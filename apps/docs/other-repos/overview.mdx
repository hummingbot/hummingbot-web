...
|------------|-------------|------------|----------------|
| **[Hummingbot API](https://github.com/hummingbot/hummingbot-api)** | REST API backend for managing bots, portfolios, and trading | [via Condor](/getting-started/installing) | [Source](/documentation/hummingbot-api/installation) |
...
| **[Condor](https://github.com/hummingbot/condor)** | Telegram bot for monitoring and controlling Hummingbot instances | [Quickstart](/getting-started/installing) | [Docs](/introduction) |
