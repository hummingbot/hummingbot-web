...
Condor uses a [two-server architecture](/condor/motivation): the **Condor Server** (agentic layer) and the **Hummingbot API Server** (execution layer). This guide installs both.
...
<Card title="Adding Credentials" icon="arrow-right" href="/condor/getting-started/credentials">
