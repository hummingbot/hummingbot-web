...
description: "How changes are reviewed, approved, and shipped in Hummingbot releases."
---
...
* [Approved proposals](https://hummingbot.org/about/proposals/): Approved PRPs and pull requests to claim bounties approved by HIPs
* [Bug fixes](https://hummingbot.org/bounties/): Fixes to outstanding bugs
