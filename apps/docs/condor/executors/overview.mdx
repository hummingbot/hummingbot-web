...
|----------|-------------|-----------|
| [Order Executor](/condor/executors/order-executor) | Places and executes a single order | - |
| [Position Executor](/condor/executors/position-executor) | Order + TP/SL/trailing stop/time limit management | Order |
| [Grid Executor](/condor/executors/grid-executor) | Multiple Position Executors across a price range | Position |
| [DCA Executor](/condor/executors/dca-executor) | Multiple orders at different price levels | Order |
| [TWAP Executor](/condor/executors/twap-executor) | Orders spread over time | Order |
| [XEMM Executor](/condor/executors/xemm-executor) | Cross-exchange market making | Order |
| [Arbitrage Executor](/condor/executors/arbitrage-executor) | Cross-market arbitrage | Order |
| [LP Executor](/condor/executors/lp-executor) | Concentrated liquidity provision | - |
