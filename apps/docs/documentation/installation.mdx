...
|------------|-------------|------------|----------------|
| [**Hummingbot API**](https://github.com/hummingbot/hummingbot-api) | REST API backend for managing bots, portfolios, and trading | [via Condor](./condor) | [Source](../hummingbot-api/installation) |
| [**Hummingbot Client**](https://github.com/hummingbot/hummingbot) | Core trading client with CLI interface for CEX trading | [Quickstart](./hummingbot-client) | [Source](../client/installation) |
| [**Gateway**](https://github.com/hummingbot/gateway) | DEX middleware for Uniswap, PancakeSwap, Raydium, and 30+ DEXs | - | [Installation](../gateway/installation) |
| [**Condor**](https://github.com/hummingbot/condor) | Telegram bot for monitoring and controlling Hummingbot instances | [Quickstart](./condor) | [Docs](https://condor.hummingbot.org) |
| [**MCP Server**](https://github.com/hummingbot/mcp) | Connects AI assistants (Claude, Gemini, ChatGPT) to Hummingbot | - | [Installation](../mcp/installation) |
...
[**Hummingbot Client Quickstart →**](./hummingbot-client)
...
- [Hummingbot Client from Source](../client/installation#source-installation) - Install the core trading client for development
- [Gateway from Source](../gateway/installation#source-installation) - Install the DEX connector middleware for development

**Building Connectors**

- [Building CLOB Connectors](../connectors/connectors/index) - Add new CEX/DEX order book connectors to Hummingbot Client
- [Building Gateway Connectors](../connectors/gateway-connectors/index) - Add new AMM DEX connectors to Gateway

**API Development**

- [Hummingbot API Developer Guide](../hummingbot-api/quickstart) - Use the REST API with curl or Python client
