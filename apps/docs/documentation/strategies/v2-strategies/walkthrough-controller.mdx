...
description: "!!! tip You can configure and deploy controllers using the Hummingbot API and manage them via Condor (Telegram) or Hummingbot MCP (AI assistants)."
---

> **Tip**
>
> You can configure and deploy controllers using the [Hummingbot API](/documentation/hummingbot-api) and manage them via [Condor](/condor/introduction) (Telegram) or [Hummingbot MCP](https://github.com/hummingbot/mcp) (AI assistants).

In this more complex example, the strategy logic is housed in a [Controller](/documentation/strategies/v2-strategies/controllers), and the user generates a controller configuration that is run with a generic script, which acts as a controller loader.
