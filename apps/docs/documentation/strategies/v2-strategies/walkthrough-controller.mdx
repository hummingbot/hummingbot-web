...
> **Tip**
>
> You can configure and deploy controllers using the [Hummingbot API](/documentation/hummingbot-api) and manage them via [Condor](/documentation/condor) (Telegram) or [Hummingbot MCP](/documentation/mcp) (AI assistants).
