---
title: "Controller Walkthrough"
description: "!!! tip You can configure and deploy controllers using the [Hummingbot API](../../hummingbot-api/index.md) and manage them via [Condor](../../condor/i"
---

> **Tip**
>
> You can configure and deploy controllers using the [Hummingbot API](../../hummingbot-api/index) and manage them via [Condor](../../condor/index) (Telegram) or [Hummingbot MCP](../../mcp/index) (AI assistants).

In this more complex example, the strategy logic is housed in a [Controller](../v2-strategies/controllers/index), and the user generates a controller configuration that is run with a generic script, which acts as a controller loader.

This allows users to run multiple configurations, as well as multiple controllers, in a single script.

![advanced](/images/strategies/v2-strategies/diagrams/11.png)
...
[![controller](/images/strategies/v2-strategies/diagrams/15.png)](diagrams/15.png)
...
[![script-config](/images/strategies/v2-strategies/diagrams/16.png)](diagrams/16.png)
...
[![script-config](/images/strategies/v2-strategies/diagrams/17.png)](diagrams/17.png)
...
[![status](/images/strategies/v2-strategies/diagrams/20.png)](diagrams/20.png)
