...
> **Tip**
>
> You can configure and deploy controllers using the [Hummingbot API](/documentation/hummingbot-api) and manage them via [Condor](/introduction) (Telegram) or [Hummingbot MCP](https://github.com/hummingbot/mcp) (AI assistants).
