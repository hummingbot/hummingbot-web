...
![simple](/images/strategies/v2-strategies/diagrams/9.png)
...
[![script config](/images/strategies/v2-strategies/diagrams/21.png)](diagrams/21.png)
...
[![controller](/images/strategies/v2-strategies/diagrams/22.png)](diagrams/22.png)
...
[![status](/images/strategies/v2-strategies/diagrams/23.png)](diagrams/23.png)

After there have been trades, you can use the [History](../../client/history) to see your bot's performance.

## Next steps

We encourage you check out [Dashboard](../../dashboard/index), the new entry point for Hummingbot users that will be officially launched at the [Hummingbot 2.0 launch event](https://lu.ma/ieyvhcft).

Also, see [Walkthrough - Controller](./walkthrough-controller) to learn how to run scripts that deploy strategies as [Controllers](controllers/index).
