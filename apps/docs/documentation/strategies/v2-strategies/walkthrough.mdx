...
description: "Below, we provide a walkthrough to illustrate the StrategyV2 framework, which we recommend for new users who want to understand how the framework work"
---
...
Run the [Status](/documentation/client/status) command to see the status (asset balances, active orders and positions) of the running strategy:

After there have been trades, you can use the [History](/documentation/client/history) to see your bot's performance.

## Next steps

We encourage you check out [Dashboard](/documentation/dashboard), the new entry point for Hummingbot users that will be officially launched at the [Hummingbot 2.0 launch event](https://lu.ma/ieyvhcft).

Also, see [Walkthrough - Controller](/documentation/strategies/v2-strategies/walkthrough-controller) to learn how to run scripts that deploy strategies as [Controllers](/documentation/strategies/v2-strategies/controllers).
