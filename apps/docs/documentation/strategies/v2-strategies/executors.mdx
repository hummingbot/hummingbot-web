...
![executors](/images/strategies/v2-strategies/diagrams/13.png)
...
* [Position Executor](positionexecutor)
* [DCA Executor](dcaexecutor)
* [Grid Executor](gridexecutor)
* [Arbitrage Executor](arbitrage-executor)
* [TWAP Executor](twapexecutor)
* [XEMM Executor](xemm-executor)
...
Use the [`lp-agent`](../../../mcp/skills) skill or call the API directly:
