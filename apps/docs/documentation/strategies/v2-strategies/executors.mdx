---
title: "LP Executor"
description: "Executors in Hummingbot are self-managing components that handle the execution of orders according to predefined conditions set by Controllers, which,"
---
...
* [Position Executor](/documentation/strategies/v2-strategies/executors/positionexecutor)
* [DCA Executor](/documentation/strategies/v2-strategies/executors/dcaexecutor)
* [Grid Executor](/documentation/strategies/v2-strategies/executors/gridexecutor)
* [Arbitrage Executor](/documentation/strategies/v2-strategies/executors/arbitrage-executor)
* [TWAP Executor](/documentation/strategies/v2-strategies/executors/twapexecutor)
* [XEMM Executor](/documentation/strategies/v2-strategies/executors/xemm-executor)
...
Use the [`lp-agent`](https://github.com/hummingbot/skills) skill or call the API directly:
