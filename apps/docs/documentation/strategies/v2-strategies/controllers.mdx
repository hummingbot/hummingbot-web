---
title: "Controllers"
description: "Controllers are the production-grade building block of the Strategy V2 framework. They define reusable, modular sub-strategies that are more configura"
---

![](/images/strategies/v2-strategies/diagrams/10.png)
