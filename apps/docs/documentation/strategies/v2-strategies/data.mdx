...
description: "The Market Data Provider service simplifies access to real-time market data with the following methods."
---
...
[Candles](/documentation/strategies/v2-strategies/candles) are trailing intervals of OHCLV data that can be used to generate custom indicators.
