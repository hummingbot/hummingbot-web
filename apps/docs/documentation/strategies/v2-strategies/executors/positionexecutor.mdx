...
* On spot exchanges, they place take-profit and stop-loss orders to manage an order after it has been filled. This is similar to [Hanging Orders](https://hummingbot.org/strategies/v1-strategies/strategy-configs/hanging-orders/) but on an individual order level.
