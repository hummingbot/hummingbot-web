---
title: "Candles"
description: "Candles allow user to compose a trailing window of real-time market data in OHLCV (Open, High, Low, Close, Volume) form from certain supported exchang"
---

![](/images/strategies/v2-strategies/candles/candles-a.jpg)
