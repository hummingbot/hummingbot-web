---
title: "Examples"
description: "The main logic in a V2 strategy is contained in the Controller, which inherits from a base class in hummingbot/strategyv2/controllers/. Controllers or"
---

## Running V2 Strategies

The main logic in a V2 strategy is contained in the [Controller](/documentation/strategies/v2-strategies/controllers), which inherits from a base class in [`hummingbot/strategy_v2/controllers/`](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/strategy_v2/controllers). Controllers orchestrate [Candles](/documentation/strategies/v2-strategies/candles) and [Executors](/documentation/strategies/v2-strategies/executors).
...
In the controller's signal logic, a directional strategy uses indicators (often from [Candles](/documentation/strategies/v2-strategies/data)) so that:

* `1`: Long [Position Executor](/documentation/strategies/v2-strategies/executors/positionexecutor) is created  
* `-1`: Short [Position Executor](/documentation/strategies/v2-strategies/executors/positionexecutor) is created  
...
A simple directional strategy using [Bollinger Band Percent (BBP)](/documentation/glossary).
