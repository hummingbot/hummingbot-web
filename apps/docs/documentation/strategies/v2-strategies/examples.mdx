---
title: "Examples"
description: "The main logic in a V2 strategy is contained in the [Controller](../controllers/index.md), which inherits from a base class in [hummingbot/strategyv2/"
---

## Running V2 Strategies

The main logic in a V2 strategy is contained in the [Controller](../controllers/index), which inherits from a base class in [`hummingbot/strategy_v2/controllers/`](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/strategy_v2/controllers). Controllers orchestrate [Candles](../candles/index) and [Executors](../executors/index).
...
In the controller's signal logic, a directional strategy uses indicators (often from [Candles](../data/index)) so that:

* `1`: Long [Position Executor](../executors/positionexecutor) is created  
* `-1`: Short [Position Executor](../executors/positionexecutor) is created  
...
A simple directional strategy using [Bollinger Band Percent (BBP)](../../../glossary/index).
...
[![](/images/strategies/v2-strategies/examples/status-bollinger.png)](./status-bollinger.png)
...
[![](/images/strategies/v2-strategies/examples/status-macdbb.png)](./status-macdbb.png)
...
[![](/images/strategies/v2-strategies/examples/status-dmanv3.png)](./status-dmanv3.png)
