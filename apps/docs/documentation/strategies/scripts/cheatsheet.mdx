...
description: "See below for reference docs that help you create Scripts that inherit from the ScriptStrategy base class."
---
...
This Script Strategies Cheatsheet is also available in [PDF form](https://hummingbot.org/strategies/scripts/cheatsheet.pdf/).
...
- Follow the [Installation](/documentation/installation) docs for your environment
