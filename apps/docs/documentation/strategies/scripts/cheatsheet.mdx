...
description: "See below for reference docs that help you create Scripts that inherit from the [ScriptStrategy](https://github.com/hummingbot/hummingbot/blob/master/"
---
...
- Follow the [Installation](../../installation/index) docs for your environment
