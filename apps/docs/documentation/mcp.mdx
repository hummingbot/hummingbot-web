---
title: "Hummingbot MCP"
description: "This section covers two ways to connect AI assistants to Hummingbot:"
---

This section covers two ways to connect AI assistants to Hummingbot:

- **[MCP Server](/documentation/mcp)** — A running server that implements the [Model Context Protocol](https://modelcontextprotocol.io), letting Claude, Gemini, and ChatGPT control your trading infrastructure via natural language
- **[Skills](/documentation/mcp/skills)** — Self-contained agent capabilities installable via `npx`, providing commands and scripts for any AI agent framework including [OpenClaw](https://openclaw.ai)

---

# Hummingbot MCP Server

The Hummingbot MCP Server is an interface to [Hummingbot API](/documentation/hummingbot-api) that enables AI assistants like Claude, Gemini, and ChatGPT to control your trading infrastructure using natural language.
...
1. **[Install the MCP Server](/documentation/mcp/installation)** - Set up and connect to your AI assistant
2. **[Explore Available Tools](/documentation/mcp/tools)** - Learn about the trading and portfolio management tools
3. **[Browse Skills](/documentation/mcp/skills)** - Install agent skills for OpenClaw, Claude Code, and other frameworks
...
See the [Installation Guide](/documentation/mcp/installation) for setup instructions for each assistant.
