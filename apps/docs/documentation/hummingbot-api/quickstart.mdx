...
- Hummingbot API installed and running (see [Installation Guide](installation))
...
- **[Bot Management](../dashboard/instances)**: Deploy and manage multiple trading bots
- **[Strategy Configuration](../dashboard/config)**: Configure and deploy trading strategies
- **[Market Data](../hummingbot-api/index#market-data)**: Access real-time and historical market data
- **[Backtesting](../dashboard/backtest)**: Test your strategies with historical data
