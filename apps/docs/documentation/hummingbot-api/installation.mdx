...
See the [Condor Quickstart](../installation/condor) for step-by-step installation instructions.
...
After installation, proceed to the [Developer Guide](quickstart) to learn how to:
