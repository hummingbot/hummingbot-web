...
See the [Condor Quickstart](/documentation/installation/condor) for step-by-step installation instructions.
...
- **API Documentation**: Available at [http://localhost:8000/docs](http://localhost:8000/docs) when running
...
After installation, proceed to the [Developer Guide](/documentation/hummingbot-api/quickstart) to learn how to:
