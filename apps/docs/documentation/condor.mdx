---
title: "Condor"
description: "Condor is an open source harness for building and running autonomous Trading Agents. It connects LLM-powered decision-making to deterministic trade ex"
---

**Condor** is an open source harness for building and running autonomous **Trading Agents**. It connects LLM-powered decision-making to deterministic trade execution via the [Hummingbot API](/documentation/hummingbot-api), enabling traders to deploy AI agents that can observe markets, reason about strategy, and execute trades across 50+ exchanges and blockchains.
...
| Hummingbot API | [Hummingbot API Docs](/documentation/hummingbot-api) |
