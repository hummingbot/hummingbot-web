---
title: "Gateway DEX Middleware"
description: "Hummingbot Gateway is a Typescript-based API server that standardizes interactions with blockchain networks and decentralized exchanges (DEXs). It act"
---
...
- **[Installation & Setup](/documentation/gateway/installation)**: Complete installation guide for source and Docker
- **[Configuration](/documentation/gateway/configuration)**: How to configure chains, connectors, and settings
- **[Commands](/documentation/gateway/commands)**: Comprehensive reference of all Gateway-related Hummingbot commands
- **[Chains](/documentation/gateway/chains)**: Detailed information about supported chains
- **[DEX Connectors](/documentation/gateway/connectors)**: Guide to all supported DEX in Gateway
- **[Strategies & Scripts](/documentation/gateway/strategies)**: Using Gateway with Hummingbot strategies
...
For detailed implementation guides and examples for each schema, see [DEX Connectors](/documentation/gateway/connectors).

## Installation

Gateway can be installed alongside [Hummingbot](https://github.com/hummingbot/hummingbot) to enable trading on AMM DEXs, or as a standalone API server. For detailed installation instructions, see [Installation & Setup](/documentation/gateway/installation).

When running Gateway in `DEV` mode, access the interactive Swagger API documentation at: [http://localhost:15888/docs](http://localhost:15888/docs)
...
The community can propose changes to connector maintenance, bounty allocations, and connector removals through [Hummingbot Governance Proposals (HGP)](https://hummingbot.org/about/proposals/). This process also determines which blockchains and networks that Gateway supports.
...
- **Build new connectors**: See [DEX Connectors](/documentation/connectors/gateway-connectors) for implementation guide
...
* [Hummingbot Gateway V2 Architecture - Part 1](https://hummingbot.org/blog/hummingbot-gateway-architecture-part-1)
* [Hummingbot Gateway V2 Architecture - Part 2](https://hummingbot.org/blog/hummingbot-gateway-architecture-part-2)
