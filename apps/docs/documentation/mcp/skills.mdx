---
title: "Skills"
description: "Hummingbot Skills are structured agent capabilities for AI assistants that provide commands, scripts, and documentation for managing the Hummingbot ec"
---
