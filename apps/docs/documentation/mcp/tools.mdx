...
description: "This page describes MCP capabilities at the router/functionality level to avoid tool-name drift as the MCP server evolves."
---
...
- When in doubt, cross-check endpoint behavior in [API Routers](/documentation/hummingbot-api/routers).
