---
title: "Installation"
description: "This guide shows you how to connect AI assistants to the Hummingbot API using the MCP (Model Context Protocol) server."
---
...
1. **Hummingbot API Server** running ([Condor Quickstart](../installation/condor))
...
2. Search for **Hummingbot MCP Server** and click **➕ Install**
   ![toolkit](/images/mcp/toolkit.png)

3. Go to the **Configuration** tab
   ![config](/images/mcp/config.png)
...
5. Click the **checkbox** to save
   ![save](/images/mcp/save.png)

### Connect a Client

1. Go to **MCP Toolkit** → **Clients**
   ![client](/images/mcp/client.png)
...
1. **Explore Tools**: See [MCP Tools](./tools) for available capabilities
2. **Try Examples**: Review [Example Workflows](./index#example-workflows)
3. **Security**: Read [Security Guidelines](./index#security-considerations)
