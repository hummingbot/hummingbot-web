...
1. **Hummingbot API Server** running ([Condor Quickstart](/documentation/installation/condor))
...
1. **Explore Tools**: See [MCP Tools](/documentation/mcp/tools) for available capabilities
2. **Try Examples**: Review [Example Workflows](/documentation/mcp#example-workflows)
3. **Security**: Read [Security Guidelines](/documentation/mcp#security-considerations)
