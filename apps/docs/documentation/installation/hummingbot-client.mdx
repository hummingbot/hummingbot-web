---
title: "Hummingbot Client Quickstart"
description: "This guide walks you through installing the Hummingbot Client using Docker, the simplest method for most users."
---

This guide walks you through installing the Hummingbot Client using Docker, the simplest method for most users.

For source installation or detailed configuration options, see [Client Installation](/documentation/client/installation).
...
> **Development Mode**
>
> By default, Gateway runs in development mode (`DEV=true`) which uses HTTP for easier setup. For production environments requiring HTTPS, set `DEV=false` and ensure certificates are properly configured. See [Gateway Installation](/documentation/gateway/installation) for details.

## Next Steps

- [Basic Features](/documentation/client) - Learn the Hummingbot CLI commands
- [Connect to Exchanges](/documentation/client/connect) - Add your exchange credentials
- [Create a Strategy](/documentation/strategies) - Start trading
- [Updating to New Versions](/documentation/installation/update) - Keep your installation current
...
For detailed source installation options, see [Client Installation](/documentation/client/installation).

## Need More Options?

For development setup or advanced configuration, see the detailed [Client Installation](/documentation/client/installation) page.
