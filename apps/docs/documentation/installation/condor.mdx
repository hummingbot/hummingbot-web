---
title: "Condor Quickstart"
description: "Condor is a Telegram-based interface for managing Trading Agents and executing trades across centralized and decentralized exchanges. It uses the Humm"
---
...
- [Hummingbot API Reference](/documentation/hummingbot-api) - API endpoints and developer guide
- [MCP Installation](https://github.com/hummingbot/mcp) - Connect AI assistants to Hummingbot API
