...
description: "Hummingbot Foundation actively maintains all repositories in the Hummingbot ecosystem and ships versioned releases of Hummingbot Client and Gateway mo"
---
...
Some releases include changes to configuration file schemas. When this happens, existing configuration files are incompatible and must be removed before updating. Check the [release notes](https://hummingbot.org/release-notes/) for your target version to see if configuration changes are required.
