---
title: "Exchange API Requirements"
...
> **Note**
>
> The information below are for developers building spot and perp connectors that integrate directly into the Hummingbot client. For information on developing gateway connectors that use Gateway, see [Building Gateway Connectors](/documentation/connectors/gateway-connectors).
