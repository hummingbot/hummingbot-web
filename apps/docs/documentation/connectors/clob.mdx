...
These connector standards allow users to create [Strategies](../strategies/index) and [Scripts](../strategies/scripts/index) that can operate on different spot and perpetual markets without modification.

### Current CLOB Connectors

Here are the CLOB connectors currently in the codebase. Note that the Foundation prioritizes fixes for connectors from exchanges that are [sponsors or partners](../about/sponsors), so they tend to be more reliable and better maintained.

| Exchange                                | Foundation Partner | Spot | Perp | Connector Guide |
|-----------------------------------------|-------------------|------|------|----------------|
| [Binance](../exchanges/binance/index)           | ✓ | ✓ | ✓ | [Guide](../blog/posts/using-binance-with-hummingbot/index) |
| [Bitmart](../exchanges/bitmart/index)           | ✓ | ✓ | ✓ |  |
| [Derive](../exchanges/derive/index)             | ✓ | ✓ | ✓ | [Guide](../blog/posts/using-derive-with-hummingbot/index) |
| [Evedex](../exchanges/evedex/index)             |  |  | ✓ |  |
| [dYdX](../exchanges/dydx)                 | ✓ | | ✓ | [Guide](../blog/posts/dydx-v4-connector/index) |
| [Gate.io](../exchanges/gate-io/index)           | ✓ | ✓ | ✓ |  |
| [HTX](../exchanges/htx/index)                 | ✓ | ✓ |  |  |
| [Kucoin](../exchanges/kucoin/index)             | ✓ | ✓ | ✓ |  |
| [OKX](../exchanges/okx/index)                   | ✓ | ✓ | ✓ |  |
| [XRPL](../exchanges/xrpl)                       | ✓ | ✓ |  | [Guide](../blog/posts/using-xrpl-with-hummingbot/index) |
| [AscendEx](../exchanges/ascendex/index)         |  | ✓ |  |  |
| [Architect](../exchanges/architect/index)       |  |  | ✓ |  |
| [Aevo](../exchanges/aevo/index)         |  | ✓ |  |  |
| [Backpack](../exchanges/backpack/index)         |  | ✓ | ✓ |  |
| [BingX](../exchanges/bing_x/index)              | | ✓ |  | |
| [Bitstamp](../exchanges/bitstamp/index)         |  | ✓ |  |  |
| [Bitrue](../exchanges/bitrue)                   |  | ✓ |  |  |
| [Bitget](../exchanges/bitget/index)         | ✓ | ✓ | ✓ |  |
| [Bybit](../exchanges/bybit)                     | | ✓ | ✓ |  |
| [BTC Markets](../exchanges/btc-markets)         |  | ✓ |  |  |
| [Coinbase](../exchanges/coinbase)               |  | ✓ |  |  |
| [Cube](../exchanges/cube/index)                 | | ✓ |  |  |
| [Dexalot](../exchanges/dexalot)           | | ✓ | ✓ | [Guide](../blog/posts/using-dexalot-with-hummingbot/index) |
| [Kraken](../exchanges/kraken/index)             |  | ✓ |  |  |
| [MEXC](../exchanges/mexc/index)                 |  | ✓ |  |  |
| [NDAX](../exchanges/ndax)                       |  | ✓ |  |  |
| [Pacifica](../exchanges/pacifica/index)             |  |  | ✓ |  |
| [Decibel](../exchanges/decibel/index)               |  |  | ✓ |  |
| [GRVT](../exchanges/grvt/index)                     |  |  | ✓ |  |
| [Vertex](../exchanges/vertex)                   | | ✓ |  |  |
| [Foxbit](../exchanges/foxbit/index) | | ✓ |  |  |
...
See [Building Connectors](../connectors/connectors/build) for more information.

If the exchange is not yet supported by Hummingbot, you can submit a governance proposal for it to be included. New connectors may be contributed by community members via [Hummingbot Governance Proposals (HGP)](../about/proposals), which require a pull request with the connector code to the Hummingbot Github repo, along with a minimum HBOT balance to create.
