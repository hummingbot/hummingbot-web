...
description: "Gateway connectors follow a standardized architecture that ensures consistency, maintainability, and compatibility with the Hummingbot client. This pa"
---
...
- [Gateway Architecture Overview](/documentation/gateway)
...
- [Testing Guidelines](/documentation/connectors/gateway-connectors/testing)
