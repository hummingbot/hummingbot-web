...
>
> **If you installed Hummingbot using the [Condor Quickstart](/condor/getting-started/overview)**, you can manage Gateway directly through the API - no separate installation needed!
>
