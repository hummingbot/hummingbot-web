---
title: "Commands"
description: "This guide covers how to use Gateway commands within the Hummingbot client. Gateway commands allow you to manage wallets, execute swaps, manage liquid"
---
...
Before using Gateway commands, you need to have Gateway installed and running. Follow the [Gateway Installation Guide](/documentation/gateway/installation) to set up Gateway using either Docker or from source.
