...
Before using Gateway commands, you need to have Gateway installed and running. Follow the [Gateway Installation Guide](./installation) to set up Gateway using either Docker or from source.
