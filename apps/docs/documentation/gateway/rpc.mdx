---
title: "RPC Providers"
description: "Starting with v2.9.0, deep integrations with leading RPC providers like Helius and Infura are available to optimize speed and reduce latency for DEX t"
---

## Overview

Starting with [v2.9.0](https://hummingbot.org/release-notes/2.9.0/), deep integrations with leading RPC providers like Helius and Infura are available to optimize speed and reduce latency for DEX trading.
