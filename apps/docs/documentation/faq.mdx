...
* [Comparing liquidity mining options in DeFi vs. Hummingbot](/blog/liquidity-mining-in-hummingbot-vs-defi): This CoinAlpha blog post explains how liquidity mining is similar in DeFi and CeFi
...
Other than those listed in the [HBOT announcement](/blog/introducing-the-hummingbot-governance-token-hbot), there are no other eligible HBOT recipients.
