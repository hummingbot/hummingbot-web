...
As we wrote in the original [Hummingbot whitepaper](/blog/posts/hummingbot-whitepaper), market making is an important function critical to organic, efficient markets that should be decentralized to prevent the concentration risk that exists in traditional finance.
...
See [What is market making?](/blog/posts/what-is-market-making) for more information.
...
* [Comparing liquidity mining options in DeFi vs. Hummingbot](/blog/posts/liquidity-mining-in-hummingbot-vs-defi): This CoinAlpha blog post explains how liquidity mining is similar in DeFi and CeFi
...
Other than those listed in the [HBOT announcement](/blog/posts/introducing-the-hummingbot-governance-token-hbot), there are no other eligible HBOT recipients.
