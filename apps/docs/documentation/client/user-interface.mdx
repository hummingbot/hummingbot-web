...
![Hummingbot CLI](/images/assets/img/userinterface-hummingbot.gif)

The CLI is divided into five panes:

* **Input pane (lower left)**: Where users enter commands

![Hummingbot CLI](/images/assets/img/input-pane.gif)

* **Output pane (upper left)**: Prints the output of the user's commands

![Hummingbot CLI](/images/assets/img/output-pane.gif)

* **Log pane (right)**: Log messages

![Log Pane](/images/assets/img/log-messages.gif)
...
![Top Navigation](/images/assets/img/top-nav.gif)
...
![Bottom Navigation](/images/assets/img/bottom-nav.gif)
...
![Hide Log Pane](/images/assets/img/hide-log-pane.gif)
...
![opening tabs](/images/assets/img/tab-opening.png)

![showing tab](/images/assets/img/leftpane.png)
...
![closing tabs](/images/assets/img/closing-of-tabs.png)

Alternatively, you can remove the new tab by inputting the `order_book --close` command to close the tab

![alternative closing tabs](/images/assets/img/name-of-parameter.png)

![closed tabs](/images/assets/img/closed-tabs.png)
