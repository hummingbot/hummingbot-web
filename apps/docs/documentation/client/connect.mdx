---
title: "Connect Exchange API Keys"
description: "The connect command lets you add your user credentials in order to connect to an exchange or protocol. For centralized exchanges, this command asks yo"
---
...
See [Exchanges](../exchanges/index) for more information about how to create API keys for each exchange.
...
![Alt text](/images/assets/img/connection-status.png)
