...
description: "The history command displays the current duration of total past trades, asset inventory and value, and market trading pair performance. Run history --"
---
...
![ ](/images/assets/img/same_return.png)
