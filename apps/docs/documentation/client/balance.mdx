...
You can use Gateway `gateway token` commands to view or update token metadata used with DEX connectors. See [Working with Tokens](/documentation/gateway/configuration) for more information.
