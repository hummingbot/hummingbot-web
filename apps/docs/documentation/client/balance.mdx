...
description: "Run the balance command to check the balances of all connected wallets and exchanges."
---
...
![balance command](/images/assets/img/balance-1.png)
...
![balance paper](/images/assets/img/balance-2.png)
...
![Alt text](/images/assets/img/balance-3.png)
...
![Alt text](/images/assets/img/balance-4.png)
...
![Alt text](/images/assets/img/balance-5.png)
...
![Alt text](/images/assets/img/balance-6.png)

## Displaying token symbols in `balance`

You can use Gateway `gateway token` commands to view or update token metadata used with DEX connectors. See [Working with Tokens](../gateway/configuration) for more information.
