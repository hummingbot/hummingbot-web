---
title: "Debug Console"
description: "The debug console is a powerful tool for Hummingbot developers to inspect and modify the live states in Hummingbot while it's running. It gives access"
---
...
![Enabling debug console in global config](/images/assets/img/debug1.png)
...
![Started debug console logm essage](/images/assets/img/debug2.png)
...
![Entering the debug console](/images/assets/img/debug3.png)
...
![Some exposed variables under 'hb'](/images/assets/img/debug4.png)
...
![Example](/images/assets/img/debug5.png)
