---
title: "Create/Delete Password"
description: "The password in Hummingbot encrypts sensitive data such as API keys, secret keys, and wallet private keys. For security reasons, the password is only"
---
...
![password](/images/assets/img/password.png)
...
> ![](/images/assets/img/encrypted_files.png)
