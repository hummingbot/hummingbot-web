...
For a quick Docker-based setup, see the [Hummingbot Client Quickstart](../installation/hummingbot-client).
...
![launch from source](/images/assets/img/launch-from-source.gif)
...
| Folder | Description |
|--------|-------------|
| `/conf/connectors` | Exchange API keys encrypted by your [password](./password) |
...
See [Gateway Installation](../gateway/installation) for setup instructions.

---

## Next Steps

- [Basic Features](./index) - Learn the Hummingbot CLI
- [V2 Strategy Walkthrough](../strategies/v2-strategies/walkthrough) - Create your first strategy
- [Hummingbot FAQ](../faq) - Common questions
- [Updating to New Versions](../installation/update) - Update your installation
