---
title: "Installation"
description: "This page provides detailed installation instructions for the Hummingbot Client, including both Docker and source installation methods."
---
...
For a quick Docker-based setup, see the [Hummingbot Client Quickstart](/documentation/installation/hummingbot-client).
...
| Folder | Description |
|--------|-------------|
| `/conf/connectors` | Exchange API keys encrypted by your [password](/documentation/client/password) |
...
See [Gateway Installation](/documentation/gateway/installation) for setup instructions.

---

## Next Steps

- [Basic Features](/documentation/client) - Learn the Hummingbot CLI
- [V2 Strategy Walkthrough](/documentation/strategies/v2-strategies/walkthrough) - Create your first strategy
- [Hummingbot FAQ](/documentation/faq) - Common questions
- [Updating to New Versions](/documentation/installation/update) - Update your installation
