---
title: "Check Bot/Market Status"
description: "Run status command or CTRL+S to show the bot's current status. The output may differ depending on the running strategy, but generally, it shows the fo"
---
...
![](/images/assets/img/status-live.gif)
...
![](/images/assets/img/orderbook-live-lines.gif)
...
![](/images/assets/img/ticker-command.png)
