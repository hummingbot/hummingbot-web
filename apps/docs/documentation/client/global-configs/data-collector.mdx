...
description: "Hummingbot can collect real-time market data in the background for the trading pairs that are initialized in the running strategy."
---

![](/images/assets/img/market-data-table.png)
