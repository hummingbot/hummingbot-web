---
title: "Balance Limit"
description: "Sets the amount limit on how much assets Hummingbot can use in an exchange or wallet. This can be useful when running multiple bots on different tradi"
---

**Updated on version [0.35.0](https://hummingbot.org/release-notes/releases/)**
