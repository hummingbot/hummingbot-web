---
title: "Rate Limits"
description: "Some exchanges impose rate limits per account. When running multiple bots using a single account, ratelimitssharepct users to set a certain percentage"
---
...
![](/images/assets/img/rate-limits-share-pct-prompt.png)
...
![](/images/assets/img/rate-limits-share-pct-message.png)
