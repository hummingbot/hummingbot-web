---
title: "Command Line Autostart"
description: "!!! warning Running any trading bots without manual supervision may incur additional risks. It is imperative that you thoroughly understand and test t"
---
...
More information on strategy can be found in [Strategy](/documentation/strategies).

More information on configuration file name can be found in [Configuring Hummingbot](/documentation/client/config-files).

More information on password can be found in [Create a secure password](/documentation/client/password).
