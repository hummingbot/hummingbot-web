---
title: "Override Fees"
description: "By default, Hummingbot uses the default fees of the exchange. However, if you're on a VIP level getting discounts on fees, you can override this by ed"
---
...
![](/images/assets/img/fees-override.png)
