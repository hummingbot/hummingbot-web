...
description: "The Backtesting section in the Hummingbot Dashboard is a powerful tool available on all controller pages, allowing users to evaluate the performance o"
---
...
![Configuring the PMM Simple controller for backtesting](/images/dashboard/backtest-1.png)
...
![Backtesting results showing net PNL, max drawdown, and total volume](/images/dashboard/backtest-2.png)
...
![Graphical representation of backtesting results including candlestick chart and PNL quote chart](/images/dashboard/backtest.png)
...
![Uploading the configured strategy to the backend API](/images/dashboard/backtest-3.png)
