---
title: "Configuring Strategies"
description: "Here's a detailed explanation of the different controllers available for configuration in the Hummingbot Dashboard:"
---
...
[![config](/images/dashboard/config-2.png)](config-2.png)
...
[![config](/images/dashboard/config-3.png)](config-3.png)

[![config](/images/dashboard/config-4.png)](config-4.png)
...
[![config](/images/dashboard/config-5.png)](config-5.png)

[![config](/images/dashboard/config-6.png)](config-6.png)

[![config](/images/dashboard/config-7.png)](config-7.png)
...
[![config](/images/dashboard/config-8.png)](config-8.png)
...
[![config](/images/dashboard/config-9.png)](config-9.png)
...
[![config](/images/dashboard/config-10.png)](config-10.png)
...
[![config](/images/dashboard/config-11.png)](config-11.png)
