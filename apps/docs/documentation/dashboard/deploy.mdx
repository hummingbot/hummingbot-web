...
description: "The Deploy V2 page in the Hummingbot Dashboard is designed for launching and managing Hummingbot trading instances. This page offers a streamlined int"
---
...
[![deploy](/images/dashboard/deploy.png)](deploy.png)

## Bot Configuration

[![deploy](/images/dashboard/deploy-1.png)](deploy-1.png)
