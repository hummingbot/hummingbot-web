...
description: "The Credentials page in the Hummingbot Dashboard is a comprehensive interface for managing your API keys and related credentials. It offers several fu"
---
...
[![credentials](/images/dashboard/credentials.png)](credentials.png)
...
[![credentials](/images/dashboard/credentials-1.png)](credentials-1.png)
...
[![credentials](/images/dashboard/credentials-2.png)](credentials-2.png)
...
[![credentials](/images/dashboard/credentials-3.png)](credentials-3.png)
...
[![credentials](/images/dashboard/credentials-5.png)](credentials-5.png)

- In the **Available Accounts and Credentials** we now have Binance showing up under the **master_account**

[![credentials](/images/dashboard/credentials-7.png)](credentials-7.png)
...
[![credentials](/images/dashboard/credentials-6.png)](credentials-6.png)
...
[![credentials](/images/dashboard/credentials-4.png)](credentials-4.png)
