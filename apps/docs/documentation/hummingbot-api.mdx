...
description: "The central hub for running Hummingbot trading bots - now with AI assistant integration via MCP (Model Context Protocol)."
---
...
- **[Quickstart](/documentation/installation/condor)** - Install Condor with Hummingbot API backend
- **[Developer Guide](/documentation/hummingbot-api/quickstart)** - Learn how to use the API directly with curl or Python to add credentials, view portfolios, and place orders
- **[Source Installation](/documentation/hummingbot-api/installation)** - For developers who want to modify the codebase
...
- **Setup**: See [Condor Quickstart](/documentation/installation/condor)
...
- **Setup**: See [MCP Installation Guide](/documentation/mcp/installation)
...
For detailed endpoint documentation, see the **[API Routers Guide](/documentation/hummingbot-api/routers)**.
...
A modern, asynchronous Python client is available for interacting with the Hummingbot API. This client is used by [Condor](/documentation/condor) and other interfaces as the interface layer for all API communications.
...
- [Condor](/documentation/condor) - Telegram interface for Hummingbot API
- [API Client Documentation](https://github.com/hummingbot/hummingbot-api-client) - Python client library
- [Hummingbot Client](/documentation/client) - Core trading engine
