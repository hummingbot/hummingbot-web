...
- **[Quickstart](../installation/condor)** - Install Condor with Hummingbot API backend
- **[Developer Guide](quickstart)** - Learn how to use the API directly with curl or Python to add credentials, view portfolios, and place orders
- **[Source Installation](installation)** - For developers who want to modify the codebase
...
- **Setup**: See [Condor Quickstart](../installation/condor)
...
For detailed endpoint documentation, see the **[API Routers Guide](routers)**.
...
A modern, asynchronous Python client is available for interacting with the Hummingbot API. This client is used by [Condor](../condor/index) and other interfaces as the interface layer for all API communications.
...
- [Condor](../condor/index) - Telegram interface for Hummingbot API
- [API Client Documentation](https://github.com/hummingbot/hummingbot-api-client) - Python client library
- [Hummingbot Client](../client/index) - Core trading engine
