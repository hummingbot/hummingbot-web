...
- **[Quickstart](/condor/getting-started/overview)** - Install Condor with Hummingbot API backend
...
- **Setup**: See [Condor Quickstart](/condor/getting-started/overview)
...
- **Setup**: See [MCP Installation Guide](https://github.com/hummingbot/mcp)
...
A modern, asynchronous Python client is available for interacting with the Hummingbot API. This client is used by [Condor](/condor/introduction) and other interfaces as the interface layer for all API communications.
...
- [Condor](/condor/introduction) - Telegram interface for Hummingbot API
