...
- **[Dashboard Quickstart Guide](/blog/posts/quickstart-dashboard)** *(deprecated)*
...
- **[What is Market Making](/blog/posts/what-is-market-making)**
  Deep dive into market making, one of the most popular algorithmic trading strategies

- **[What is Cross Exchange Market Making?¶](/blog/posts/what-is-cross-exchange-market-making)**
  Essential principles for managing risk in automated trading systems

- **[Liquidity Mining in Hummingbot vs DeFi](/blog/posts/liquidity-mining-in-hummingbot-vs-defi)**
...
Check out the [Strategy Guides](/blog/overview) category in our blog for step-by-step guides in setting up various Hummingbot strategies:

- **[Strategy Guide: Grid Strike](/blog/posts/strategy-guide-grid-strike)**
...
- **[How to Configure V2 Strategies](/blog/posts/create-controller-config)**
...
- **[Coding a Custom Liquidation Strategy](/blog/posts/coding-a-custom-v2-controller)**
  Explore how to create a custom V2 Controller for Hummingbot to snipe future liquidations on Binance

- **[Directional Trading with MACD and Bollinger Bands](/blog/posts/directional-trading-experiment)**
...
- **[Technical Deep Dive into the Avellaneda & Stoikov Strategy](/blog/posts/technical-deep-dive-into-the-avellaneda-stoikov-strategy)**
