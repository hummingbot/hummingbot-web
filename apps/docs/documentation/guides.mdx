---
title: "Guides"
description: "This page serves as a comprehensive resource hub for learning about algorithmic trading with Hummingbot. With content for new crypto traders to advanc"
---
...
- **[Hummingbot API Developer Guide](/documentation/hummingbot-api/quickstart)**
...
- **[Dashboard Quickstart Guide](https://hummingbot.org/blog/quickstart-dashboard)** *(deprecated)*
...
- **[Liquidity Mining in Hummingbot vs DeFi](https://hummingbot.org/blog/liquidity-mining-in-hummingbot-vs-defi)**
...
Check out the [Strategy Guides](https://hummingbot.org/blog) category in our blog for step-by-step guides in setting up various Hummingbot strategies:

- **[Strategy Guide: Grid Strike](https://hummingbot.org/blog/strategy-guide-grid-strike)**
...
- **[How to Configure V2 Strategies](https://hummingbot.org/blog/create-controller-config)**
...
- **[Coding a Custom Liquidation Strategy](https://hummingbot.org/blog/coding-a-custom-v2-controller)**
  Explore how to create a custom V2 Controller for Hummingbot to snipe future liquidations on Binance

- **[Directional Trading with MACD and Bollinger Bands](https://hummingbot.org/blog/directional-trading-experiment)**
...
- **[Technical Deep Dive into the Avellaneda & Stoikov Strategy](https://hummingbot.org/blog/technical-deep-dive-into-the-avellaneda-stoikov-strategy)**
...
- **[Using Binance with Hummingbot](https://hummingbot.org/blog/using-binance-with-hummingbot)**
  Step-by-step guide to using Hummingbot with Binance, including generating exchange API keys and adding them to Hummingbot

- **[Funding Rate Arbitrage and Creating Vaults on Hyperliquid](https://hummingbot.org/blog/using-hyperliquid-vaults-with-hummingbot)**
  Guide on using Hyperliquid Vaults as exchange wallets for individual traders or automated market makers

- **[Running a Trading Bot with Hummingbot Dashboard on dYdX V4](https://hummingbot.org/blog/using-dydx-v4-with-hummingbot)**
  Guide to integrating and trading on dYdX's perpetual contracts using Hummingbot Dashboard

- **[Running a Trading Bot with Hummingbot on Derive](https://hummingbot.org/blog/using-derive-with-hummingbot)**
  Comprehensive resource for integrating and trading on Derive's decentralized derivatives platform using Hummingbot

- **[Trading on XRPL with Hummingbot](https://hummingbot.org/blog/using-xrpl-with-hummingbot)**
  Guide to setting up and trading on the XRP Ledger's decentralized exchange using Hummingbot

See more examples in the [Connector Guides](https://hummingbot.org/blog) category in our blog.
