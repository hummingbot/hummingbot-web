...
- [Connect to an Exchange](../exchanges/index)
...
- [Clock Tick Size](./global-configs/clock-tick)
...
- [Rate Oracle](../strategies/v1-strategies/strategy-configs/rate-oracle)
