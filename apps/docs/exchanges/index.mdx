...
Partner directly with Hummingbot Foundation for priority development, exchange-specific content like [Funding Rate Arbitrage on Hyperliquid](/blog/using-hyperliquid-vaults-with-hummingbot), and co-marketing campaigns starting at **$50,000**. 
