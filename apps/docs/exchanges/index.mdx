...
| **🔄 Gateway DEX** | AMM decentralized exchanges and aggregators via Gateway | [Uniswap →](./gateway/uniswap) |

* [All CLOB Connectors →](/documentation/connectors/clob) 
* [All Gateway DEX Connectors →](/documentation/gateway/connectors)

### Real-Time Usage Data

See live trading activity across all exchanges via our public dashboard:

The [Reported Volumes](https://hummingbot.org/reporting/) dashboard shows real-time, aggregated trading data from Hummingbot instances worldwide, including both official releases and community forks. This transparent data helps exchanges understand actual usage patterns and trading volume.
...
Build your own connector following other connectors in the `development` branch of Hummingbot's open source framework. Then, create a [Hummingbot Governance Proposal (HGP)](https://hummingbot.org/about/proposals/) along with a valid, comprehensive pull request containing the connector code. 

You'll need some [HBOT tokens](https://hummingbot.org/about/governance/) to create a proposal, and you'll be responsible for ongoing maintenance updates to keep your connector included in ongoing releases of Hummingbot.
...
See [Bounties](https://hummingbot.org/bounties/) for more information.

### 🏆 Sponsor the Foundation

Partner directly with Hummingbot Foundation for priority development, exchange-specific content like [Funding Rate Arbitrage on Hyperliquid](https://hummingbot.org/blog/using-hyperliquid-vaults-with-hummingbot), and co-marketing campaigns starting at **$50,000**. 
...
[Learn About Governance →](https://hummingbot.org/about/governance/)\{: .md-button \}
...
[Build CLOB Connectors →](/documentation/connectors/connectors/build)\{: .md-button \}
...
[Build Gateway Connectors →](/documentation/connectors/gateway-connectors)\{: .md-button \}
