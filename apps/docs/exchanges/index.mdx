---
title: "Exchanges"
description: "Overview of Hummingbot's exchange connectors across CLOB CEX, CLOB DEX, and Gateway DEX types, with connector status and supported features."
---
...
|---------------|-------------|------------------|
| **🏛️ CLOB CEX** | Centralized exchanges with spot & perpetual futures trading in central limit order book (CLOB) markets | [Binance →](./binance/index) |
| **📊 CLOB DEX** | On-chain, non-custodial spot and perp exchanges CLOB markets | [Hyperliquid →](hyperliquid) |
...
Build your own connector following other connectors in the `development` branch of Hummingbot's open source framework. Then, create a [Hummingbot Governance Proposal (HGP)](../about/proposals) along with a valid, comprehensive pull request containing the connector code. 

You'll need some [HBOT tokens](../about/governance) to create a proposal, and you'll be responsible for ongoing maintenance updates to keep your connector included in ongoing releases of Hummingbot.
...
See [Bounties](../bounties/index) for more information.

### 🏆 Sponsor the Foundation

Partner directly with Hummingbot Foundation for priority development, exchange-specific content like [Funding Rate Arbitrage on Hyperliquid](../blog/posts/using-hyperliquid-vaults-with-hummingbot/index), and co-marketing campaigns starting at **$50,000**. 
...
[Learn About Governance →](../about/governance)\{: .md-button \}
...
[Build CLOB Connectors →](../connectors/connectors/build)\{: .md-button \}
...
[Build Gateway Connectors →](../connectors/gateway-connectors/index)\{: .md-button \}
