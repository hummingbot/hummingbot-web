---
title: "Backpack"
description: "Run trading bots on Backpack with Hummingbot — Centralized Exchange (CEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
...
- **Backpack referral link:** [https://backpack.exchange/join/1tvdqfkk](https://backpack.exchange/join/1tvdqfkk)
- **CoinMarketCap**: [https://coinmarketcap.com/exchanges/backpack-exchange/](https://coinmarketcap.com/exchanges/backpack-exchange/)
- **CoinGecko**: [https://www.coingecko.com/en/exchanges/backpack-exchange](https://www.coingecko.com/en/exchanges/backpack-exchange)
- **Fees**: [https://support.backpack.exchange/exchange/trading/trading-fees](https://support.backpack.exchange/exchange/trading/trading-fees)
...
- **API Docs**: [https://docs.backpack.exchange/](https://docs.backpack.exchange/)
