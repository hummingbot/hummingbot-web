---
title: "Rate Limits"
description: "Run trading bots on Rate Limits with Hummingbot — Decentralized Exchange (DEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
