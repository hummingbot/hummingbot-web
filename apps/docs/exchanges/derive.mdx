...
| [📓 Connector Guide](https://hummingbot.org/blog/using-derive-with-hummingbot) | ✅ | 
...
Access the [Paper Trade](/documentation/client/global-configs/paper-trade) version of this connector by running `connect derive_paper_trade` instead of `connect derive`.
