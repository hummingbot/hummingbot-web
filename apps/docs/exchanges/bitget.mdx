---
title: "Bitget"
description: "Run trading bots on Bitget with Hummingbot — Centralized Exchange (CEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
