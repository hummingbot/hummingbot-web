---
title: "Dydx"
description: "Run trading bots on Dydx with Hummingbot — Decentralized Exchange (DEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
