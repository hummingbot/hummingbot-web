...
> **Foundation Sponsor**
>
> dYdX is a [sponsor](https://hummingbot.org/about/sponsors/) of Hummingbot Foundation, so when you use Hummingbot to run bots on dYdX, you're supporting the Foundation and our mission to democratize algo trading with open source software.
...
- **CoinMarketCap**: [https://coinmarketcap.com/exchanges/dydx-v4/](https://coinmarketcap.com/exchanges/dydx-v4/)
- **CoinGecko**: [https://www.coingecko.com/en/exchanges/dydx-chain](https://www.coingecko.com/en/exchanges/dydx-chain)
- **API Docs**: [https://docs.dydx.exchange/api_integration-repositories](https://docs.dydx.exchange/api_integration-repositories)
- **Fees**: [https://docs.dydx.exchange/introduction-trading_fees](https://docs.dydx.exchange/introduction-trading_fees)
- **Supported Countries**: [https://dydx.trade/terms](https://dydx.trade/terms) 
...
- **Folder**: [https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/derivative/dydx_v4_perpetual](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/derivative/dydx_v4_perpetual)
...
This exchange offers a staging (testnet) mode: [https://v4.testnet.dydx.exchange/](https://v4.testnet.dydx.exchange/)
