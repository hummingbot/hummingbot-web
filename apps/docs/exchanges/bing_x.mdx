---
title: "Bing X"
description: "Run trading bots on Bing X with Hummingbot — Centralized Exchange (CEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
