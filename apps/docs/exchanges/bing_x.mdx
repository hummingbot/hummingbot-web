...
- **CoinGecko**: [https://www.coingecko.com/en/exchanges/bingx](https://www.coingecko.com/en/exchanges/bingx)
- **API Docs**: [https://bingx-api.github.io/docs/#/en-us/common/introduce](https://bingx-api.github.io/docs/#/en-us/common/introduce)
- **Fees**: [https://bingx.com/support/costs/](https://bingx.com/support/costs/)
...
2. When creating your account you can use our Referral Code (`7VFN4OVG`) to enjoy 20% rebate.
   ...
   ![Referral Code](/images/exchanges/bing_x/bingx-api5.png)
...
4. Click on the ***Create API*** button
   ...
   ![Create API](/images/exchanges/bing_x/bingx-api1.png)
...
5. Write a label for your API Keys and then select the permission options that you want (enabling the withdrawal permission requires linking IP addresses on the box below) and click ***Confirm***
   ...
   ![API Permission](/images/exchanges/bing_x/bingx-api2.png)

6. Enter your corresponding verification codes.

   ![Security Verification](/images/exchanges/bing_x/bingx-api3.png)

7. Copy your API keys and store them somewhere safe.

   ![Get API Key](/images/exchanges/bing_x/bingx-api4.png)
...
- **Folder**: [https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/exchange/bing_x](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/exchange/bing_x)
