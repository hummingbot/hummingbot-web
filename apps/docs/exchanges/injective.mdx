---
title: "Injective"
description: "Run trading bots on Injective with Hummingbot — Decentralized Exchange (DEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
...
- **CoinMarketCap**: [https://coinmarketcap.com/currencies/injective](https://coinmarketcap.com/currencies/injective)
- **CoinGecko**: [https://www.coingecko.com/en/coins/injective](https://www.coingecko.com/en/coins/injective)
- **API Docs**: [https://api.injective.exchange](https://api.injective.exchange)
- **Fees**: [https://docs.injective.network/learn/basic-concepts/gas_and_fees/](https://docs.injective.network/learn/basic-concepts/gas_and_fees/)
- **Supported Countries**: 
...
- **Folder**: [https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/exchange/injective_v2](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/exchange/injective_v2)
...
- **Connection Type**: gRPC
- **Folder**: [https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/derivative/injective_v2_perpetual](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/derivative/injective_v2_perpetual)
