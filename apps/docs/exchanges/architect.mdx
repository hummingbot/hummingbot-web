---
title: "Architect"
description: "Run trading bots on Architect with Hummingbot — Centralized Exchange (CEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
...
- **Website**: [https://architect.co](https://architect.co)
- **API Docs**: [https://docs.architect.exchange/api-reference/user-management/get-whoami](https://docs.architect.exchange/api-reference/user-management/get-whoami)
- **Fees**: [https://docs.architect.exchange/guides/accounts-fees/fee-structure](https://docs.architect.exchange/guides/accounts-fees/fee-structure)
