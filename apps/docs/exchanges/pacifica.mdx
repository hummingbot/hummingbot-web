---
title: "Pacifica"
description: "Run trading bots on Pacifica with Hummingbot — Decentralized Exchange (DEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
...
- **Website**: [https://app.pacifica.fi/](https://app.pacifica.fi/)
- **CoinMarketCap**: [https://coinmarketcap.com/exchanges/pacifica/?type=perpetual](https://coinmarketcap.com/exchanges/pacifica/?type=perpetual)
- **CoinGecko**: [https://www.coingecko.com/en/exchanges/pacifica](https://www.coingecko.com/en/exchanges/pacifica)
- **API Docs**: [https://docs.pacifica.fi/](https://docs.pacifica.fi/)
- **Fees**: [https://docs.pacifica.fi/trading-on-pacifica/trading-fees](https://docs.pacifica.fi/trading-on-pacifica/trading-fees)
...
- **Folder**: [https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/derivative/pacifica_perpetual](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/derivative/pacifica_perpetual)
...
This perp exchange offers a paper trading mode: [https://test-app.pacifica.fi/](https://test-app.pacifica.fi/)
