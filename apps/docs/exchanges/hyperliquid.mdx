---
title: "Hyperliquid"
description: "Run trading bots on Hyperliquid with Hummingbot — Decentralized Exchange (DEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
...
| [📓 Connector Guide](../blog/posts/using-hyperliquid-vaults-with-hummingbot/index) | ✅ |
...
> **Tip**
>
> See the [Hyperliquid Vault Guide](../blog/posts/using-hyperliquid-vaults-with-hummingbot/index) for more details on how to use Hyperliquid VauLts.
