...
Access the [Paper Trade](/documentation/client/global-configs/paper-trade) version of this connector by running `connect kraken_paper_trade` instead of `connect kraken`.
