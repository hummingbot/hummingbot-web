...
Access the [Paper Trade](/documentation/client/global-configs/paper-trade) version of this connector by running `connect kucoin_paper_trade` instead of `connect kucoin`.
