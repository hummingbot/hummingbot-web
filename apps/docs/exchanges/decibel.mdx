---
title: "Decibel"
description: "Run trading bots on Decibel with Hummingbot — Decentralized Exchange (DEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
...
- **Website**: [https://app.decibel.trade/](https://app.decibel.trade/)
- **Testnet**: [https://testnet-decibel.vercel.app/](https://testnet-decibel.vercel.app/)
- **API Docs**: [https://docs.decibel.trade/](https://docs.decibel.trade/)
- **Fees**: [https://docs.decibel.trade/for-traders/fees](https://docs.decibel.trade/for-traders/fees)
...
- **Folder**: [https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/derivative/decibel_perpetual](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/connector/derivative/decibel_perpetual)
...
This perp exchange offers a testnet mode: [https://testnet-decibel.vercel.app/](https://testnet-decibel.vercel.app/)
