---
title: "Gateway"
description: "Connect Hummingbot to Gateway — connector status, supported components, and configuration."
---
...
See [Gateway](../../gateway/index) for more information.
...
The community can propose changes to connector maintenance, bounty allocations, and connector removals through [Hummingbot Governance Proposals (HGP)](../../about/proposals). This process also determines which [blockchains and networks](../../gateway/chains) that Gateway supports.
...
New Gateway connectors may be contributed by community members via [Hummingbot Governance Proposals (HGP)](../../about/proposals), which require a pull request with the connector code to the Hummingbot Gateway Github repo, along with a minimum HBOT balance to create.
...
|----------|------------|--------|-----|----------------|-------|
| [Jupiter](./jupiter) | `solana` | | ✓ | `swap` | |
| [Meteora](./meteora) | `solana` | | ✓ | `clmm` | |
| [Raydium](./raydium) | `solana` | | ✓ | `clmm`, `amm` | |
| [Balancer](./balancer) | `ethereum` | ✓ |  | `amm` | |
| [Curve](./curve) | `ethereum` | ✓ |  | `amm` | |
| [ETCSwap](./etcSwap) | `ethereum` | ✓ |  | `amm`, `amm_lp` | |
| [Pancakeswap](./pancakeswap) | `binance-smart-chain` | ✓ |  | `amm`, `amm_lp` | |
| [Quickswap](./quickswap) | `polygon` | ✓ |  | `amm` | |
| [Sushiswap](./sushiswap) | `ethereum` | ✓ |  | `amm` | |
| [TraderJoe](./traderjoe) | `avalanche` | ✓ |  | `amm` | |
| [Uniswap](./uniswap) | `ethereum` | ✓ | | `amm`, `amm_lp` | |
