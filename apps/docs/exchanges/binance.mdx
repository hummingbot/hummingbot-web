...
| [📓 Connector Guide](https://hummingbot.org/blog/using-binance-with-hummingbot) | ✅ | 
...
> **Tip**
>
> See the [Binance Connector Guide](https://hummingbot.org/blog/using-binance-with-hummingbot) for details on create API keys on Binance.
...
Access the [Paper Trade](/documentation/client/global-configs/paper-trade) version of this connector by running `connect binance_paper_trade` instead of `connect binance`.
