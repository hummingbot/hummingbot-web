---
title: "Grvt"
description: "Run trading bots on Grvt with Hummingbot — Decentralized Exchange (DEX), Central Limit Order Book (CLOB). Connector status, supported components, and setup."
---
...
- **CoinMarketCap**: [https://coinmarketcap.com/exchanges/grvt/](https://coinmarketcap.com/exchanges/grvt/)
- **CoinGecko**: [https://www.coingecko.com/en/exchanges/grvt-futures](https://www.coingecko.com/en/exchanges/grvt-futures)
- **API Docs**: [https://api-docs.grvt.io/auth/](https://api-docs.grvt.io/auth/)
- **Fees**: [https://help.grvt.io/en/articles/9614699-how-does-grvt-s-fee-model-work](https://help.grvt.io/en/articles/9614699-how-does-grvt-s-fee-model-work)
