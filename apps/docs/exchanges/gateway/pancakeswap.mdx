...
For EVM-based networks (BNB Chain, Ethereum, Arbitrum, Base), see [Gateway Connect](/documentation/gateway/commands#gateway-connect) for instructions on connecting your wallet to Gateway.
