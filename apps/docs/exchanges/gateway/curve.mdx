---
title: "Curve"
description: "Connect Hummingbot to Curve via Gateway — a decentralized exchange for on-chain swaps and liquidity provision. Connector info, supported pool types, and configuration."
---
