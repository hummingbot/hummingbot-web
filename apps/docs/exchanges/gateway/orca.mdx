---
title: "Orca"
description: "Connect Hummingbot to Orca via Gateway — a decentralized exchange for on-chain swaps and liquidity provision. Connector info, supported pool types, and configuration."
---
