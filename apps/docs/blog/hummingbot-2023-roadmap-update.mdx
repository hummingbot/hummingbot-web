...
1. Expanded Hummingbot to directional strategies by introducing the [Candles Feed](/documentation/strategies/v2-strategies/candles) OHLCV generator and the [PositionExecutor Smart Component](/documentation/strategies/v2-strategies/executors), enhancing the efficiency and flexibility of our trading algorithms
2. Introduced the [Orchestration Module](/documentation/installation/broker) to simplify the management of multiple trading bots and strategies, which is being developed by a community team
