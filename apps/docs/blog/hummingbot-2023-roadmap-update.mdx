...
description: "In December, we shared our ambitious [technical roadmap](../hummingbot-2023-technical-roadmap/index.md) for 2023, detailing the features and improvements w"
date: "2023-05-02"
category: "Roadmap"
---

![](/images/blog/hummingbot-2023-roadmap-update/cover.png)

In December, we shared our ambitious [technical roadmap](/images/blog/hummingbot-2023-roadmap-update/../hummingbot-2023-technical-roadmap/index.md) for 2023, detailing the features and improvements we planned to introduce throughout the year. Today, we are excited to provide an update on the progress we've made, the milestones we've reached, and the exciting plans we have for the remainder of the year.
...
1. Expanded Hummingbot to directional strategies by introducing the [Candles Feed](/images/blog/hummingbot-2023-roadmap-update/../../../strategies/v2-strategies/candles/index.md) OHLCV generator and the [PositionExecutor Smart Component](/images/blog/hummingbot-2023-roadmap-update/../../../strategies/v2-strategies/executors/index.md), enhancing the efficiency and flexibility of our trading algorithms
2. Introduced the [Orchestration Module](/images/blog/hummingbot-2023-roadmap-update/../../../installation/broker.md) to simplify the management of multiple trading bots and strategies, which is being developed by a community team
...
![](/images/blog/hummingbot-2023-roadmap-update/./Screen-Shot-2023-05-02-at-3.00.20-PM.png)
