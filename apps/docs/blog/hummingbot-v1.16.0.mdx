...
[Bounties](../bounties/index) offer a platform for those seeking development work on exchange connectors, strategies, bug fixes, and more to connect with skilled developers capable of building these solutions. 

Check out our new guides for prospective Contributors and Sponsors:

* [Contributors](../bounties/contributors) 
* [Sponsors](/exchanges/)
...
* [#6284](https://github.com/hummingbot/hummingbot/pull/6284) Fixed issue where [Gate.io](../exchanges/gate-io/index) and [Kucoin Perpetual](../exchanges/kucoin/index) were showing the incorrect orderbook amount **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
