---
title: "Hummingbot v2.6.1 Release Notes"
description: "Release notes for Hummingbot v2.6.0."
date: "2025-06-09"
category: "Releases"
---
...
<Note> **The Hummingbot client release was updated to `v2.6.1` on June 12, 2025 to hot-fix critical issues with the market making controllers.**
...
Afterwards, follow the instructions to re-install dependencies and compile the codebase for each repository. See [Install Hummingbot from Source](/images/blog/hummingbot-v2.6.0/../installation/hummingbot-client) and [Install Gateway from Source](/images/blog/hummingbot-v2.6.0/../gateway/installation).
...
- [`amm_data_feed_example.py`](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/amm_data_feed_example.py) - Demonstrates real-time price feeds from AMM and CLMM DEXs
- [`amm_trade_example.py`](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/amm_trade_example.py) - Triggers a swap when price reaches a certain level on AMM and CLMM DEXs
- [`clmm_manage_position.py`](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/clmm_manage_position.py) - Automatically enter and exit LP positions on CLMM DEXs
...
Check out the full guide: [Using XRP Ledger with Hummingbot](/images/blog/hummingbot-v2.6.0/../blog/posts/using-xrpl-with-hummingbot/index)
