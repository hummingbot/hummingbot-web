...
description: "Epoch 3 polls prioritizes maintenance of exchanges, strategies, and issues in the Hummingbot codebase"
date: "2023-01-13"
category: "Governance"
---
...
![](/images/blog/epoch-3-polls-recap/cover.png)
...
![](/images/blog/epoch-3-polls-recap/./2.png)

The CEX Connectors poll places [centralized exchange connectors](/images/blog/epoch-3-polls-recap/../../../connectors/index.md) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the January-March 2023 release cycles. The poll received 39 distinct votes, for a total of 22 million HBOT voting power spent.
...
![](/images/blog/epoch-3-polls-recap/./3.png)

The DEX Connectors poll places [decentralized exchange connectors](/images/blog/epoch-3-polls-recap/../../../gateway/connectors.md) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the January-March 2023 release cycles. The poll received 32 distinct votes, for a total of 20 million HBOT voting power spent.
...
![](/images/blog/epoch-3-polls-recap/./4.png)
...
[Pure Market Making (PMM)](/images/blog/epoch-3-polls-recap/../../../strategies/v1-strategies/pure-market-making.md)

[Cross Exchange Market Making (XEMM)](/images/blog/epoch-3-polls-recap/../../../strategies/v1-strategies/cross-exchange-market-making.md)

[AMM Arbitrage](/images/blog/epoch-3-polls-recap/../../../strategies/v1-strategies/amm-arbitrage.md)
...
![](/images/blog/epoch-3-polls-recap/./shane-rounce-DNkoNXQti3c-unsplash.jpg)
