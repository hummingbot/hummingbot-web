---
title: "Hummingbot v1.27.0 Release Notes"
description: "Release notes for Hummingbot v1.27.0."
date: "2024-04-29"
category: "Releases"
---
...
The new [**Funding Rate Arbitrage**](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/funding_rate_arb.py) sample script works by exploiting differences in funding rates across different cryptocurrency exchanges to make a profit. 
...
[XEMM Executor](/images/blog/hummingbot-v1.27.0/../strategies/v2-strategies/executors/xemm-executor) is a new **Strategy V2 component**  which is designed to handle cross-exchange market making (XEMM) operations within the Hummingbot framework. 

You can use the [v2_xemm.py](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/v2_xemm.py) script to run it. We have also added a Controller version taht supports multiple order levels: [xemm_multiple_levels.py](https://github.com/hummingbot/hummingbot/blob/master/controllers/generic/xemm_multiple_levels.py).

**Pull Request:**  [#6946](https://github.com/hummingbot/hummingbot/pull/6946)

## Updated Docker Installation Process

We have simplified and updated the [Docker installation](/installation/hummingbot-client) instructions so that users can install from the base Hummingbot Github repo. This change aims to enhance user experience by providing a more organized and straightforward approach to using Hummingbot's powerful features.

The page includes [advanced configuration examples ](/installation/hummingbot-client) as well that were previously hosted in the `deploy-examples` repo, which now features a single, comprehensive deployment example designed to launch multiple bots efficiently. 

## Updated CEX Connector: Coinbase

**Pull Request:**  [#6887](https://github.com/hummingbot/hummingbot/pull/6887) - Added Coinbase Advanced Trade connector
...
For more information, refer to the [Cube](/images/blog/hummingbot-v1.27.0/../exchanges/cube/index) connector docs.
...
- [#6937](https://github.com/hummingbot/hummingbot/pull/6937) - Added `injective_fee_calculator_multiplier_config` for [Injective](/images/blog/hummingbot-v1.27.0/../exchanges/injective) **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
- [#6940](https://github.com/hummingbot/hummingbot/pull/6940) - Updated [Binance](/images/blog/hummingbot-v1.27.0/../exchanges/binance/index) & OKX `nextFundingTime` to 10-bit integer **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
- [#6956](https://github.com/hummingbot/hummingbot/pull/6956) - Updated [Vertex's](/images/blog/hummingbot-v1.27.0/../exchanges/vertex) hostnames **Thanks to [Wandering-Consciousness](https://github.com/Wandering-Consciousness) for this fix! 🙏**
...
- [#6962](https://github.com/hummingbot/hummingbot/pull/6962) - Fixed an issue where the [Hyperliquid](/images/blog/hummingbot-v1.27.0/../exchanges/hyperliquid) funding rate was not updated **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
- [#6966](https://github.com/hummingbot/hummingbot/pull/6966) -  Added support for High-Frequency Trading (HFT) accounts on the [KuCoin](/images/blog/hummingbot-v1.27.0/../exchanges/kucoin/index) Pro platform **Thanks to [supervik](https://github.com/supervik) for this contribution! 🙏**
