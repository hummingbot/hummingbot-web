---
title: "Hummingbot v1.28.0 Release Notes"
description: "Release notes for Hummingbot v1.28.0."
date: "2024-05-31"
category: "Releases"
---
...
- [#6983](https://github.com/hummingbot/hummingbot/pull/6983) - Fixed rate limits issue for [Cube](/images/blog/hummingbot-v1.28.0/../exchanges/cube/index) **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
...
- [#6999](https://github.com/hummingbot/hummingbot/pull/6999) - Fixed issue where [Kucoin](/images/blog/hummingbot-v1.28.0/../exchanges/kucoin/index) exchange ID was showing 'none'  **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
- [#7002](https://github.com/hummingbot/hummingbot/pull/7002) - Fixed issue with OKX Perpetual orders with wrong amount **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
...
- [#7013](https://github.com/hummingbot/hummingbot/pull/7013) - Fixed issue with [Hyperliquid](/images/blog/hummingbot-v1.28.0/../exchanges/hyperliquid) reversing order on close **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
- [#7016](https://github.com/hummingbot/hummingbot/pull/7016) - Refactored Polkadex API to latest version **Thanks to [dizpers](https://github.com/dizpers) for this fix! 🙏**
- [#7022](https://github.com/hummingbot/hummingbot/pull/7022) - Added OKX spot candles feed **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this contribution! 🙏**
- [#7027](https://github.com/hummingbot/hummingbot/pull/7027) - Fixed issue with [Hyperliquid](/images/blog/hummingbot-v1.28.0/../exchanges/hyperliquid) error setting leverage **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
...
- [#7033](https://github.com/hummingbot/hummingbot/pull/7033) - Added minor improvements to the [Cube](/images/blog/hummingbot-v1.28.0/../exchanges/cube/index) connector **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
- [#7049](https://github.com/hummingbot/hummingbot/pull/7049) - Added hotfix to remove "expired" markets from the [Cube](/images/blog/hummingbot-v1.28.0/../exchanges/cube/index) connector to prevent users from trading on them  **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
