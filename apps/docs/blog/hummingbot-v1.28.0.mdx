...
- [#6983](https://github.com/hummingbot/hummingbot/pull/6983) - Fixed rate limits issue for [Cube](../exchanges/cube/index) **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
...
- [#6999](https://github.com/hummingbot/hummingbot/pull/6999) - Fixed issue where [Kucoin](../exchanges/kucoin/index) exchange ID was showing 'none'  **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
...
- [#7013](https://github.com/hummingbot/hummingbot/pull/7013) - Fixed issue with [Hyperliquid](../exchanges/hyperliquid) reversing order on close **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
...
- [#7027](https://github.com/hummingbot/hummingbot/pull/7027) - Fixed issue with [Hyperliquid](../exchanges/hyperliquid) error setting leverage **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
...
- [#7033](https://github.com/hummingbot/hummingbot/pull/7033) - Added minor improvements to the [Cube](../exchanges/cube/index) connector **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
- [#7049](https://github.com/hummingbot/hummingbot/pull/7049) - Added hotfix to remove "expired" markets from the [Cube](../exchanges/cube/index) connector to prevent users from trading on them  **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
