...
![cover](/images/blog/using-vega-protocol-with-hummingbot/cover.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/vega-console.png)](/images/blog/using-vega-protocol-with-hummingbot/vega-console.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/vega-install-snap.png)](/images/blog/using-vega-protocol-with-hummingbot/vega-install-snap.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/vega-deposit.png)](/images/blog/using-vega-protocol-with-hummingbot/vega-deposit.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/vega-network.png)](/images/blog/using-vega-protocol-with-hummingbot/vega-network.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/vega-deposit-3.png)](/images/blog/using-vega-protocol-with-hummingbot/vega-deposit-3.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/snap_key.png)](/images/blog/using-vega-protocol-with-hummingbot/snap_key.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/metamask_snap_02.gif)](/images/blog/using-vega-protocol-with-hummingbot/metamask_snap_02.gif)
...
<Warning> **Your wallet seed phrase is extremely sensitive. Keep it confidential and never share it online or with anyone you don't trust. Always ensure you're in a secure and private environment when handling your seed phrase.**
### Install Hummingbot
...
Now, install Hummingbot by following the [installation process](/images/blog/using-vega-protocol-with-hummingbot/../../../installation/index.md). The easiest way to get started is to clone the Github repo and launch the Docker image:
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/connect_vega.gif)](/images/blog/using-vega-protocol-with-hummingbot/connect_vega.gif)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/balance.png)](/images/blog/using-vega-protocol-with-hummingbot/balance.png)
...
This is a simple directional strategy that enters into long positions when the market is oversold (as measured by [RSI](https://en.wikipedia.org/wiki/Relative_strength_index)). Alternatively, if the market is overbought, the bot will enter into a short position. After a position is created, the strategy uses a [PositionExecutor](/images/blog/using-vega-protocol-with-hummingbot/../../../strategies/v2-strategies/executors/positionexecutor.md) to manage it.
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/config.png)](/images/blog/using-vega-protocol-with-hummingbot/config.png)
...
* You'll need to use a different exchange (like Binance Futures) other than Vega for `candles_exchange`, since Vega does not currently support [Candles](/images/blog/using-vega-protocol-with-hummingbot/../../../strategies/v2-strategies/candles/index.md) yet.
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/logs.png)](/images/blog/using-vega-protocol-with-hummingbot/logs.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/status.png)](/images/blog/using-vega-protocol-with-hummingbot/status.png)
...
[![image](/images/blog/using-vega-protocol-with-hummingbot/data-node.png)](/images/blog/using-vega-protocol-with-hummingbot/data-node.png)
