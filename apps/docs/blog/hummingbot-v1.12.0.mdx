...
- Adjusted the documentation pages for each [Exchange Connector](../exchanges/index) and [Strategy](../strategies/index)
...
See the [Gateway Setup](../gateway/installation) documentation page for more information on how to approve tokens.
