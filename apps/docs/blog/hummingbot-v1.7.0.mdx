---
title: "Release Notes - Version 1.7.0"
description: "Release notes for Hummingbot v1.7.0."
date: "2022-08-31"
category: "Releases"
---
...
- **Install via Docker**: [Linux](/images/blog/hummingbot-v1.7.0/../installation/hummingbot-client) | [Windows](/images/blog/hummingbot-v1.7.0/../installation/hummingbot-client) | [macOS](/images/blog/hummingbot-v1.7.0/../installation/hummingbot-client) | [Raspberry Pi](/images/blog/hummingbot-v1.7.0/../installation/hummingbot-client)
...
Now, the `cross exchange market making` strategy now has an option to use DEXes as taker exchanges. Now, you can hedge your filled orders on any [Gateway-supported AMM](/images/blog/hummingbot-v1.7.0/../gateway/index)!

## New Script examples

We have added more [examples](https://github.com/hummingbot/hummingbot/tree/master/strategies/scripts) of [Scripts](/strategies/scripts) for the upcoming [Hummingbot BotCamp](https://hummingbot.thinkific.com/) developer bootcamp.
...
- Improved Gateway [developer setup docs](/gateway/installation)
- New Gateway [testing docs](/gateway/commands)
