...
Now, the `cross exchange market making` strategy now has an option to use DEXes as taker exchanges. Now, you can hedge your filled orders on any [Gateway-supported AMM](../gateway/index)!
