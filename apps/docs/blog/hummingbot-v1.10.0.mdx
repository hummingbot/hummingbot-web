---
title: "Release Notes - Version 1.10.0"
description: "Release notes for Hummingbot v1.10.0."
date: "2022-11-29"
category: "Releases"
---
...
- **Install via Docker**: [Linux](/images/blog/hummingbot-v1.10.0/../installation/hummingbot-client) | [Windows](/images/blog/hummingbot-v1.10.0/../installation/hummingbot-client) | [macOS](/images/blog/hummingbot-v1.10.0/../installation/hummingbot-client) | [Raspberry Pi](/images/blog/hummingbot-v1.10.0/../installation/hummingbot-client)
...
- BNB Chain: [PancakeSwap](/images/blog/hummingbot-v1.10.0/../exchanges/gateway/pancakeswap) and [SushiSwap](/images/blog/hummingbot-v1.10.0/../exchanges/gateway/sushiswap)
...
- [Gate.io](/images/blog/hummingbot-v1.10.0/../exchanges/gate-io/index) is operated by Gate Technology Corp. Their mission is to serve the blockchain industry by providing secure and reliable products & services to consumers and companies around the world.
...
All scripts examples can be found [here](/images/blog/hummingbot-v1.10.0/../strategies/scripts/examples).
