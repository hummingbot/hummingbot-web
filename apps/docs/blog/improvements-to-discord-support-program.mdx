...
description: "Fourteen months have passed since the introduction of the [Discord Support Program](https://snapshot.org//hbot-ip.eth/proposal/0x588779179d0229db7de2de9e23"
date: "2024-02-26"
category: "Announcements"
---

![](/images/blog/improvements-to-discord-support-program/cover.webp)
...
But with the introduction of new Hummingbot features like [Dashboard](https://github.com/hummingbot/dashboard) and [V2 Strategies](/images/blog/improvements-to-discord-support-program/../../../strategies/v2-strategies/index.md), newer members of our community have struggling to keep pace with troubleshooting and issue resolution. In response, the Foundation team has intensified its engagement with community members on Discord by answering questions. Moreover, we are committed to keeping our community members abreast of the newest Hummingbot developments on the [roadmap](/images/blog/improvements-to-discord-support-program/../hummingbot-2024-technical-roadmap/index.md), including the imminent launch of the Condor Telegram bot, custom screeners, and advanced AI capabilities.
...
At the end of the month, contributors will receive their total bounties earned, [either in USDC or HBOT](/images/blog/improvements-to-discord-support-program/../launching-usdc-payouts-for-bounty-recipients/index.md) based on the current preference they indicated in the onboarding form.
