---
title: "Hummingbot v2.0.1 Release Notes"
description: "Release notes for Hummingbot v2.0.1."
date: "2024-08-28"
category: "Releases"
---
...
The new **dYdX** API connector has been upgraded to v4 in this release, enabling users to run bots on one of the leading decentralized perpetual DEXs! Due to dependency conflicts, we have created a custom Docker image and custom scripts to help users install Hummingbot with dYdX. The complete install instructions can be found in the [dYdX connector docs](/images/blog/hummingbot-v2.0.1/../exchanges/dydx), and see the blog post announcing the new dYdX sponsorship [here](/images/blog/hummingbot-v2.0.1/../blog/posts/dydx-v4-connector/index)!
...
Authentication is disabled by default. However, if you want to enable it, please follow the instructions provided for your specific setup: **[Docker](/images/blog/hummingbot-v2.0.1/../blog/posts/quickstart-dashboard/index#docker)** | **[Source](/images/blog/hummingbot-v2.0.1/../blog/posts/quickstart-dashboard/index#source)**.
...
**Pull Request:**  [#7102](https://github.com/hummingbot/hummingbot/pull/7102) - Added [Bitstamp](/images/blog/hummingbot-v2.0.1/../exchanges/bitstamp/index) connector
...
**Pull Request:**  [#7170](https://github.com/hummingbot/hummingbot/pull/7170) - Added Hashkey Global connector
...
**Pull Request:**  [#7119](https://github.com/hummingbot/hummingbot/pull/7119) | [#338](https://github.com/hummingbot/gateway/pull/338) - Added **Telos** connector
...
- [#6987](https://github.com/hummingbot/hummingbot/pull/6987) - Updated [dYdX perpetual](/images/blog/hummingbot-v2.0.1/../exchanges/dydx) connector to latest v4 **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
...
- [#7103](https://github.com/hummingbot/hummingbot/pull/7103) - Fixed time sync related error detection for [Kucoin Perpetual](/images/blog/hummingbot-v2.0.1/../exchanges/kucoin/index) **Thanks to [Jbekker](https://github.com/Jbekker) for this fix! 🙏**
- [#7108](https://github.com/hummingbot/hummingbot/pull/7108) - Added additional hotfixes for [XRPL connector](/images/blog/hummingbot-v2.0.1/../exchanges/xrpl) **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
- [#7118](https://github.com/hummingbot/hummingbot/pull/7118) - Added support for seed phrase connect in [Injective V2](/images/blog/hummingbot-v2.0.1/../exchanges/injective)  **Thanks to [peterwilli](https://github.com/peterwilli) for this fix! 🙏**
- [#7121](https://github.com/hummingbot/hummingbot/pull/7121) - Cleaned up Hummingbot repo 
- [#7122](https://github.com/hummingbot/hummingbot/pull/7122) - Fixed time related error check for [Mexc](/images/blog/hummingbot-v2.0.1/../exchanges/mexc/index) **Thanks to [Jbekker](https://github.com/Jbekker) for this fix! 🙏** 
...
- [#7137](https://github.com/hummingbot/hummingbot/pull/7137) - Fixed [OKX](/images/blog/hummingbot-v2.0.1/../exchanges/okx/index) issue with false insufficient balance error for market buy order **Thanks to [Jbekker](https://github.com/Jbekker) for this fix! 🙏**
...
- [#7182](https://github.com/hummingbot/hummingbot/pull/7182) - Added [Mexc](/images/blog/hummingbot-v2.0.1/../exchanges/mexc/index) August 16 API updates  **Thanks to [Kaiwen0418](https://github.com/Kaiwen0418) for this fix! 🙏**
