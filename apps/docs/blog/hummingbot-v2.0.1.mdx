...
Authentication is disabled by default. However, if you want to enable it, please follow the instructions provided for your specific setup: **[Docker](/blog/quickstart-dashboard#docker)** | **[Source](/blog/quickstart-dashboard#source)**.
