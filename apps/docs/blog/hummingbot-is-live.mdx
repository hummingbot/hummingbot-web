...
For an explanation of the CLI and a summary of commands, visit the [Hummingbot documentation](../../../client/user-interface).

#### Initializing and configuring Hummingbot

![Configuring Hummingbot](/images/blog/hummingbot-is-live/./hummingbot-config.gif)

Hummingbot is initialized and configured through a step-by-step command line interface (see [Client](../../../client/index) for a full example).
...
#### Get started
- [Install Hummingbot](../../../installation/index)
