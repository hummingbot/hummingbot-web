...
For an explanation of the CLI and a summary of commands, visit the [Hummingbot documentation](/documentation/client/user-interface).

#### Initializing and configuring Hummingbot

Hummingbot is initialized and configured through a step-by-step command line interface (see [Client](/documentation/client) for a full example).
...
#### Get started
- [Install Hummingbot](/installation)
