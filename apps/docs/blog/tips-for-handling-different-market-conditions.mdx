...
Increasing the [filled_order_delay](/images/blog/tips-for-handling-different-market-conditions/../../../strategies/v1-strategies/strategy-configs/filled-order-delay.md) parameter places a delay between a filled order and when the next order is placed. By increasing the filled_order_delay parameter, it reduces the risk of filling too many orders on one side or the other.
