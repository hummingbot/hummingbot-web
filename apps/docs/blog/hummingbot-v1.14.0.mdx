...
We have streamlined and simplified the [Installation](../installation/hummingbot-client) section, adding OS-specific guides and [a new Docker page](../installation/hummingbot-client) that explains how to deploy various Hummingbot configurations using Docker.
...
- [Cheatsheet](../strategies/scripts/cheatsheet): Reference for creating Scripts
- Smart Components: Self-executing, encapsulated piece of logic like `PositionExecutor`
- [Orchestration Module](../installation/broker): Community-maintained repo for orchestrating multiple bots
...
See the [Orchestration Module](../installation/broker) documentation for more information.
...
See the [Kucoin Perpetual](../exchanges/kucoin/index) documentation for more information.
