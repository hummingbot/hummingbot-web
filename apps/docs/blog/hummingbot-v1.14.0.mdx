---
title: "Release Notes - Version 1.14.0"
description: "Release notes for Hummingbot v1.14.0."
date: "2023-03-30"
category: "Releases"
---
...
We have streamlined and simplified the [Installation](/images/blog/hummingbot-v1.14.0/../installation/hummingbot-client) section, adding OS-specific guides and [a new Docker page](/images/blog/hummingbot-v1.14.0/../installation/hummingbot-client) that explains how to deploy various Hummingbot configurations using Docker.
...
- [Cheatsheet](/images/blog/hummingbot-v1.14.0/../strategies/scripts/cheatsheet): Reference for creating Scripts
- Smart Components: Self-executing, encapsulated piece of logic like `PositionExecutor`
- [Orchestration Module](/images/blog/hummingbot-v1.14.0/../installation/broker): Community-maintained repo for orchestrating multiple bots
...
See the [Orchestration Module](/images/blog/hummingbot-v1.14.0/../installation/broker) documentation for more information.
...
See the [Kucoin Perpetual](/images/blog/hummingbot-v1.14.0/../exchanges/kucoin/index) documentation for more information.
...
See the [Dexalot](/images/blog/hummingbot-v1.14.0/../exchanges/dexalot) connector documentation for more information.
