...
![](/images/blog/introducing-v2-strategies/./cover.png)
...
[V2 Strategies](/images/blog/introducing-v2-strategies/../../../strategies/v2-strategies/index.md) marks a departure from the more rigid structure of V1 strategies. It's crafted to enable users to create powerful, custom strategies, even those who may not have extensive Python programming experience.
...
![](/images/blog/introducing-v2-strategies/./architecture.png)

An ecosystem of interconnected components let users customize their V2 Strategies:

* [V2 Script](/images/blog/introducing-v2-strategies/../../../strategies/v2-strategies/index.md): This serves as the strategy's blueprint, outlining its configuration and interacting seamlessly with other components.
* [Controller](/images/blog/introducing-v2-strategies/../../../strategies/v2-strategies/controllers/index.md): Acting as the strategy's command center, the Controller interprets input from the V2 Script and steers the overall strategy. It manages Executors, which are crucial for order and position management.
* [Candles](/images/blog/introducing-v2-strategies/../../../strategies/v2-strategies/candles/index.md): Providing a structured snapshot of market data, Candles are pivotal in generating analytical indicators for market analysis.
* [Executors](/images/blog/introducing-v2-strategies/../../../strategies/v2-strategies/executors/index.md): These components autonomously manage orders and positions, ensuring alignment with the strategy's directives.
...
His strategy traded across 3 markets on Binance Futures and generated a positive P%L in each market. Here was one such market analyzed using the Strategy Performance page in [Dashboard](/images/blog/introducing-v2-strategies/../../../dashboard/index.md):

![Trading Strategy Results](/images/blog/introducing-v2-strategies/./performance-1.jpg)

![Binance Futures PnL](/images/blog/introducing-v2-strategies/./performance-0.jpg)
...
![](/images/blog/introducing-v2-strategies/./botcamp-nov-7.png)
