...
For more information, see [Hyperliquid](/images/blog/hummingbot-v1.23.0/../exchanges/hyperliquid) in our exchange connector documentation.
...
See [DEX Connectors - XRP Ledger](/images/blog/hummingbot-v1.23.0/../exchanges/xrpl) and Chain Connectors - XRP Ledger for the respective DEX and chain documentation pages.
...
- [#6684](https://github.com/hummingbot/hummingbot/pull/6684) - Added paper trade support for [Injective v2](/images/blog/hummingbot-v1.23.0/../exchanges/injective) **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
- [#6691](https://github.com/hummingbot/hummingbot/pull/6691) - Added fix for the [MEXC](/images/blog/hummingbot-v1.23.0/../exchanges/mexc/index) partially canceled error **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
...
- [#6702](https://github.com/hummingbot/hummingbot/pull/6702) - Fixed issue with getting more than 100 [gateio_perpetual](/images/blog/hummingbot-v1.23.0/../exchanges/gate-io/index) candles **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
- [#6703](https://github.com/hummingbot/hummingbot/pull/6703) - Added market orders to the [Kraken](/images/blog/hummingbot-v1.23.0/../exchanges/kraken/index) connector
...
- [#247](https://github.com/hummingbot/gateway/pull/247) - Added LP to [PancakeSwap](/images/blog/hummingbot-v1.23.0/../exchanges/gateway/pancakeswap) integration **Thanks to [vic-en](https://github.com/vic-en) for this contribution! 🙏**
