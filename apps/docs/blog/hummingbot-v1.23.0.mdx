---
title: "Hummingbot v1.23.0 Release Notes"
description: "Release notes for Hummingbot v1.23.0."
date: "2023-12-26"
category: "Releases"
---
...
* **Event Link**: [https://discord.gg/ygc7Mrgx?event=1187049283841708072](https://discord.gg/ygc7Mrgx?event=1187049283841708072)
...
**Github Repo:** [https://github.com/hummingbot/helper](https://github.com/hummingbot/helper)
...
For more information, see [Hyperliquid](../exchanges/hyperliquid) in our exchange connector documentation.

**Pull Requests:**  [#6675](https://github.com/hummingbot/hummingbot/pull/6675)

**Snapshot Proposal:** [https://snapshot.org/#/hbot-ncp.eth/proposal/0x138d4160162f5e930e0bba0c8be408bd208d67b481e7924d39c9eba56def11e6](https://snapshot.org/#/hbot-ncp.eth/proposal/0x138d4160162f5e930e0bba0c8be408bd208d67b481e7924d39c9eba56def11e6)
...
See [DEX Connectors - XRP Ledger](../exchanges/xrpl) and Chain Connectors - XRP Ledger for the respective DEX and chain documentation pages.

**Pull Requests:**  [#6535](https://github.com/hummingbot/hummingbot/pull/6535), [#128](https://github.com/hummingbot/gateway/pull/128) 

**Snapshot Proposal:** [https://snapshot.org/#/hbot-ip.eth/proposal/0x07b027fc420274d26add346ed65a2f7e3e5a662bd5317d2ddb2dd02562a7b2d2](https://snapshot.org/#/hbot-ip.eth/proposal/0x07b027fc420274d26add346ed65a2f7e3e5a662bd5317d2ddb2dd02562a7b2d2)
...
- [#6650](https://github.com/hummingbot/hummingbot/pull/6650) - Fixed issue with Polkadex hanging orders and broken pipes **Thanks to [Nullably](https://github.com/Nullably) for this fix! 🙏**
- [#6684](https://github.com/hummingbot/hummingbot/pull/6684) - Added paper trade support for [Injective v2](../exchanges/injective) **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
- [#6691](https://github.com/hummingbot/hummingbot/pull/6691) - Added fix for the [MEXC](../exchanges/mexc/index) partially canceled error **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
...
- [#6702](https://github.com/hummingbot/hummingbot/pull/6702) - Fixed issue with getting more than 100 [gateio_perpetual](../exchanges/gate-io/index) candles **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
- [#6703](https://github.com/hummingbot/hummingbot/pull/6703) - Added market orders to the [Kraken](../exchanges/kraken/index) connector
...
- [#247](https://github.com/hummingbot/gateway/pull/247) - Added LP to [PancakeSwap](../exchanges/gateway/pancakeswap) integration **Thanks to [vic-en](https://github.com/vic-en) for this contribution! 🙏**
