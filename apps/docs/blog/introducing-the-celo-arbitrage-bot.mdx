...
description: "TL;DR In the next release of Hummingbot (ETA 2 weeks), we will be officially supporting the Celo blockchain protocol and releasing a new algorithmic tradin"
date: "2020-06-03"
