...
The CEX Connectors poll places [centralized exchange connectors](https://hummingbot.org/connectors/) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the October-December 2023 release cycles.
...
**🥈 Silver:**  [Gate.io](/exchanges/gate-io), [Kucoin](/exchanges/kucoin), [Huobi](/exchanges/htx)
...
The DEX Connectors poll places [decentralized exchange connectors](/documentation/gateway/connectors) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the October-December 2023 release cycles. 
...
**🥈 Silver:**  [Dexalot](/exchanges/dexalot), Polkadex, [Injective Helix](/exchanges/injective)
...
**🥇 Gold:** [Ethereum](/documentation/gateway/chains)
...
**🥈 Silver:** [Avalanche](/documentation/gateway/chains), [Binance Smart Chain](/documentation/gateway/chains), [Polygon](/documentation/gateway/chains)
