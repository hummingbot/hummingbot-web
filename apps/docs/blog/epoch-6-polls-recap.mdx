...
The CEX Connectors poll places [centralized exchange connectors](../../../connectors/index) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the October-December 2023 release cycles.
...
**🥇 Gold:** [Binance](../../../exchanges/binance/index)
...
**🥈 Silver:**  [Gate.io](../../../exchanges/gate-io/index), [Kucoin](../../../exchanges/kucoin/index), [Huobi](../../../exchanges/htx/index)
...
**🥈 Silver:** [Avalanche](../../../gateway/chains), [Binance Smart Chain](../../../gateway/chains), [Polygon](../../../gateway/chains)
