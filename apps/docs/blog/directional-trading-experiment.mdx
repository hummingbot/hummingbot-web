...
Our strategy employs the Directional Framework, which combines two novel features in Hummingbot: [Candles Feed](../../../strategies/v2-strategies/candles/index) and [PositionExecutor](../../../strategies/v2-strategies/executors/positionexecutor).
