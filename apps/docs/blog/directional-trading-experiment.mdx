...
Our strategy employs the Directional Framework, which combines two novel features in Hummingbot: [Candles Feed](/documentation/strategies/v2-strategies/candles) and [PositionExecutor](/documentation/strategies/v2-strategies/executors/positionexecutor).
