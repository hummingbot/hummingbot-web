...
With the release of a new [connector guide](../using-vega-protocol-with-hummingbot/index) for the Vega DEX connector, we are thrilled to officially welcome [Vega Protocol](https://vega.xyz) as a sponsor and partner of Hummingbot Foundation! 
...
That's why we're excited to warmly introduce Vega as a new Hummingbot Foundation [sponsor](../../../about/index), which will support our efforts to maintain the Vega integration to Hummingbot and educate our respective communities on how to use it!
...
For instance, we just released the [Vega Connector Guide](../using-vega-protocol-with-hummingbot/index), in which we detail creating a Vega wallet, adding credentials to Hummingbot, and how to configure Vega-compatible scripts.

![Vega Connector Guide](/images/blog/announcing-vega-hummingbot-connector-sponsorship/../using-vega-protocol-with-hummingbot/index)
