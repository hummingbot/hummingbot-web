...
![cover](/images/blog/exchange-types-explained-clob-rfq-amm/cover.webp)
...
![CLOB exchanges](/images/blog/exchange-types-explained-clob-rfq-amm/./clob-exchanges.png)
...
![An exchange from the past](/images/blog/exchange-types-explained-clob-rfq-amm/./traders.png)
...
![(Open the image in a new tab to expand it)](/images/blog/exchange-types-explained-clob-rfq-amm/./CLOB-exchange.png)
...
![RFQ Exchanges](/images/blog/exchange-types-explained-clob-rfq-amm/./airswap-kyber.png)
...
![(RFQ)](/images/blog/exchange-types-explained-clob-rfq-amm/./rfq-exchange.png)
...
![AMMs](/images/blog/exchange-types-explained-clob-rfq-amm/./bancor-uniswap.png)
...
![Determining purchase price on a constant product market maker](/images/blog/exchange-types-explained-clob-rfq-amm/./automated-mm.png)

To understand numerically how automated market maker pricing works, this [spreadsheet](http://bit.ly/2VhceZT) may be helpful.

![Example](/images/blog/exchange-types-explained-clob-rfq-amm/./constant-product-mm.png)
