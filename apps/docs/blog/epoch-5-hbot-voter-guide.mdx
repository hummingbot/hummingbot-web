...
Here are the 26 [CEX Connector](https://hummingbot.org/connectors/) nominees for Epoch 5:
...
Here are the 19 [DEX Connectors](/documentation/gateway/connectors) nominees for Epoch 5:
...
- [AMM-Arbitrage](https://hummingbot.org/strategies/v1-strategies/amm-arbitrage/) (Epoch 4 Core)
- [Avellaneda Market Making](https://hummingbot.org/strategies/v1-strategies/avellaneda-market-making/)
- [Cross-Exchange Market Making](https://hummingbot.org/strategies/v1-strategies/cross-exchange-market-making/) (Epoch 4 Core)
- [Cross-Exchange Mining](https://hummingbot.org/strategies/v1-strategies/cross-exchange-mining/)
- [Hedge](https://hummingbot.org/strategies/v1-strategies/hedge/)
- [Liquidity Mining](https://hummingbot.org/strategies/v1-strategies/liquidity-mining/)
- [Perpetual Market Making](https://hummingbot.org/strategies/v1-strategies/perpetual-market-making/)
- [Pure Market Making](https://hummingbot.org/strategies/v1-strategies/pure-market-making/) (Epoch 4 Core)
- [Spot Perpetual Arbitrage](https://hummingbot.org/strategies/v1-strategies/spot-perpetual-arbitrage/)
- [TWAP Executor](/documentation/strategies/v2-strategies/executors/twapexecutor) (V1 TWAP strategy removed)
- [AMM-V3 LP](https://hummingbot.org/strategies/) (Epoch 4 Core)
