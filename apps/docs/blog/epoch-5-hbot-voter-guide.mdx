...
Here are the 26 [CEX Connector](../../../connectors/index) nominees for Epoch 5:
...
The Core Strategies poll selects the top 3 [strategies](../../../strategies/index) in the Hummingbot codebase, which are maintained by Hummingbot Foundation. We will run these strategies to test Hummingbot ad fund bounties to fix bugs discovered during the next Epoch.
...
- [AMM-Arbitrage](../../../strategies/v1-strategies/amm-arbitrage) (Epoch 4 Core)
- [Avellaneda Market Making](../../../strategies/v1-strategies/avellaneda-market-making)
- [Cross-Exchange Market Making](../../../strategies/v1-strategies/cross-exchange-market-making) (Epoch 4 Core)
- [Cross-Exchange Mining](../../../strategies/v1-strategies/cross-exchange-mining)
- [Hedge](../../../strategies/v1-strategies/hedge)
- [Liquidity Mining](../../../strategies/v1-strategies/liquidity-mining)
- [Perpetual Market Making](../../../strategies/v1-strategies/perpetual-market-making)
- [Pure Market Making](../../../strategies/v1-strategies/pure-market-making) (Epoch 4 Core)
- [Spot Perpetual Arbitrage](../../../strategies/v1-strategies/spot-perpetual-arbitrage)
- [TWAP Executor](../../../strategies/v2-strategies/executors/twapexecutor) (V1 TWAP strategy removed)
- [AMM-V3 LP](../../../strategies/index) (Epoch 4 Core)
