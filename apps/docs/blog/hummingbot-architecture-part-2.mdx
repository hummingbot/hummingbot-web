...
description: "In the last article - [Hummingbot Architecture - Part 1](../hummingbot-architecture-part-1/index.md) - of this series, we've discussed the design motivatio"
date: "2021-05-03"
category: "Engineering"
---

![](/images/blog/hummingbot-architecture-part-2/./cover.webp)

## Introduction

In the last article - [Hummingbot Architecture - Part 1](/images/blog/hummingbot-architecture-part-2/../hummingbot-architecture-part-1/index.md) - of this series, we've discussed the design motivations behind Hummingbot, the clock and the market connectors. Today, we'll be discussing the architecture behind trading strategies - the very component that decides Hummingbot trades with your money. We will also discuss how you can diagnose problems and debug Hummingbot in live trading.



## Strategies

![](/images/blog/hummingbot-architecture-part-2/./chess.jpg)
...
![](/images/blog/hummingbot-architecture-part-2/./avellaneda.png)
...
![](/images/blog/hummingbot-architecture-part-2/./getprice.png)
...
![](/images/blog/hummingbot-architecture-part-2/./avi.png)
...
![](/images/blog/hummingbot-architecture-part-2/./avi2.png)
![](/images/blog/hummingbot-architecture-part-2/./avi3.png)
...
![](/images/blog/hummingbot-architecture-part-2/./pc.jpg)
...
![](/images/blog/hummingbot-architecture-part-2/./telegram.png)
...
![](/images/blog/hummingbot-architecture-part-2/./debug5.png)

You can read more about the debug console from [Hummingbot documentation](/images/blog/hummingbot-architecture-part-2/../../../connectors/connectors/debug.md).
...
![](/images/blog/hummingbot-architecture-part-2/./discord.png)
