---
title: "Release Notes - Version 1.13.0"
description: "Release notes for Hummingbot v1.13.0."
date: "2023-02-28"
category: "Releases"
---
...
[6046](https://github.com/hummingbot/hummingbot/pull/6046) added a candles data feed for [binance](/images/blog/hummingbot-v1.13.0/../exchanges/binance/index) and [binance-perpetual](/images/blog/hummingbot-v1.13.0/../exchanges/binance/index). This "signal factory" component allows users to generate custom OHLCV candles using both historical and live Websocket data, allowing traders to use technical indicators to code directional strategies.
...
- [amm_price_example.py](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/amm_price_example.py): Fetches price from a DEX connector using Gateway
- [amm_trade_example.py](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/amm_trade_example.py): Executes a swap using a DEX connector using Gateway
- [candles_example.py](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/candle_example.py): Build custom indicators using the Binance candles feed
- [simple_directional_script_example.py](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/advanced_directional_strategy_example.py): Creates a simple directional strategy that uses RSI
- [advanced_directional_script_example.py](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/simple_directional_strategy_example.py): Creates an advanced directional strategy that uses both RSI and Bollinger Bands
- [microprice_calculator.py](https://github.com/hummingbot/hummingbot/blob/master/strategies/scripts/microprice_calculator.py): Computes the [microprice](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2970694) price estimator using exchange data
...
BTC Markets is a centralized cryptocurrency exchange established in Australia, and is available for local residents only. BTC Markets aims to provide clients with an efficient, secure, and reliable trading platform. Its services are available to individuals, organizations, and Self-Managed Super Funds. See the [btc-markets](/images/blog/hummingbot-v1.13.0/../exchanges/btc-markets) connector documentation for more information.
