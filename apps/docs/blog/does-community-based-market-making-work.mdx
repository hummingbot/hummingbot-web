...
Two months ago, in conjunction with our friends from Harmony Protocol, we started an [experimental program](../introducing-harmony-liquidity-bounties/index) called **$ONE Makers** to see if ordinary individuals using Hummingbot to run market making bots could effectively provide the same level of liquidity as professional market makers.
...
Finally, we also conducted two interviews ( [Interview 1](../interview-with-liquidity-miner-david-salter/index) | [Interview 2](../interview-with-liquidity-miner-dominator008/index) ) with $ONE Makers participants, in which they reported making profits.
