---
title: "Release Notes - Version 1.15.0"
description: "Release notes for Hummingbot v1.15.0."
date: "2023-04-26"
category: "Releases"
---
...
* Injective Chain (removed)
* [Injective (perp)](/images/blog/hummingbot-v1.15.0/../exchanges/injective)
* [Injective (spot)](/images/blog/hummingbot-v1.15.0/../exchanges/injective)

<Note> **There were some fixes to the Injective spot and perpetual connectors that on `development` branch, but not on `master`. Until the May 2023 release, we recommend running the `development` branch of Hummingbot and Hummingbot Gateway.**
