---
title: "Hummingbot v2.5.0 Release Notes"
description: "Release notes for Hummingbot v2.5.0."
date: "2025-04-21"
category: "Releases"
---
...
Afterwards, follow the instructions to re-install dependencies and compile the codebase for each repository. See [Install Hummingbot from Source](/images/blog/hummingbot-v2.5.0/../installation/hummingbot-client) and [Install Gateway from Source](/images/blog/hummingbot-v2.5.0/../gateway/installation).
...
This release also adds a new [**PMM Controller**](https://github.com/hummingbot/hummingbot/blob/master/controllers/generic/pmm.py), a new strategy that leverages the `PositionsHeld` feature to provide a modernized V2 version of the [Pure Market Making](/images/blog/hummingbot-v2.5.0/../strategies/v1-strategies/pure-market-making) V1 strategy.
...
- [New Gateway](/images/blog/hummingbot-v2.5.0/../gateway/installation) - For Solana DEX connectors and LP strategies
- Legacy Gateway - For compatibility with older connectors (see Gateway installation documentation)

**Example Scripts**

- [amm_price_example](https://github.com/hummingbot/hummingbot/blob/development/strategies/scripts/amm_price_example.py)
- [amm_trade_example](https://github.com/hummingbot/hummingbot/blob/development/strategies/scripts/amm_price_example.py)
- [clmm_manage_position](https://github.com/hummingbot/hummingbot/blob/development/strategies/scripts/clmm_manage_position.py)
