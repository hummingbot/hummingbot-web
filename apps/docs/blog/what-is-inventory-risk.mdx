...
As I mentioned in the [first academy article](../what-is-market-making/index), the ideal situation for a market maker is when the price is moving without a trend:
...
All you need is know how to code on Python, create a .py file integrated with Humminbot code base, and activate the script through config script_enabled command (you can find more information about scripts [here](../../../strategies/scripts/index).
