...
description: "2019 recap At Hummingbot, our mission is to democratize high-frequency trading (HFT)."
date: "2020-01-02"
category: "Roadmap"
---

![cover](/images/blog/hummingbot-2020-roadmap/cover.jpg)

### 2019 recap
**At Hummingbot, our mission is to democratize high-frequency trading (HFT).**

Before, only hedge funds had the technology to run lucrative HFT strategies like market making and arbitrage. After we [launched Hummingbot](/images/blog/hummingbot-2020-roadmap/../hummingbot-is-live/index.md) in April 2019, ten thousand people around the world have installed our open source HFT software. Currently, Hummingbot's weekly install rate is growing at an 18% clip.



Before, crypto projects and exchanges were held hostage by hedge funds who charged ludicrous fees and required millions in token inventory for market making services. We [announced liquidity mining](/images/blog/hummingbot-2020-roadmap/../liquidity-mining-launch/index.md) in November 2019, which gives projects and exchanges the ability to source liquidity from a decentralized network of both individual and professional liquidity miners, resulting in significant cost savings and transparency gains. Moreover, we project that liquidity miners can [earn 10%+ per year](/images/blog/hummingbot-2020-roadmap/../liquidity-mining-launch/index.md) from running Hummingbot and providing liquidity.
...
![Mockup of the upcoming Hummingbot Miners web app](/images/blog/hummingbot-2020-roadmap/hummingbot-miners.png)
...
After this 4-week test period, we expect to go live with the first wave of liquidity mining campaigns. Since liquidity mining requires custom data infrastructure that collects, stores and transforms real-time order book data for each supported exchange, we plan to expand exchange coverage in waves, starting with Binance and 0x in Wave 1 along with Liquid and other exchanges in Wave 2. Please see this [blog post](/images/blog/hummingbot-2020-roadmap/../liquidity-mining-launch/index.md) for more details.
...
In 2020, we plan to add more diverse market types. As we wrote in this [blog post](/images/blog/hummingbot-2020-roadmap/../exchange-types-explained-clob-rfq-amm/index.md), there are other exchange models such as RFQ and AMM markets. In addition, we plan to integrate with exchanges that offer margin trading, futures, and perpetual swap products.
