...
![cover](/images/blog/liquidity-mining-in-hummingbot-vs-defi/cover.jpg)

The need for liquidity is as constant a theme in the cryptocurrency market as are death and taxes.  However, as we have previously written in other blogs (such as [this one](/images/blog/liquidity-mining-in-hummingbot-vs-defi/../../../blog/posts/introducing-liquidity-mining-a-marketplace-for-market-makers/index.md), the way in which token issuers and exchanges procure market making in the crypto market is broken.  The reliance on high cost, price gouging crypto market makers is just not sustainable or scalable. This led us to propose the [concept of liquidity mining](http://bit.ly/liquiditymining) and launch the [Hummingbot Miners](https://miners.hummingbot.io) platform for decentralized and crowd-sourced market making.
...
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./Asset-A-&-Asset-B.JPG)
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./Asset-A-&-Asset-B-Computation.JPG)
...
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./Asset-A-&-Asset-B-2.JPG)
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./Asset-A-&-Asset-B-Computation-2.JPG)
...
* Hummingbot’s [ONE Makers liquidity bounty program](/images/blog/liquidity-mining-in-hummingbot-vs-defi/../../../blog/posts/introducing-harmony-liquidity-bounties/index.md) for Harmony Protocol in summer 2019, our "liquidity bounties" pilot for liquidity mining.
...
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./amm-1.jpg)
...
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./amm-2.jpg)

The amount of Asset A that the trader receives is simply determined by a mathematical formula:

![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./amm-eq.png)
...
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./Miners_App.JPG)
...
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./Hummingbot.JPG)	
...
![](/images/blog/liquidity-mining-in-hummingbot-vs-defi/./comparison.jpg)
