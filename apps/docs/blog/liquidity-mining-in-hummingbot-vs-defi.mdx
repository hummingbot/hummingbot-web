...
The need for liquidity is as constant a theme in the cryptocurrency market as are death and taxes.  However, as we have previously written in other blogs (such as [this one](/blog/introducing-liquidity-mining-a-marketplace-for-market-makers), the way in which token issuers and exchanges procure market making in the crypto market is broken.  The reliance on high cost, price gouging crypto market makers is just not sustainable or scalable. This led us to propose the [concept of liquidity mining](http://bit.ly/liquiditymining) and launch the [Hummingbot Miners](https://miners.hummingbot.io) platform for decentralized and crowd-sourced market making.
...
* Hummingbot’s [ONE Makers liquidity bounty program](/blog/introducing-harmony-liquidity-bounties) for Harmony Protocol in summer 2019, our "liquidity bounties" pilot for liquidity mining.
