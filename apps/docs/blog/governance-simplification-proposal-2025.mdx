...
description: "By [Michael Feng](https://x.com/fengtality), co-founder of Hummingbot"
date: "2025-12-22"
category: "Governance"
---

![](/images/blog/governance-simplification-proposal-2025/cover.png)
...
2. **Bounties management services**: The Foundation has expanded its services to help new exchanges manage connector development and maintenance via [bounties](/images/blog/governance-simplification-proposal-2025/../../../bounties/index.md)
3. **Platform maturation**: Hummingbot has migrated from a CLI client to an open source ecosystem for algorithmic trading, with [Hummingbot API](/images/blog/governance-simplification-proposal-2025/../../../hummingbot-api/index.md) as the command center running on a cloud server and [Condor](/images/blog/governance-simplification-proposal-2025/../../../condor/index.md) Telegram bot as the primary client. This makes Hummingbot's entire suite of exchanges and bot strategies more accessible than ever.
...
![](/images/blog/governance-simplification-proposal-2025/governance-current.png)
...
![](/images/blog/governance-simplification-proposal-2025/governance-simplification.png)
...
- **Clarifies Board role**: Currently, Board responsibilities are [unclear](/images/blog/governance-simplification-proposal-2025/../../../about/board.md). This change defines a clear, focused responsibility: annual budget approval
