...
description: "By Michael Feng, co-founder of Hummingbot"
date: "2025-12-22"
category: "Governance"
---
...
2. **Bounties management services**: The Foundation has expanded its services to help new exchanges manage connector development and maintenance via [bounties](https://hummingbot.org/bounties/)
3. **Platform maturation**: Hummingbot has migrated from a CLI client to an open source ecosystem for algorithmic trading, with [Hummingbot API](/documentation/hummingbot-api) as the command center running on a cloud server and [Condor](https://hummingbot.org/condor/) Telegram bot as the primary client. This makes Hummingbot's entire suite of exchanges and bot strategies more accessible than ever.
...
- **Clarifies Board role**: Currently, Board responsibilities are [unclear](https://hummingbot.org/about/board/). This change defines a clear, focused responsibility: annual budget approval
