---
title: "Hummingbot v2.7.0 Release Notes"
description: "Release notes for Hummingbot v2.7.0."
date: "2025-07-16"
category: "Releases"
---
...
Afterwards, follow the instructions to re-install dependencies and compile the codebase for each repository. See [Install Hummingbot from Source](/images/blog/hummingbot-v2.7.0/../installation/hummingbot-client) and [Install Gateway from Source](/images/blog/hummingbot-v2.7.0/../gateway/installation).
...
📚 Documentation: [Hummingbot API Overview](/images/blog/hummingbot-v2.7.0/../hummingbot-api/index) | [Developer Guide](/images/blog/hummingbot-v2.7.0/../hummingbot-api/quickstart)
...
📚 Documentation: See examples in the [Developer Guide](/images/blog/hummingbot-v2.7.0/../hummingbot-api/quickstart)
...
📚 Documentation: [Dashboard Overview](/images/blog/hummingbot-v2.7.0/../dashboard/index)
...
📚 Documentation: [Headless Mode](/images/blog/hummingbot-v2.7.0/../client/start-stop#headless-mode)
