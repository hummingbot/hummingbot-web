...
The CEX Connectors poll places [centralized exchange connectors](https://hummingbot.org/connectors/) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the April-June 2023 release cycles.
...
The DEX Connectors poll places [decentralized exchange connectors](/documentation/gateway/connectors) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the April-June 2023 release cycles. The poll received 24 distinct votes, for a total of 24 million HBOT voting power spent.
...
- [Pure Market Making (PMM)](https://hummingbot.org/strategies/v1-strategies/pure-market-making/)
- [AMM Arbitrage](https://hummingbot.org/strategies/v1-strategies/amm-arbitrage/)
- [Cross Exchange Market Making (XEMM)](https://hummingbot.org/strategies/v1-strategies/cross-exchange-market-making/)
