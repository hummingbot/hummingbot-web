...
- Delegation system was terminated: More voting power is now distributed among community members since [the delegation system has ended](../end-of-hbot-delegation/index) on 28 February 2023.
...
The CEX Connectors poll places [centralized exchange connectors](../../../connectors/index) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the April-June 2023 release cycles.
...
The Core Strategies poll defines which [strategies](../../../strategies/index) should be Core (officially maintained by the Foundation) versus Community (maintained by community members or not maintained). There were 27 unique votes in the poll, and the total number of HBOT voting power tallied was 18 million.
...
- [Pure Market Making (PMM)](../../../strategies/v1-strategies/pure-market-making)
- [AMM Arbitrage](../../../strategies/v1-strategies/amm-arbitrage)
- [Cross Exchange Market Making (XEMM)](../../../strategies/v1-strategies/cross-exchange-market-making)
