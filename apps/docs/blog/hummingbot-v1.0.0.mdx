...
description: "Release notes for Hummingbot v1.0.0."
date: "2022-01-27"
category: "Releases"
---
...
- **Install via Docker**: [Linux](/images/blog/hummingbot-v1.0.0/../installation/hummingbot-client) | [Windows](/images/blog/hummingbot-v1.0.0/../installation/hummingbot-client) | [macOS](/images/blog/hummingbot-v1.0.0/../installation/hummingbot-client) | [Raspberry Pi](/images/blog/hummingbot-v1.0.0/../installation/hummingbot-client)
...
We have refactored [`binance`](/images/blog/hummingbot-v1.0.0/../exchanges/binance/index) and [`binance_perpetual`](/images/blog/hummingbot-v1.0.0/../exchanges/binance/index) with the best practices of a Hummingbot connector. Going forward, these connecotrs will be the standard for `spot` and `perpetual` type exchange connectors, respectively. Community developers who want to integrate an exchange into Hummingbot should use these two connectors as references.
