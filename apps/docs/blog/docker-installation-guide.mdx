...
![Alt text](/images/blog/docker-installation-guide/password.png)
...
![Alt text](/images/blog/docker-installation-guide/interface.png)
...
For a more in-depth look, visit [User Interface](/images/blog/docker-installation-guide/../../../client/user-interface.md)
...
[![Alt text](/images/blog/docker-installation-guide/create-script-config.png)](/images/blog/docker-installation-guide/create-script-config.png)

Select the `v2_directional_rsi.py` script and press <kbd>ENTER</kbd>. 

[![Alt text](/images/blog/docker-installation-guide/create-script-config2.png)](/images/blog/docker-installation-guide/create-script-config2.png)
...
[![Alt text](/images/blog/docker-installation-guide/config-script.png)](/images/blog/docker-installation-guide/config-script.png)
...
[![Alt text](/images/blog/docker-installation-guide/load-config-script.png)](/images/blog/docker-installation-guide/load-config-script.png)
...
[![Alt text](/images/blog/docker-installation-guide/script-status.png)](/images/blog/docker-installation-guide/script-status.png)
...
In this example, we'll connect **Binance API** keys. Head over to the [Binance Connector Docs](https://docs.hummingbot.org/exchanges/binance/#generate-api-keys) for instructions on how to generate API keys for [Binance](/images/blog/docker-installation-guide/../../../exchanges/binance/index.md).

Check the [Connectors list](/images/blog/docker-installation-guide/../../../exchanges/index.md) for a list of exchanges that are currently integrated with Hummingbot

<Warning> **Please always keep your API keys secure and do not share them. **
...
![Alt text](/images/blog/docker-installation-guide/connect.png)
...
![Alt text](/images/blog/docker-installation-guide/binance.png)
...
![Alt text](/images/blog/docker-installation-guide/connected.png)
