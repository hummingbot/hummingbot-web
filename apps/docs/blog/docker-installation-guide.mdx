...
For a more in-depth look, visit [User Interface](../../../client/user-interface)
...
[![Alt text](/images/blog/docker-installation-guide/create-script-config.png)](create-script-config.png)

Select the `v2_directional_rsi.py` script and press &lt;kbd>ENTER&lt;/kbd>. 

[![Alt text](/images/blog/docker-installation-guide/create-script-config2.png)](create-script-config2.png)
...
[![Alt text](/images/blog/docker-installation-guide/config-script.png)](config-script.png)
...
[![Alt text](/images/blog/docker-installation-guide/load-config-script.png)](load-config-script.png)
...
[![Alt text](/images/blog/docker-installation-guide/script-status.png)](script-status.png)
...
In this example, we'll connect **Binance API** keys. Head over to the [Binance Connector Docs](https://docs.hummingbot.org/exchanges/binance/#generate-api-keys) for instructions on how to generate API keys for [Binance](../../../exchanges/binance/index).

Check the [Connectors list](../../../exchanges/index) for a list of exchanges that are currently integrated with Hummingbot
