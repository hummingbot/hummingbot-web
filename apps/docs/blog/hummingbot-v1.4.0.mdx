---
title: "Release Notes - Version 1.4.0"
description: "Release notes for Hummingbot v1.4.0."
date: "2022-05-30"
category: "Releases"
---
...
- **Install via Docker**: [Linux](/images/blog/hummingbot-v1.4.0/../installation/hummingbot-client) | [Windows](/images/blog/hummingbot-v1.4.0/../installation/hummingbot-client) | [macOS](/images/blog/hummingbot-v1.4.0/../installation/hummingbot-client) | [Raspberry Pi](/images/blog/hummingbot-v1.4.0/../installation/hummingbot-client)
...
[Gateway Documentation](/images/blog/hummingbot-v1.4.0/../gateway/index)
...
All scripts modules should be stored in the `/strategies/scripts folder` (the old scripts folder is renamed to pmm_scripts).
There is a new version of the start command for the scripts:
`start --script <script_module_name>`

Check out the [Script Strategies documentation](/images/blog/hummingbot-v1.4.0/../strategies/scripts/index)
