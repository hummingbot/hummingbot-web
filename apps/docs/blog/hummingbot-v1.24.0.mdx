---
title: "Hummingbot v1.24.0 Release Notes"
description: "Release notes for Hummingbot v1.24.0."
date: "2024-01-29"
category: "Releases"
---
...
* **Event Link**: [https://discord.gg/8TsJdCnc?event=1199751917715329064](https://discord.gg/8TsJdCnc?event=1199751917715329064)
...
Ever since we introduced [Scripts](/documentation/strategies/scripts) as a lightweight way to create simple trading strategies, users have been asking for the ability to add configuration files for them, as they are able to do for V1 Strategies. Now, they finally can!
...
See [Config Files](https://hummingbot.org/client/config-files//#script-config-files) for details on how to use this feature.

## New Sample V2 Strategies

Hummingbot's new [V2 Strategies](/documentation/strategies/v2-strategies) allow users to create powerful custom strategies by configuring LEGO-like components as building blocks. In this release, we have added a page with a list of [Sample Strategies](https://hummingbot.org/strategies/v2-strategies/examples//) that users can extend and modify.
...
The new [**DManV4**](https://github.com/hummingbot/hummingbot/blob/development/strategies/scripts/v2_dman_v4_multiple_pairs.py) strategy is a sophisticated market making strategy that utilizes Natural True Range (NATR) to dynamically set spreads, along with various advanced parameters for more nuanced controls.
...
**Snapshot Proposal:** [https://snapshot.org/#/hbot-ncp.eth/proposal/0x769ddfb5fd3f283e15192806c53efbf02b9e182ba8a64f5311305786265ef29a](https://snapshot.org/#/hbot-ncp.eth/proposal/0x769ddfb5fd3f283e15192806c53efbf02b9e182ba8a64f5311305786265ef29a)
...
- [#6760](https://github.com/hummingbot/hummingbot/pull/6760) - Refactored [Injective](../exchanges/injective) connectors to use the new chain streams **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
- [#6785](https://github.com/hummingbot/hummingbot/pull/6785) - Fixed directional script bugs and added configurable PMM script
- [#6789](https://github.com/hummingbot/hummingbot/pull/6789) - Fixed `unexpected_error_while_processing_event_201` for [Hyperliquid](../exchanges/hyperliquid) **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏** 
...
- [#6795](https://github.com/hummingbot/hummingbot/pull/6795) - Updated [MEXC](/exchanges/mexc) broker ID

### Gateway

- [#251](https://github.com/hummingbot/gateway/pull/251) - Added [PancakeSwap](../exchanges/gateway/pancakeswap) V3 price calculation **Thanks to [0xcodercrane](https://github.com/0xcodercrane) for this fix! 🙏** 
- [#266](https://github.com/hummingbot/gateway/pull/266) - Fixed [Dexalot](../exchanges/dexalot) issue where `EUROC` and `sAVAX` balances are not recognized  **Thanks to [vic-en](https://github.com/vic-en) for this fix! 🙏** 
- [#272](https://github.com/hummingbot/gateway/pull/272) - Changed default `gasPrice` value for Kujira **Thanks to [danilo-silva-funttastic](https://github.com/danilo-silva-funttastic) for this fix! 🙏**
