...
- [#6760](https://github.com/hummingbot/hummingbot/pull/6760) - Refactored [Injective](/images/blog/hummingbot-v1.24.0/../exchanges/injective) connectors to use the new chain streams **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
- [#6785](https://github.com/hummingbot/hummingbot/pull/6785) - Fixed directional script bugs and added configurable PMM script
- [#6789](https://github.com/hummingbot/hummingbot/pull/6789) - Fixed `unexpected_error_while_processing_event_201` for [Hyperliquid](/images/blog/hummingbot-v1.24.0/../exchanges/hyperliquid) **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏** 
...
- [#6795](https://github.com/hummingbot/hummingbot/pull/6795) - Updated [MEXC](/images/blog/hummingbot-v1.24.0/../exchanges/mexc/index) broker ID


### Gateway

- [#251](https://github.com/hummingbot/gateway/pull/251) - Added [PancakeSwap](/images/blog/hummingbot-v1.24.0/../exchanges/gateway/pancakeswap) V3 price calculation **Thanks to [0xcodercrane](https://github.com/0xcodercrane) for this fix! 🙏** 
- [#266](https://github.com/hummingbot/gateway/pull/266) - Fixed [Dexalot](/images/blog/hummingbot-v1.24.0/../exchanges/dexalot) issue where `EUROC` and `sAVAX` balances are not recognized  **Thanks to [vic-en](https://github.com/vic-en) for this fix! 🙏** 
