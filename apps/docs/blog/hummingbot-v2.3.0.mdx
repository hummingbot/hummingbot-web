...
This release adds support for a Bitmart perpetual connector in [Hummingbot #7368](https://github.com/hummingbot/hummingbot/pull/7368) with the [bounty](https://github.com/hummingbot/hummingbot/issues/7323), funded by the Bitmart team. See the [Bitmart](/exchanges/bitmart) documentation for more information.
