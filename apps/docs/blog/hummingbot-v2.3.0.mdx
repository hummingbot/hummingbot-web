---
title: "Hummingbot v2.3.0 Release Notes"
description: "Release notes for Hummingbot v2.3.0."
date: "2025-02-03"
category: "Releases"
---
...
Afterwards, follow the instructions to re-install dependencies and compile the codebase for each repository. See [Install Hummingbot from Source](/images/blog/hummingbot-v2.3.0/../installation/hummingbot-client) and [Install Gateway from Source](/images/blog/hummingbot-v2.3.0/../gateway/installation).
...
This release adds support for a Bitmart perpetual connector in [Hummingbot #7368](https://github.com/hummingbot/hummingbot/pull/7368) with the [bounty](https://github.com/hummingbot/hummingbot/issues/7323), funded by the Bitmart team. See the [Bitmart](/images/blog/hummingbot-v2.3.0/../exchanges/bitmart/index) documentation for more information.
