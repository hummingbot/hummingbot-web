...
![cover](/images/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/cover.webp)
...
![ETH locked in Uniswap: https://mikemcdonald.github.io/eth-defi/](/images/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/./uniswap-chart.png)
...
![The 3 types of Uniswap users](/images/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/./uniswap-roles.png)
...
Both Hummingbot and Uniswap enable users to profit from providing **liquidity**, a huge problem for many crypto projects. In past blog posts, we've written about [why liquidity is beneficial](/images/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/../how-to-think-about-liquidity-blockcrunch/index.md) and [what happens when liquidity is missing](/images/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/../the-thin-crust-of-liquidity/index.md). 
...
![User interfaces: Hummingbot (left) vs Uniswap (right)](/images/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/./interfaces.png)
