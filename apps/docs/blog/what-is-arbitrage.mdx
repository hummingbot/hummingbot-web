...
description: "Last week we published the [first article](../what-is-market-making/index.md) of the Hummingbot Academy, covering an introduction to what is Market Making,"
date: "2020-09-11"
category: "Tutorials"
---

![cover](/images/blog/what-is-arbitrage/cover.webp)

## Welcome to Hummingbot Academy!

Last week we published the [first article](/images/blog/what-is-arbitrage/../what-is-market-making/index.md) of the **Hummingbot Academy**, covering an introduction to **what is** **Market Making**, and today we discuss Arbitrage in order to answer the following questions:
...
![Photo by Adam Jones (http://adamjones.freeservers.com/)](/images/blog/what-is-arbitrage/banana_market.png) 
...
> 💡 The market maker [like a pawnshop owner](/images/blog/what-is-arbitrage/../what-is-market-making/index.md) operates on a single place, **making** buy and sell offers on the same market. The arbitrageur (like a merchant transporting goods between towns), operates on more than one place, **taking** buy and sell **offers** from two (or more) different markets.
...
![](/images/blog/what-is-arbitrage/spread1.png)
...
![](/images/blog/what-is-arbitrage/spread2.png)
