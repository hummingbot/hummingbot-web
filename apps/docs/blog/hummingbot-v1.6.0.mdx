...
description: "Release notes for Hummingbot v1.6.0."
date: "2022-07-26"
category: "Releases"
---
...
- **Install via Docker**: [Linux](/images/blog/hummingbot-v1.6.0/../installation/hummingbot-client) | [Windows](/images/blog/hummingbot-v1.6.0/../installation/hummingbot-client) | [macOS](/images/blog/hummingbot-v1.6.0/../installation/hummingbot-client) | [Raspberry Pi](/images/blog/hummingbot-v1.6.0/../installation/hummingbot-client)
...
<Warning> **As this new version will automatically migrate any old configuration files due to the config management refactoring, we strongly advise users to create a backup of the config files first prior to updating the bots to 1.6.0. The migration process may also take some time or may encounter issues so it's advisable to implement the update at a more convenient period. Lastly, make sure to remove any existing scripts you have and download instead the latest helper scripts (`create.sh`, `update.sh`) from our installation [page](/images/blog/hummingbot-v1.6.0/../installation/hummingbot-client).**
