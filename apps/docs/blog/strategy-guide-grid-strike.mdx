...
description: "Grid Strike (gridstrike) is a [Controller](../../../strategies/v2-strategies/controllers/index.md) in Hummingbot's StrategyV2 framework that automatically"
date: "2025-10-07"
category: "Tutorials"
---

**Grid Strike** (`grid_strike`) is a [Controller](/images/blog/strategy-guide-grid-strike/../../../strategies/v2-strategies/controllers/index.md) in Hummingbot's StrategyV2 framework that automatically places a grid of buy or sell orders within a set price range.

Unlike [basic grid strategies](https://www.binance.com/en/square/post/24240367765730), Grid Strike utilizes [Executors](/images/blog/strategy-guide-grid-strike/../../../strategies/v2-strategies/executors/index.md) which dynamically manage each order level with configurable take profit and stop loss settings. This means every position opened by the strategy is automatically monitored and closed according to your risk parameters. It can be configured to move with the market trend —- either up or down -- letting you adapt the strategy to changing market conditions.
...
![](/images/blog/strategy-guide-grid-strike/./long-grid.png)
...
* [**Hummingbot Client**](/images/blog/strategy-guide-grid-strike/../../../client/index.md): See [Installation Guide](/images/blog/strategy-guide-grid-strike/../../../installation/index.md) or [Source Installation](/images/blog/strategy-guide-grid-strike/../../../client/installation.md#source-installation) to get started
* [**Hummingbot API + Dashboard**](/images/blog/strategy-guide-grid-strike/../../../hummingbot-api/index.md): See the [Hummingbot Dashboard Quickstart Guide](/images/blog/strategy-guide-grid-strike/../quickstart-dashboard/index.md) for a guide with step-by-step setup instructions
...
![1.png](/images/blog/strategy-guide-grid-strike/1.png)
...
Once you are satisfied with your Grid Strike configuration, add the name of the file to the [Loader Script](/images/blog/strategy-guide-grid-strike/../../../strategies/scripts/examples.md#v2-controller-loader):

```
create --script-config v2_with_controllers
```
![image.png](/images/blog/strategy-guide-grid-strike/image.png)
...
[![image-1.png](/images/blog/strategy-guide-grid-strike/./image-1.png)](/images/blog/strategy-guide-grid-strike/./image-1.png)
...
[![](/images/blog/strategy-guide-grid-strike/./long-grid-order-executor.png)](/images/blog/strategy-guide-grid-strike/./long-grid-order-executor.png)
...
![](/images/blog/strategy-guide-grid-strike/./triple_barrier.png)

Grid Strike creates Grid Executors that implement the Triple Barrier Method, similar to [Position Executors](/images/blog/strategy-guide-grid-strike/../../../strategies/v2-strategies/executors/positionexecutor.md). Set these parameters to define how each order is managed if it is filled:
...
[![](/images/blog/strategy-guide-grid-strike/./long-vs-short-grids.png)](/images/blog/strategy-guide-grid-strike/./long-vs-short-grids.png)
...
![Gridstrike for Short.png](/images/blog/strategy-guide-grid-strike/Gridstrike_for_Short.png)
...
![GridStrike for Long.png](/images/blog/strategy-guide-grid-strike/GridStrike_for_Long.png)
