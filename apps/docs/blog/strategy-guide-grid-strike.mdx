...
**Strategy Code**: [https://github.com/hummingbot/hummingbot/blob/master/controllers/generic/grid_strike.py](https://github.com/hummingbot/hummingbot/blob/master/controllers/generic/grid_strike.py)
...
* [**Hummingbot Client**](../../../client/index): See [Installation Guide](../../../installation/index) or [Source Installation](../../../client/installation#source-installation) to get started
* [**Hummingbot API + Dashboard**](../../../hummingbot-api/index): See the [Hummingbot Dashboard Quickstart Guide](../quickstart-dashboard/index) for a guide with step-by-step setup instructions
...
Once you are satisfied with your Grid Strike configuration, add the name of the file to the [Loader Script](../../../strategies/scripts/examples#v2-controller-loader):
...
[![image-1.png](/images/blog/strategy-guide-grid-strike/./image-1.png)](./image-1.png)
...
[![](/images/blog/strategy-guide-grid-strike/./long-grid-order-executor.png)](./long-grid-order-executor.png)
...
Grid Strike creates Grid Executors that implement the Triple Barrier Method, similar to [Position Executors](../../../strategies/v2-strategies/executors/positionexecutor). Set these parameters to define how each order is managed if it is filled:
...
[![](/images/blog/strategy-guide-grid-strike/./long-vs-short-grids.png)](./long-vs-short-grids.png)
