---
title: "Hummingbot v2.4.0 Release Notes"
description: "Release notes for Hummingbot v2.4.0."
date: "2025-03-03"
category: "Releases"
---
...
Afterwards, follow the instructions to re-install dependencies and compile the codebase for each repository. See [Install Hummingbot from Source](/images/blog/hummingbot-v2.4.0/../installation/hummingbot-client) and [Install Gateway from Source](/images/blog/hummingbot-v2.4.0/../gateway/installation).
...
See the [Derive](/images/blog/hummingbot-v2.4.0/../exchanges/derive/index) documentation for more information.


### Improvements to Existing Exchange Connectors

- [#7315](https://github.com/hummingbot/hummingbot/pull/7315) - Updated [Bitmart](/images/blog/hummingbot-v2.4.0/../exchanges/bitmart/index) to latest API version  **Thanks to [babcoccl](https://github.com/babcoccl) for this fix! 🙏**
- [#7421](https://github.com/hummingbot/hummingbot/pull/7421) - Fixed `last_price` bug in [Dexalot](/images/blog/hummingbot-v2.4.0/../exchanges/dexalot)  **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
- [#7441](https://github.com/hummingbot/hummingbot/pull/7441) - Updated [Bybit](/images/blog/hummingbot-v2.4.0/../exchanges/bybit) to latest API version **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
- [#7442](https://github.com/hummingbot/hummingbot/pull/7442) - Updated [Bitmart](/images/blog/hummingbot-v2.4.0/../exchanges/bitmart/index) ticker parsing  **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
- [#7448](https://github.com/hummingbot/hummingbot/pull/7448) - Updated [Injective](/images/blog/hummingbot-v2.4.0/../exchanges/injective) library version to 1.8  **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
