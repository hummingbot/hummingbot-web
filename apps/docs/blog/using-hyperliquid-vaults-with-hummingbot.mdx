...
![Cover](/images/blog/using-hyperliquid-vaults-with-hummingbot/cover.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image1.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image1.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image2.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image2.png)

Enter the name for the vault and a short description.

[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image3.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image3.png)
...
- [Installation Guide](/images/blog/using-hyperliquid-vaults-with-hummingbot/../../../installation/index.md)
...
Guides for various environments:
  ...
  - [Linux](/images/blog/using-hyperliquid-vaults-with-hummingbot/../../../installation/index.md)
  - [Windows](/images/blog/using-hyperliquid-vaults-with-hummingbot/../../../installation/index.md)
  - [macOS](/images/blog/using-hyperliquid-vaults-with-hummingbot/../../../installation/index.md)

### Trading with Hummingbot

Go to the Trade page.

[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image4.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image4.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image7.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image7.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image8.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image8.png)

Next, start a trading strategy in Hummingbot, and your bot trades should match the trades shown under the Vault.

[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image11.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image11.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image5.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image5.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image6.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/image6.png)

Users just need to go to the [Vault](https://app.hyperliquid.xyz/vaults) page and select Vaults they want to deposit into.

[![HLP](/images/blog/using-hyperliquid-vaults-with-hummingbot/hlp.png)](/images/blog/using-hyperliquid-vaults-with-hummingbot/hlp.png)
