...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image1.png)](image1.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image2.png)](image2.png)

Enter the name for the vault and a short description.

[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image3.png)](image3.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image4.png)](image4.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image7.png)](image7.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image8.png)](image8.png)

Next, start a trading strategy in Hummingbot, and your bot trades should match the trades shown under the Vault.

[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image11.png)](image11.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image5.png)](image5.png)
...
[![Image](/images/blog/using-hyperliquid-vaults-with-hummingbot/image6.png)](image6.png)

Users just need to go to the [Vault](https://app.hyperliquid.xyz/vaults) page and select Vaults they want to deposit into.

[![HLP](/images/blog/using-hyperliquid-vaults-with-hummingbot/hlp.png)](hlp.png)
