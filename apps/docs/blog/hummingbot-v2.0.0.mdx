...
For more info check out the [Hummingbot 2.0 Quickstart Guide](../blog/posts/quickstart-dashboard/index). Some highlights:

- Configure Strategy V2 controllers with a visual editor:

[![](/images/blog/hummingbot-v2.0.0/../assets/img/pmm_simple.png)](../assets/img/pmm_simple.png)

- Backtest your configurations before saving them to Backend-API

[![](/images/blog/hummingbot-v2.0.0/../assets/img/backtesting.png)](../assets/img/backtesting.png)

- Deploy your strategy configurations using a few clicks:

[![](/images/blog/hummingbot-v2.0.0/../assets/img/deploy.png)](../assets/img/deploy.png)

- View real-time status of all instances and their logs:

[![](/images/blog/hummingbot-v2.0.0/../assets/img/instances.png)](../assets/img/instances.png)
