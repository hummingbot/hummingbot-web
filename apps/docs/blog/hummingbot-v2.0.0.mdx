---
title: "Hummingbot v2.0.0 Release Notes"
description: "Release notes for Hummingbot v2.0.0."
date: "2024-07-03"
category: "Releases"
---
...
For more info check out the [Hummingbot 2.0 Quickstart Guide](/images/blog/hummingbot-v2.0.0/../blog/posts/quickstart-dashboard/index). Some highlights:

- Configure Strategy V2 controllers with a visual editor:

[![](/images/blog/hummingbot-v2.0.0/../assets/img/pmm_simple.png)](/images/blog/hummingbot-v2.0.0/../assets/img/pmm_simple.png)

- Backtest your configurations before saving them to Backend-API

[![](/images/blog/hummingbot-v2.0.0/../assets/img/backtesting.png)](/images/blog/hummingbot-v2.0.0/../assets/img/backtesting.png)

- Deploy your strategy configurations using a few clicks:

[![](/images/blog/hummingbot-v2.0.0/../assets/img/deploy.png)](/images/blog/hummingbot-v2.0.0/../assets/img/deploy.png)

- View real-time status of all instances and their logs:

[![](/images/blog/hummingbot-v2.0.0/../assets/img/instances.png)](/images/blog/hummingbot-v2.0.0/../assets/img/instances.png)
...
**Pull Request:**  [#280](https://github.com/hummingbot/gateway/pull/280) - Added **Balancer** connector
