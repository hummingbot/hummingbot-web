...
The `/agent` command enters Agent Builder mode, which connects your LLM to Hummingbot API via [MCP tools](/documentation/mcp). Agent Builder mode guides you through creating a Trading Agent using this framework:
