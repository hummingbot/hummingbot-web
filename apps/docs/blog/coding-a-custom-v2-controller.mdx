...
description: "In this article, we'll explore how to create a custom V2 Controller for Hummingbot to snipe future liquidations on Binance. We'll use a generic controller"
date: "2024-08-03"
category: "Engineering"
---

![cover](/images/blog/coding-a-custom-v2-controller/cover.webp)
...
![](/images/blog/coding-a-custom-v2-controller/liquidation_example.png)

## Coding the Strategy

I intentionally omit the imports here for better readability. You can download the full source-code here: [liquidations_sniper.py](/images/blog/coding-a-custom-v2-controller/liquidations_sniper.py)

### Control flow

Let's quickly understand the high-level control flow of the controller we are going to build.

![](/images/blog/coding-a-custom-v2-controller/control_flow.png)
...
Add the file [liquidations_sniper.py](/images/blog/coding-a-custom-v2-controller/liquidations_sniper.py) to your Hummingbot installation like this:

![](/images/blog/coding-a-custom-v2-controller/hummingbot_controllers.png)
...
![](/images/blog/coding-a-custom-v2-controller/configuration.png)
...
If you are unsure about the reason for this, just read the docs: [Strategies V2 Architecture](/images/blog/coding-a-custom-v2-controller/../../../strategies/v2-strategies/index.md)
...
![](/images/blog/coding-a-custom-v2-controller/strategy_configuration.png)
...
![](/images/blog/coding-a-custom-v2-controller/running_strategy.png)

#### Monitor live status

You can monitor the actual execution with the command: `status --live`

![](/images/blog/coding-a-custom-v2-controller/live_status.png)
