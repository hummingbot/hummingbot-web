...
- [Installation Guide](../../../installation/index)
...
To begin trading, a strategy must be configured. The two strategies supported natively by the Osmosis connector are [**amm_arb**](../../../strategies/v1-strategies/amm-arbitrage) and **amm_v3_lp**.
