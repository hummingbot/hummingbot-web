...
![cover](/images/blog/using-osmosis-with-hummingbot/cover.png)
...
<Note> **Please ensure your wallet has sufficient balance, including OSMO for gas fees**
<br>
...
- [Installation Guide](/images/blog/using-osmosis-with-hummingbot/../../../installation/index.md)
...
- [Linux](/images/blog/using-osmosis-with-hummingbot/../../../installation/index.md)
- [Windows](/images/blog/using-osmosis-with-hummingbot/../../../installation/index.md)
- [MacOS](/images/blog/using-osmosis-with-hummingbot/../../../installation/index.md)
...
<Note> **For a linked Keplr-Google wallet, find instructions to export the private key [here](https://help.keplr.app/articles/how-to-view-your-private-key).**
...
1. Export Keplr seed phrase.
   ![image](/images/blog/using-osmosis-with-hummingbot/view-keplr-seed.png)
...
2. Restore the wallet using the seed phrase, in a different Cosmos-based wallet (such as Leap wallet) which allows exporting the private key.
   ![image](/images/blog/using-osmosis-with-hummingbot/import-seed-leap.png)
...
2. Scroll down to the ‘Security’ section and select ‘Export Private Key’.
   ![image](/images/blog/using-osmosis-with-hummingbot/export-private-key-leap-1.png)
...
4. Copy down the private key and _be sure to discard_ the ‘0x’ at the beginning of the displayed key.
   ![image](/images/blog/using-osmosis-with-hummingbot/export-private-key-leap-2.png)

<Note> **Images made with Leap version 0.10.7 and Keplr version 0.12.70; in Chrome.**
...
<Note> **Hummingbot stores both API keys and private keys on the local machine in encrypted form, with the Hummingbot client password as the key.**
![image](/images/blog/using-osmosis-with-hummingbot/gateway-connect-osmosis.png)
...
To begin trading, a strategy must be configured. The two strategies supported natively by the Osmosis connector are [**amm_arb**](/images/blog/using-osmosis-with-hummingbot/../../../strategies/v1-strategies/amm-arbitrage.md) and **amm_v3_lp**.
...
![image](/images/blog/using-osmosis-with-hummingbot/create-amm-v3-lp-osmosis.png)
...
![image](/images/blog/using-osmosis-with-hummingbot/import-list.png)

If successful, you will see:

![image](/images/blog/using-osmosis-with-hummingbot/imported.png)
...
<Note> **The `amm_arb` strategy will first request confirmation of selected wallets.**
![image](/images/blog/using-osmosis-with-hummingbot/run-strat.png)
...
<Note> **The `status` command currently has a [issue](https://github.com/hummingbot/gateway/issues/294) with amm_v3_lp strategy.**
## Known Issues
...
If you are interested in contributing or funding a bounty for development of additional features or improvements for this connector or related strategies, please feel free to contact [Pecunia.Finance](/images/blog/using-osmosis-with-hummingbot/mailto:pecuniafinancedao@protonmail.com).
