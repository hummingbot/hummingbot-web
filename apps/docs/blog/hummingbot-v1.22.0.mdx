...
![](/strategies/v2-strategies/diagrams/1.png)

Dive into the documentation at [V2 Strategies](/strategies/v2-strategies/) to explore the full potential of these new strategies!
...
* [#6640](https://github.com/hummingbot/hummingbot/pull/6640) - Fixed issue with [Kucoin Perpetual](../exchanges/kucoin/index) leverage **Thanks to [leastchaos](https://github.com/leastchaos) for this fix! 🙏**
