...
See [FoxBit](/images/blog/hummingbot-v1.22.0/../exchanges/foxbit) for the exchange connector docs.
...
* [#6640](https://github.com/hummingbot/hummingbot/pull/6640) - Fixed issue with [Kucoin Perpetual](/images/blog/hummingbot-v1.22.0/../exchanges/kucoin/index) leverage **Thanks to [leastchaos](https://github.com/leastchaos) for this fix! 🙏**
