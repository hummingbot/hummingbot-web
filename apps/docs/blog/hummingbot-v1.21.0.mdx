...
* [#6584](https://github.com/hummingbot/hummingbot/pull/6584) Addressed a problem with order cancellation, status and revamped processes on [Binance Perps](/exchanges/binance). 
* [#6596](https://github.com/hummingbot/hummingbot/pull/6596) Updated [Binance](/exchanges/binance) Spot API request weight rate limits for enhanced rate limit handling **Thanks to [isreallee82](https://github.com/isreallee82) for this fix! 🙏**
