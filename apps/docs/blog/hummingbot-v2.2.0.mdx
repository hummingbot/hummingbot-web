...
Users can now use the Arbitrage Controller (see below) or the [AMM arbitrage](../strategies/v1-strategies/amm-arbitrage) V1 strategy to run arbitrage strategies between Jupiter and other Hummingbot-supported exchanges. See the [Jupiter](../exchanges/gateway/jupiter) documentation for more information.
