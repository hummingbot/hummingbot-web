---
title: "Hummingbot v2.2.0 Release Notes"
description: "Release notes for Hummingbot v2.2.0."
date: "2024-12-26"
category: "Releases"
---
...
Afterwards, follow the instructions to re-install dependencies and compile the codebase for each repository. See [Install Hummingbot from Source](/images/blog/hummingbot-v2.2.0/../installation/hummingbot-client) and [Install Gateway from Source](/images/blog/hummingbot-v2.2.0/../gateway/installation).
...
Users can now use the Arbitrage Controller (see below) or the [AMM arbitrage](/images/blog/hummingbot-v2.2.0/../strategies/v1-strategies/amm-arbitrage) V1 strategy to run arbitrage strategies between Jupiter and other Hummingbot-supported exchanges. See the [Jupiter](/images/blog/hummingbot-v2.2.0/../exchanges/gateway/jupiter) documentation for more information.

### New Hyperliquid Spot Connector

This release adds support for Hyperliquid spot markets in [Hummingbot #7282](https://github.com/hummingbot/hummingbot/pull/7282), funded by the Hyperliquid Connector Pot voted by the HBOT token holders in quarterly polls. See the [Hyperliquid](/images/blog/hummingbot-v2.2.0/../exchanges/hyperliquid) documentation for more information. 
