...
The CEX Connectors poll places [centralized exchange connectors](../../../connectors/index) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the July-September 2023 release cycles.
...
The Core Strategies poll defines which [strategies](../../../strategies/index) should be Core (officially maintained by the Foundation) versus Community (maintained by community members or not maintained). There were 22 unique votes in the poll, and the total number of HBOT voting power tallied was 75 million.
