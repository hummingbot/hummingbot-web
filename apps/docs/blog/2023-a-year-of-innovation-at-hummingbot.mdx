...
In the [2023 Technical Roadmap](../hummingbot-2023-technical-roadmap/index), we defined 4 key goals:
...
- **New Standard for CLOB DEX Connectors**: We added [Injective Helix](../../../exchanges/injective), Vertex, and [Hyperliquid](../../../exchanges/hyperliquid) as Python-based DEX connectors to the Hummingbot client, allowing for enhanced performance and efficiency.
...
In 2023, we greatly expanded the scripting capabilities in Hummingbot by adding the [V2 Strategy Framework](../../../strategies/v2-strategies/index), which marked a revolutionary leap forward for Hummingbot:
