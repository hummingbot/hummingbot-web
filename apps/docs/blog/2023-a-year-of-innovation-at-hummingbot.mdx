...
In 2023, we greatly expanded the scripting capabilities in Hummingbot by adding the [V2 Strategy Framework](/documentation/strategies/v2-strategies), which marked a revolutionary leap forward for Hummingbot:
