---
title: "Release Notes - Version 1.17.0"
description: "Release notes for Hummingbot v1.17.0."
date: "2023-06-26"
category: "Releases"
---
...
This release refactors the Position Executor smart component that creates self-executing [Triple Barrier](https://www.mlfinlab.com/en/latest/labeling/tb_meta_labeling.html) positions. Notably, this refactor integrates **both spot and perpetual support**, so that users can use the same component across both exchange types interchangeably.

Check out how few lines of code the sample directional scripts are now:

* [`directional_strategy_rsi_spot.py`](https://github.com/hummingbot/hummingbot/blob/development/strategies/scripts/directional_strategy_rsi_spot.py)
* [`directional_strategy_rsi.py`](https://github.com/hummingbot/hummingbot/blob/development/strategies/scripts/directional_strategy_rsi.py)
...
<Note> **In this release, we also improved test mocking for candles by ensuring that a coroutine related to filling historical candles is properly mocked.**
...
* [#127](https://github.com/hummingbot/gateway/pull/127) Changed default gas setting for Polygon to 400
* [#131](https://github.com/hummingbot/gateway/pull/131) Refactored TraderJoe to use SDK V2 **Thanks to [CoinAlpha](https://github.com/coinalpha) for this fix! 🙏**
