...
description: "by [Emerald](https://github.com/peterwilli)"
date: "2024-10-08"
category: "Connectors"
---
...
1. Open the extension in your browser, you should see this screen. Click the "Create new wallet" button: ![](/images/blog/injective-connector-guide/705f8cb92a52c56738575421236411a2.png)

2. Click "Create new recovery phrase": ![](/images/blog/injective-connector-guide/a0ee03251d5df6ad9533584f4ea7fd30.png)
...
6. In the next screen, the application will ask you to enter 2 random words that you have written down, this is to double-check if you have written them down correctly. ![](/images/blog/injective-connector-guide/41ad3d314ac18e01f0095dd20e94ee36.png)
...
10. In the chain selection screen, find Injective and turn it on, then hit save: ![](/images/blog/injective-connector-guide/60fd6d124c5b101546d468915af53142.png)

#### Create the Trading account

1. Repeat the process above, but name the wallet "Hummingbot Trading"
2. You should have something like this now when you click on the account icon on the top right of the extension pane: ![](/images/blog/injective-connector-guide/bee4a6fba0a4a92532d75c6a918d105d.png)
...
If you don't wish to buy INJ and add funds to your accounts, you can go to the faucet here: [https://inj.supply](https://inj.supply)
...
![](/images/blog/injective-connector-guide/04b68cc4736b8d70b16f2eea17af52bb.png)
...
![](/images/blog/injective-connector-guide/c1bbb92721f5681e616f10cd2adfbfb3.png)
