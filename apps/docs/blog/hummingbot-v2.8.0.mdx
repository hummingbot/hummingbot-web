---
title: "Hummingbot v2.8.0 Release Notes"
description: "Release notes for Hummingbot v2.8.0."
date: "2025-08-21"
category: "Releases"
---
...
Afterwards, follow the instructions to re-install dependencies and compile the codebase for each repository. See [Install Hummingbot from Source](/images/blog/hummingbot-v2.8.0/../installation/hummingbot-client) and [Install Gateway from Source](/images/blog/hummingbot-v2.8.0/../gateway/installation).
...
**Standardized Schemas**: Implemented three universal trading schemas across all DEX connectors:
  ...
  - [**Router Schema**](/images/blog/hummingbot-v2.8.0/../gateway/connectors#router-schema): DEX aggregators (Jupiter, 0x, Uniswap Router) that find optimal swap routes
  - [**AMM Schema**](/images/blog/hummingbot-v2.8.0/../gateway/connectors#amm-schema): Traditional V2-style constant product pools (Raydium AMM, Uniswap V2)
  - [**CLMM Schema**](/images/blog/hummingbot-v2.8.0/../gateway/connectors#clmm-schema): V3-style concentrated liquidity pools (Meteora DLMM, Raydium CLMM, Uniswap V3)
...
**New Configuration System**: 
  ...
  - See [Configuration Guide](/images/blog/hummingbot-v2.8.0/../gateway/configuration) for details

#### 🎮 Gateway Commands in Hummingbot

Added comprehensive [Gateway commands](/images/blog/hummingbot-v2.8.0/../gateway/commands) directly in the Hummingbot client:
...
* **[Jupiter](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/jupiter)**: Complete rewrite with Router schema, improved route finding and error handling
* **[Meteora](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/meteora)**: New DLMM (Dynamic Liquidity Market Maker) support with CLMM schema
* **[Raydium](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/raydium)**: Dual support for AMM V2 pools and CLMM V3 concentrated liquidity
* **[Uniswap](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/uniswap)**: Migrated to Universal Router with support for V2 AMM, V3 CLMM, and Smart Order Router
...
* **[PancakeSwap](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/pancakeswap)** - BNB Chain AMM/CLMM ([Bounty #7654](https://github.com/hummingbot/hummingbot/issues/7654))
* **[Balancer](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/balancer)** - Multi-asset AMM pools ([Bounty #7653](https://github.com/hummingbot/hummingbot/issues/7653))
* **[Curve](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/curve)** - Stablecoin-optimized AMM ([Bounty #7652](https://github.com/hummingbot/hummingbot/issues/7652))
* **[SushiSwap](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/sushiswap)** - Multi-chain AMM/CLMM
* **[QuickSwap](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/quickswap)** - Polygon AMM/CLMM
* **[TraderJoe](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/traderjoe)** - Avalanche AMM/CLMM
* **[ETCSwap](/images/blog/hummingbot-v2.8.0/../exchanges/gateway/etcSwap)** - Ethereum Classic AMM

See the [DEX Connectors](/images/blog/hummingbot-v2.8.0/../gateway/connectors) page for full details on upgrading these connectors to the v2.8.0 standard. 
...
* **[Gateway Documentation](/images/blog/hummingbot-v2.8.0/../gateway/index)**: Complete rewrite with practical guides and examples
* **[Gateway Strategies](/images/blog/hummingbot-v2.8.0/../gateway/strategies)**: New scripts demonstrating AMM Data Feed, AMM Trade, and LP Position Management
* **[Chain Schemas](/images/blog/hummingbot-v2.8.0/../gateway/chains#chain-schema)**: Standardized request/response schemas for all blockchain operations

#### 🚀 Migration Guide

For users upgrading from Gateway v2.7 or earlier, see the [Gateway Installation Guide](/images/blog/hummingbot-v2.8.0/../gateway/installation) for complete setup instructions.
...
- Based on approval from [community voting](https://snapshot.box/#/s:hbot-ncp.eth/proposal/0x01022a516c3536d015e21b28e90204a7dbc4a65b42c0e2d568847509f7531e6a), the [Foxbit](/images/blog/hummingbot-v2.8.0/../exchanges/foxbit/index) exchange connector was added back in [#7680](https://github.com/hummingbot/hummingbot/pull/7680).
