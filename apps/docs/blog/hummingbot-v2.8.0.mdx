...
* **[Gateway Documentation](../gateway/index)**: Complete rewrite with practical guides and examples
...
- Based on approval from [community voting](https://snapshot.box/#/s:hbot-ncp.eth/proposal/0x01022a516c3536d015e21b28e90204a7dbc4a65b42c0e2d568847509f7531e6a), the [Foxbit](../exchanges/foxbit/index) exchange connector was added back in [#7680](https://github.com/hummingbot/hummingbot/pull/7680).
