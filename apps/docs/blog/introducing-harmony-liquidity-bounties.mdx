...
We've written before about the [small-cap liquidity crisis](../the-thin-crust-of-liquidity/index) in equities, in which smaller stocks can't attract liquidity because the large trading firms focus on market making for the largest stocks on the most liquid trading venues.
