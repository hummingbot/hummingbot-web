---
title: "Hummingbot v2.9.0 Release Notes"
description: "Release notes for Hummingbot v2.9.0."
date: "2025-09-24"
category: "Releases"
---
...
Afterwards, follow the instructions to re-install dependencies and compile the codebase for each repository. See [Install Hummingbot from Source](/images/blog/hummingbot-v2.9.0/../installation/hummingbot-client) and [Install Gateway from Source](/images/blog/hummingbot-v2.9.0/../gateway/installation).
...
See the [Quants Lab Documentation](/images/blog/hummingbot-v2.9.0/../quants-lab/index) for detailed information and installation guide.

### 🥞 PancakeSwap Connector

We have refactored and restored the [PancakeSwap](/images/blog/hummingbot-v2.9.0/../exchanges/gateway/pancakeswap) connector to Gateway, enabling trading and liquidity provision using the modernized Gateway architecture on the largest DEX on BNB Chain and other EVM networks.
...
See the [RPC Provider Configuration Guide](/images/blog/hummingbot-v2.9.0/../gateway/rpc) for detailed setup instructions and supported networks.
