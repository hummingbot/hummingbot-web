...
![](/images/blog/botcamp-cohort-7-demo-day/cover.png)
...
In Cohort 7, participants embarked on an intensive 5-week journey to become **Certified StrategyV2 Developers**. Throughout the program, they learned to design, code, and deploy custom algorithmic trading strategies using the [Strategy V2 Framework](/images/blog/botcamp-cohort-7-demo-day/../../../strategies/v2-strategies/index.md). The cohort culminated in a Demo Day, where participants presented their strategies and voted for the best ones.
...
By completing the cohort, participants gained official recognition with [Hummingbot certification](/images/blog/botcamp-cohort-7-demo-day/./../../../community/certification.md) to showcase their skills on social media and professional platforms. In addition, each Demo Day presenter received a limited edition [Cohort 7 NFT](https://opensea.io/assets/ethereum/0x59072271620d3528cb6d7565158b11492b25a4e5/1), commemorating their participation and achievement.
...
![](/images/blog/botcamp-cohort-7-demo-day/mvp.png)
...
![](/images/blog/botcamp-cohort-7-demo-day/cohort-9.png)

Cohort 7 Demo Day was a resounding success, and we are now accepting registrations for the next public cohort of Botcamp, which will offer the new [Hummingbot Market Maker certification](/images/blog/botcamp-cohort-7-demo-day/../../../community/certification.md)!
