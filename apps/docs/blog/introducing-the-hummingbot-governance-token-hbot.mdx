...
description: "HBOT Tokens empower holders to decide how the Hummingbot codebase changes over time through voting on proposals."
date: "2021-12-16"
category: "Governance"
---

![cover](/images/blog/introducing-the-hummingbot-governance-token-hbot/cover.webp)

HBOT Tokens empower holders to decide how the Hummingbot codebase changes over time through voting on proposals.

As announced in [this October post](/images/blog/introducing-the-hummingbot-governance-token-hbot/../introducing-the-hummingbot-foundation/index.md), CoinAlpha has established the Hummingbot Foundation (the "Foundation"), a new, independent open source foundation that will enable a decentralized, community-led software development model for Hummingbot, an open source toolbox for building crypto trading bots.
...
![](/images/blog/introducing-the-hummingbot-governance-token-hbot/./hbot-economics.png)
...
See the [Hummingbot Foundation Governance whitepaper](/images/blog/introducing-the-hummingbot-governance-token-hbot/../../../about/whitepaper.md) for more details.
...
![](/images/blog/introducing-the-hummingbot-governance-token-hbot/./Screen_Shot_2021-12-17_at_11.10.27_AM.png)
...
![](/images/blog/introducing-the-hummingbot-governance-token-hbot/./hbot-claim-site.png)
...
See the [Hummingbot Foundation Governance whitepaper](/images/blog/introducing-the-hummingbot-governance-token-hbot/../../../about/whitepaper.md) for additional details about the governance process, such as proposal types, minim token balance requirements, and quorum/approval thresholds.
