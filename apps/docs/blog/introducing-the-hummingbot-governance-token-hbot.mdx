...
See the [Hummingbot Foundation Governance whitepaper](https://hummingbot.org/about/whitepaper/) for more details.
...
See the [Hummingbot Foundation Governance whitepaper](https://hummingbot.org/about/whitepaper/) for additional details about the governance process, such as proposal types, minim token balance requirements, and quorum/approval thresholds.
