...
Open your web browser and go to [https://dydx.exchange/](https://dydx.exchange/). On the dYdX homepage, click the **"Connect Wallet"** button, typically located in the top-right corner of the page.
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/1.png)](1.png)

From the list of available options, select **"MetaMask"**.

   [![image](/images/blog/using-dydx-v4-with-hummingbot/2.png)](2.png)

MetaMask will open a pop-up asking you to confirm the connection.

   [![image](/images/blog/using-dydx-v4-with-hummingbot/3.png)](3.png)  
   [![image](/images/blog/using-dydx-v4-with-hummingbot/4.png)](4.png)

After the wallet is connected, dYdX will prompt you to sign a message to generate the dYdX Chain Wallet.

   [![image](/images/blog/using-dydx-v4-with-hummingbot/5.png)](5.png)  
   [![image](/images/blog/using-dydx-v4-with-hummingbot/6.png)](6.png)
...
Once your wallet is connected, you will need to deposit USDC into your dYdX account. USDC is the required trading currency on dYdX.
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/8.png)](8.png)
...
After connecting, locate your **dYdX Chain Address** in the wallet connection settings. Copy this address and store it securely for future reference.
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/9.png)](9.png)
...
To export your secret passphrase, go to the wallet connection settings dropdown and click **"Export Secret Phrase"**.
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/10.png)](10.png)
...
A window will appear. Check the box to confirm that you understand the risks. There may be a short delay before the export button becomes available.
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/11.png)](11.png)
...
To connect Hummingbot to dYdX's v4 perpetual market, you'll need the dYdX v4 secret phrase and chain address from above.
 ...
 To verify the connection, run the **balance** command to check if the displayed balance matches your dYdX account:
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/balance.png)](balance.png)
 ...
 **Create the configuration:**
   ...
   ```
   [![image](/images/blog/using-dydx-v4-with-hummingbot/12.png)](12.png)


  - Once the configuration is done, give the controller config a name or use the default one:

   [![image](/images/blog/using-dydx-v4-with-hummingbot/21.png)](21.png)
 ...
 **Create a script config**
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/script.png)](script.png)

   - Make sure to enter the file name of the controller config we created earlier 

   [![image](/images/blog/using-dydx-v4-with-hummingbot/script2.png)](script2.png)

   - Lastly, give the script config a name

   [![image](/images/blog/using-dydx-v4-with-hummingbot/script3.png)](script3.png)
 ...
 **Start the strategy**
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/22.png)](22.png) 
 ...
 **Monitor the Strategy**
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/23.png)](23.png)
 ...
 **Stop the Bot**
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/24.png)](24.png)

For more details on V2 Strategies or other available controllers, check out the Controllers section of [V2 Strategies](../../../strategies/v2-strategies/controllers/index) documentation. Please note that since dYdX only supports **one-way mode** some V2 Strategies that use Hedge mode may not work correctly with the controller.    
...
- In the **Add Credentials** section:
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/13.png)](13.png)
...
- If the credentials are valid, they will appear under the **Available Accounts and Credentials** section, with `dydx_v4_perpetual` listed under the respective account.
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/14.png)](14.png)
...
[![image](/images/blog/using-dydx-v4-with-hummingbot/15.png)](15.png)
...
- Since dYdX only supports **ONEWAY** mode (not HEDGE mode), make sure to set **Position Mode** to **ONEWAY**.
   ...
   [![image](/images/blog/using-dydx-v4-with-hummingbot/16.png)](16.png)
...
[![image](/images/blog/using-dydx-v4-with-hummingbot/17.png)](17.png)
...
[![image](/images/blog/using-dydx-v4-with-hummingbot/18.png)](18.png)
...
[![image](/images/blog/using-dydx-v4-with-hummingbot/19.png)](19.png)
