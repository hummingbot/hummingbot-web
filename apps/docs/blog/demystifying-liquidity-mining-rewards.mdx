...
![](/images/blog/demystifying-liquidity-mining-rewards/cover.webp)
...
<Tip> **For reference, please review this [sample liquidity mining rewards spreadsheet](http://bit.ly/liquidityminingcalc) which illustrates the calculations described in this blog.**
...
![](/images/blog/demystifying-liquidity-mining-rewards/./rewards-allocation-chart.png)
...
In our [liquidity mining whitepaper](/images/blog/demystifying-liquidity-mining-rewards/../../../liquidity-mining.pdf), we introduced the spread density function ρ(s) for spread s (Equation 1) as a way of mapping spreads to rewards:

![](/images/blog/demystifying-liquidity-mining-rewards/./spread-density-function-graph.png)
...
![](/images/blog/demystifying-liquidity-mining-rewards/./2-total-snapshot-weight.png)
...
![](/images/blog/demystifying-liquidity-mining-rewards/./3_4-miners-allocation.png)
...
![](/images/blog/demystifying-liquidity-mining-rewards/./5-miners-reward.png)
...
<Tip> **The liquidity mining return is an annualized return calculated based on (1) the total amount of mining rewards available for that period, (2) the total volume of eligible orders placed in that period in base currency terms, which is then (3) converted into an annualized rate.**
...
![](/images/blog/demystifying-liquidity-mining-rewards/./6_7-liquidity-mining-return.png)

Specifically for one minute snapshots, the annualized return would be:

![](/images/blog/demystifying-liquidity-mining-rewards/./8-annualized-return.png)

This annualized return can then be used to directly compare the economics of liquidity mining vs. HOLDing (0% return), staking, and lending. In the simulation-based analysis in the [liquidity mining whitepaper](/images/blog/demystifying-liquidity-mining-rewards/../../../liquidity-mining.pdf), we showed that users could potentially earn 10-50% from liquidity mining.
...
![](/images/blog/demystifying-liquidity-mining-rewards/./8-markets-view.png)
