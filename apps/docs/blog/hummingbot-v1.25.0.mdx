...
See Tag: Connector Guides for a full list of the current guides. HBOT holders can propose [Bounties](https://hummingbot.org/bounties/) to fund the creation of additional guides by community contributors.
...
In this release we've revamped the documentation for the Bounties program to make it a lot easier for both Contributors and Sponsors to follow the steps needed to sponsor or contribute to a bounty. See [Lifecycle of a Bounty](https://hummingbot.org/bounties/lifecycle/).
...
- [#6791](https://github.com/hummingbot/hummingbot/pull/6791) - Added [OKX Perpetuals](../exchanges/okx) candles feed **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
...
- [#6811](https://github.com/hummingbot/hummingbot/pull/6811) - Updated [Injective](../exchanges/injective) low level API components **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
- [#6817](https://github.com/hummingbot/hummingbot/pull/6817) - Added [Kraken](/exchanges/kraken) spot candles feed **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
