---
title: "Hummingbot v1.25.0 Release Notes"
description: "Release notes for Hummingbot v1.25.0."
date: "2024-02-26"
category: "Releases"
---
...
See Tag: Connector Guides for a full list of the current guides. HBOT holders can propose [Bounties](/images/blog/hummingbot-v1.25.0/./../bounties/index) to fund the creation of additional guides by community contributors.
...
In this release we've revamped the documentation for the Bounties program to make it a lot easier for both Contributors and Sponsors to follow the steps needed to sponsor or contribute to a bounty. See [Lifecycle of a Bounty](/images/blog/hummingbot-v1.25.0/../bounties/lifecycle).
...
- [#6791](https://github.com/hummingbot/hummingbot/pull/6791) - Added [OKX Perpetuals](/images/blog/hummingbot-v1.25.0/../exchanges/okx) candles feed **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
- [#6796](https://github.com/hummingbot/hummingbot/pull/6796) - Renamed Huobi to HTX **Thanks to [blagodar1](https://github.com/blagodar1) for this fix! 🙏**
- [#6811](https://github.com/hummingbot/hummingbot/pull/6811) - Updated [Injective](/images/blog/hummingbot-v1.25.0/../exchanges/injective) low level API components **Thanks to [aarmoa](https://github.com/aarmoa) for this fix! 🙏**
- [#6817](https://github.com/hummingbot/hummingbot/pull/6817) - Added [Kraken](/images/blog/hummingbot-v1.25.0/../exchanges/kraken/index) spot candles feed **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
