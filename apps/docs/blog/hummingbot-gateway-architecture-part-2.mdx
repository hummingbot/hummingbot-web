...
description: "Update (February 2023): Hummingbot Gateway v2 is now available as a standalone Github repository: [https://github.com/hummingbot/gateway](https://github.co"
date: "2021-10-18"
category: "Engineering"
---

![cover](/images/blog/hummingbot-gateway-architecture-part-2/cover.jpg)
...
In [Part 1](../hummingbot-gateway-architecture-part-1/index) of this series, we have discussed the architectural changes we are making to Hummingbot Gateway v2 to improve its robustness and reliability, to bring it up to the service quality level expected of production trading systems.
