...
We have streamlined and simplified the [Installation](/documentation/installation/hummingbot-client) section, adding OS-specific guides and [a new Docker page](/documentation/installation/hummingbot-client) that explains how to deploy various Hummingbot configurations using Docker.
...
- [Cheatsheet](/documentation/strategies/scripts/cheatsheet): Reference for creating Scripts
- Smart Components: Self-executing, encapsulated piece of logic like `PositionExecutor`
- [Orchestration Module](/documentation/installation/broker): Community-maintained repo for orchestrating multiple bots
...
See the [Orchestration Module](/documentation/installation/broker) documentation for more information.
...
See the [Kucoin Perpetual](/exchanges/kucoin) documentation for more information.
...
We improved the [PositionExecutor](/documentation/strategies/v2-strategies/executors/positionexecutor) Smart Component introduced in the last release:
