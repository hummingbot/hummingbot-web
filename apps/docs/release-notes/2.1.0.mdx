...
### Hummingbot Repository
 ...
 - [#7134](https://github.com/hummingbot/hummingbot/pull/7134) - Added server time sync for [Gate.io](/exchanges/gate-io) **Thanks to [Jbekker](https://github.com/Jbekker) for this fix! 🙏**
