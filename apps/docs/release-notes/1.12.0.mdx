---
title: "Release Notes - Version 1.12.0"
description: "Release notes for Hummingbot v1.12.0."
date: "2023-01-27"
category: "Releases"
---
...
- Adjusted the documentation pages for each [Exchange Connector](../exchanges/index) and [Strategy](https://hummingbot.org/strategies/)
...
For more details of the Epoch 3 poll results check out this blog post: [https://blog.hummingbot.org/epoch-3-polls/](https://blog.hummingbot.org/epoch-3-polls/)
...
See the [Gateway Setup](/documentation/gateway/installation) documentation page for more information on how to approve tokens.
