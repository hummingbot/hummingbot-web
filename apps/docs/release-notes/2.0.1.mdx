...
Authentication is disabled by default. However, if you want to enable it, please follow the instructions provided for your specific setup: **[Docker](https://hummingbot.org/blog/quickstart-dashboard#docker)** | **[Source](https://hummingbot.org/blog/quickstart-dashboard#source)**.
...
**Pull Request:**  [#7102](https://github.com/hummingbot/hummingbot/pull/7102) - Added [Bitstamp](/exchanges/bitstamp) connector
...
- [#7103](https://github.com/hummingbot/hummingbot/pull/7103) - Fixed time sync related error detection for [Kucoin Perpetual](/exchanges/kucoin) **Thanks to [Jbekker](https://github.com/Jbekker) for this fix! 🙏**
...
- [#7122](https://github.com/hummingbot/hummingbot/pull/7122) - Fixed time related error check for [Mexc](/exchanges/mexc) **Thanks to [Jbekker](https://github.com/Jbekker) for this fix! 🙏** 
...
- [#7137](https://github.com/hummingbot/hummingbot/pull/7137) - Fixed [OKX](/exchanges/okx) issue with false insufficient balance error for market buy order **Thanks to [Jbekker](https://github.com/Jbekker) for this fix! 🙏**
...
- [#7182](https://github.com/hummingbot/hummingbot/pull/7182) - Added [Mexc](/exchanges/mexc) August 16 API updates  **Thanks to [Kaiwen0418](https://github.com/Kaiwen0418) for this fix! 🙏**
