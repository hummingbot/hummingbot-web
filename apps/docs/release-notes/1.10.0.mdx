...
- BNB Chain: [PancakeSwap](../exchanges/gateway/pancakeswap) and [SushiSwap](../exchanges/gateway/sushiswap)
...
- Whitebit is a European centralized exchange that offers crypto-to-crypto and crypto-to-fiat transactions with 0.1% trading fees.
...
- [Gate.io](/exchanges/gate-io) is operated by Gate Technology Corp. Their mission is to serve the blockchain industry by providing secure and reliable products & services to consumers and companies around the world.
...
All scripts examples can be found [here](/documentation/strategies/v2-strategies/examples).
