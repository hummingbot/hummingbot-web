...
- [#6983](https://github.com/hummingbot/hummingbot/pull/6983) - Fixed rate limits issue for [Cube](/exchanges/cube) **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
...
- [#6999](https://github.com/hummingbot/hummingbot/pull/6999) - Fixed issue where [Kucoin](/exchanges/kucoin) exchange ID was showing 'none'  **Thanks to [tomasgaudino](https://github.com/tomasgaudino) for this fix! 🙏**
...
- [#7033](https://github.com/hummingbot/hummingbot/pull/7033) - Added minor improvements to the [Cube](/exchanges/cube) connector **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
- [#7049](https://github.com/hummingbot/hummingbot/pull/7049) - Added hotfix to remove "expired" markets from the [Cube](/exchanges/cube) connector to prevent users from trading on them  **Thanks to [mlguys](https://github.com/mlguys) for this fix! 🙏**
