...
Both Hummingbot and Uniswap enable users to profit from providing **liquidity**, a huge problem for many crypto projects. In past blog posts, we've written about [why liquidity is beneficial](https://hummingbot.org/blog/how-to-think-about-liquidity-blockcrunch) and [what happens when liquidity is missing](https://hummingbot.org/blog/the-thin-crust-of-liquidity). 
