...
- [#6691](https://github.com/hummingbot/hummingbot/pull/6691) - Added fix for the [MEXC](/exchanges/mexc) partially canceled error **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
...
- [#6702](https://github.com/hummingbot/hummingbot/pull/6702) - Fixed issue with getting more than 100 [gateio_perpetual](/exchanges/gate-io) candles **Thanks to [yancong001](https://github.com/yancong001) for this fix! 🙏**
- [#6703](https://github.com/hummingbot/hummingbot/pull/6703) - Added market orders to the [Kraken](/exchanges/kraken) connector
