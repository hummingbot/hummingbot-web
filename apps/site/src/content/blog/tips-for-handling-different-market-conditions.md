---
title: "Tips for Handling Different Market Conditions"
description: "by Owen Hobbs In numerous ways, markets can resemble the waves of the ocean. Both have peaks, bottoms, and ultimately return to a midpoint or sea level. Th"
date: "2022-03-02"
author: "Hummingbot Community"
category: "Tutorials"
excerpt: "by Owen Hobbs In numerous ways, markets can resemble the waves of the ocean. Both have peaks, bottoms, and ultimately return to a midpoint or sea level. The approach one takes to navigate the waves is largely dependent on the…"
cover: "/blog/tips-for-handling-different-market-conditions/cover.webp"
---
*by Owen Hobbs*
...
![range-bound-markets](/blog/tips-for-handling-different-market-conditions/image_1.jpg)
...
![calculating-spread](/blog/tips-for-handling-different-market-conditions/image_2.jpg)

## **Order Levels**

By incorporating more advanced features such as [order_levels](https://docs.hummingbot.org/strategies/v1-strategies/strategy-configs/order-levels) and [order_level_spread](https://docs.hummingbot.org/strategies/v1-strategies/strategy-configs/order-levels), one could place additional orders at wider spreads in an attempt to capture more volatile moments that exceed the first order level. The [order_level_amount](https://docs.hummingbot.org/strategies/v1-strategies/strategy-configs/order-levels) parameter can either increase or decrease the subsequent order size after the first level. This can be used according to one's risk appetite. For example, one may be willing to purchase 100 assets at a tighter spread, but is willing to purchase an additional 150 assets at a wider spread as this is less risky.
...
![order-levels](/blog/tips-for-handling-different-market-conditions/image_3.jpg)
...
![offsetting-spreads](/blog/tips-for-handling-different-market-conditions/image_4.jpg)
...
Increasing the [filled_order_delay](https://docs.hummingbot.org/strategies/v1-strategies/strategy-configs/filled-order-delay) parameter places a delay between a filled order and when the next order is placed. By increasing the filled_order_delay parameter, it reduces the risk of filling too many orders on one side or the other.
...
![bid-order-delay](/blog/tips-for-handling-different-market-conditions/image_5.jpg)
