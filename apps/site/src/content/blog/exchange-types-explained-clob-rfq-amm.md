---
title: "Exchange Types Explained: CLOB, RFQ, AMM"
description: "Since Hummingbot is an open source bot platform that connects to many different exchanges, we have developed a deep understanding of the nuances between va"
date: "2019-04-24"
author: "Carlo Las Marias"
category: "Tutorials"
excerpt: "Since Hummingbot is an open source bot platform that connects to many different exchanges, we have developed a deep understanding of the nuances between various exchange types. In this post, we discuss the three main methodologies that digital asset exchanges…"
cover: "/blog/exchange-types-explained-clob-rfq-amm/cover.webp"
---
...
![CLOB exchanges](/blog/exchange-types-explained-clob-rfq-amm/clob-exchanges.png)
...
![An exchange from the past](/blog/exchange-types-explained-clob-rfq-amm/traders.png)
...
![(Open the image in a new tab to expand it)](/blog/exchange-types-explained-clob-rfq-amm/CLOB-exchange.png)
...
![RFQ Exchanges](/blog/exchange-types-explained-clob-rfq-amm/airswap-kyber.png)
...
![(RFQ)](/blog/exchange-types-explained-clob-rfq-amm/rfq-exchange.png)
...
![AMMs](/blog/exchange-types-explained-clob-rfq-amm/bancor-uniswap.png)
...
![Determining purchase price on a constant product market maker](/blog/exchange-types-explained-clob-rfq-amm/automated-mm.png)

To understand numerically how automated market maker pricing works, this [spreadsheet](http://bit.ly/2VhceZT) may be helpful.

![Example](/blog/exchange-types-explained-clob-rfq-amm/constant-product-mm.png)
