---
title: "Epoch 4 Polls Recap"
description: "Every quarter, Hummingbot Foundation organizes Polls, an on-going initiative that lets HBOT holders decide how the Foundation allocates its engineering ban"
date: "2023-04-14"
author: "Hummingbot Foundation"
category: "Governance"
excerpt: "Every quarter, Hummingbot Foundation organizes Polls, an on-going initiative that lets HBOT holders decide how the Foundation allocates its engineering bandwidth and developer bounties across the components in the Hummingbot codebase. This week, we completed the Epoch 4 polls, which…"
cover: "/blog/epoch-4-polls-recap/cover.jpg"
---
...
- Delegation system was terminated: More voting power is now distributed among community members since [the delegation system has ended](/blog/end-of-hbot-delegation) on 28 February 2023.

Below, we summarize the results of the Epoch 4 Polls and outline the changes we'll make over the next quarter.

## CEX Connectors

![](/blog/epoch-4-polls-recap/2.jpg)

The CEX Connectors poll places [centralized exchange connectors](https://docs.hummingbot.org/connectors) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the April-June 2023 release cycles.
...
- [Pure Market Making (PMM)](https://docs.hummingbot.org/strategies/v1-strategies/pure-market-making)
- [AMM Arbitrage](https://docs.hummingbot.org/strategies/v1-strategies/amm-arbitrage)
- [Cross Exchange Market Making (XEMM)](https://docs.hummingbot.org/strategies/v1-strategies/cross-exchange-market-making)
...
![](/blog/epoch-4-polls-recap/closeup-diverse-people-joining-their-hands.jpg)
