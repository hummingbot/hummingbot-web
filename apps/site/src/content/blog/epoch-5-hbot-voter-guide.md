---
title: "Epoch 5 HBOT Voter's Guide"
description: "Hummingbot Foundation's quarterly Polls have successfully driven greater participation in Hummingbot governance. Last quarter, each poll received 30+ votes"
date: "2023-06-26"
author: "Hummingbot Foundation"
category: "Governance"
excerpt: "Hummingbot Foundation's quarterly Polls have successfully driven greater participation in Hummingbot governance. Last quarter, each poll received 30+ votes and 20+ million HBOT voting power allocated! But more importantly, polls have also allowed our community to decide which exchange connectors…"
cover: "/blog/epoch-5-hbot-voter-guide/cover.webp"
---
...
Here are the 26 [CEX Connector](https://docs.hummingbot.org/connectors) nominees for Epoch 5:
...
Here are the 19 [DEX Connectors](https://docs.hummingbot.org/gateway/connectors) nominees for Epoch 5:
...
The Core Strategies poll selects the top 3 [strategies](https://docs.hummingbot.org/strategies) in the Hummingbot codebase, which are maintained by Hummingbot Foundation. We will run these strategies to test Hummingbot ad fund bounties to fix bugs discovered during the next Epoch.
...
- [AMM-Arbitrage](https://docs.hummingbot.org/strategies/v1-strategies/amm-arbitrage) (Epoch 4 Core)
- [Avellaneda Market Making](https://docs.hummingbot.org/strategies/v1-strategies/avellaneda-market-making)
- [Cross-Exchange Market Making](https://docs.hummingbot.org/strategies/v1-strategies/cross-exchange-market-making) (Epoch 4 Core)
- [Cross-Exchange Mining](https://docs.hummingbot.org/strategies/v1-strategies/cross-exchange-mining)
- [Hedge](https://docs.hummingbot.org/strategies/v1-strategies/hedge)
- [Liquidity Mining](https://docs.hummingbot.org/strategies/v1-strategies/liquidity-mining)
- [Perpetual Market Making](https://docs.hummingbot.org/strategies/v1-strategies/perpetual-market-making)
- [Pure Market Making](https://docs.hummingbot.org/strategies/v1-strategies/pure-market-making) (Epoch 4 Core)
- [Spot Perpetual Arbitrage](https://docs.hummingbot.org/strategies/v1-strategies/spot-perpetual-arbitrage)
- [TWAP Executor](https://docs.hummingbot.org/strategies/v2-strategies/executors/twapexecutor) (V1 TWAP strategy removed)
- [AMM-V3 LP](https://docs.hummingbot.org/strategies) (Epoch 4 Core)
