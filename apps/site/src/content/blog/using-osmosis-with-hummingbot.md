...
category: "Connectors"
excerpt: "These instructions help users navigate the installation, configuration, and operation of (OSS) Hummingbot high-frequency trading bot running Automated Market Making Arbitrage or Range Automated Market Making strategies on Osmosis DEX over the Hummingbot Gateway."
cover: "/blog/using-osmosis-with-hummingbot/cover.png"
---
## Introduction
...
- [Installation Guide](https://docs.hummingbot.org/installation)
...
- [Linux](https://docs.hummingbot.org/installation)
- [Windows](https://docs.hummingbot.org/installation)
- [MacOS](https://docs.hummingbot.org/installation)
...
1. Export Keplr seed phrase.
   ![image](/blog/using-osmosis-with-hummingbot/view-keplr-seed.png)
...
2. Restore the wallet using the seed phrase, in a different Cosmos-based wallet (such as Leap wallet) which allows exporting the private key.
   ![image](/blog/using-osmosis-with-hummingbot/import-seed-leap.png)
...
2. Scroll down to the ‘Security’ section and select ‘Export Private Key’.
   ![image](/blog/using-osmosis-with-hummingbot/export-private-key-leap-1.png)
...
4. Copy down the private key and _be sure to discard_ the ‘0x’ at the beginning of the displayed key.
   ![image](/blog/using-osmosis-with-hummingbot/export-private-key-leap-2.png)
...
>
![image](/blog/using-osmosis-with-hummingbot/gateway-connect-osmosis.png)
...
To begin trading, a strategy must be configured. The two strategies supported natively by the Osmosis connector are [**amm_arb**](https://docs.hummingbot.org/strategies/v1-strategies/amm-arbitrage) and **amm_v3_lp**.
...
![image](/blog/using-osmosis-with-hummingbot/create-amm-v3-lp-osmosis.png)
...
![image](/blog/using-osmosis-with-hummingbot/import-list.png)

If successful, you will see:

![image](/blog/using-osmosis-with-hummingbot/imported.png)
...
>
![image](/blog/using-osmosis-with-hummingbot/run-strat.png)
