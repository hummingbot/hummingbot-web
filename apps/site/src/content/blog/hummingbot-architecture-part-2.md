---
title: "Hummingbot Architecture - Part 2"
description: "In the last article - Hummingbot Architecture - Part 1 - of this series, we've discussed the design motivations behind Hummingbot, the clock and the market"
date: "2021-05-03"
author: "Martin Kou"
category: "Engineering"
excerpt: "In the last article - Hummingbot Architecture - Part 1 - of this series, we've discussed the design motivations behind Hummingbot, the clock and the market connectors. Today, we'll be discussing the architecture behind trading strategies - the very component…"
cover: "/blog/hummingbot-architecture-part-2/cover.webp"
---
![](/blog/hummingbot-architecture-part-2/cover.webp)

## Introduction

In the last article - [Hummingbot Architecture - Part 1](/blog/hummingbot-architecture-part-1) - of this series, we've discussed the design motivations behind Hummingbot, the clock and the market connectors. Today, we'll be discussing the architecture behind trading strategies - the very component that decides Hummingbot trades with your money. We will also discuss how you can diagnose problems and debug Hummingbot in live trading.

## Strategies

![](/blog/hummingbot-architecture-part-2/chess.jpg)
...
![](/blog/hummingbot-architecture-part-2/avellaneda.png)
...
![](/blog/hummingbot-architecture-part-2/getprice.png)
...
![](/blog/hummingbot-architecture-part-2/avi.png)
...
![](/blog/hummingbot-architecture-part-2/avi2.png)
![](/blog/hummingbot-architecture-part-2/avi3.png)
...
![](/blog/hummingbot-architecture-part-2/pc.jpg)
...
![](/blog/hummingbot-architecture-part-2/telegram.png)
...
![](/blog/hummingbot-architecture-part-2/debug5.png)

You can read more about the debug console from [Hummingbot documentation](https://docs.hummingbot.org/connectors/connectors/debug).
...
![](/blog/hummingbot-architecture-part-2/discord.png)
