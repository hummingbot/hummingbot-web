...
description: "Since both Hummingbot and Uniswap are both open source projects that allow users to make money by providing liquidity, many people have asked how they comp"
date: "2019-04-12"
author: "CoinAlpha"
category: "Tutorials"
excerpt: "Since both Hummingbot and Uniswap are both open source projects that allow users to make money by providing liquidity, many people have asked how they compare to each other. Below, we shed more light on their similarities and differences and…"
cover: "/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/cover.webp"
---
...
![ETH locked in Uniswap: https://mikemcdonald.github.io/eth-defi/](/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/uniswap-chart.png)
...
![The 3 types of Uniswap users](/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/uniswap-roles.png)
...
Both Hummingbot and Uniswap enable users to profit from providing **liquidity**, a huge problem for many crypto projects. In past blog posts, we've written about [why liquidity is beneficial](/blog/how-to-think-about-liquidity-blockcrunch) and [what happens when liquidity is missing](/blog/the-thin-crust-of-liquidity). 
...
![User interfaces: Hummingbot (left) vs Uniswap (right)](/blog/hummingbot-vs-uniswap-two-approaches-to-liquidity/interfaces.png)
