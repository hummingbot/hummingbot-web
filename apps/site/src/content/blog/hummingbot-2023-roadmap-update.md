---
title: "Hummingbot 2023 Roadmap Update"
description: "In December, we shared our ambitious technical roadmap for 2023, detailing the features and improvements we planned to introduce throughout the year. Today"
date: "2023-05-02"
author: "Hummingbot Foundation"
category: "Roadmap"
excerpt: "In December, we shared our ambitious technical roadmap for 2023, detailing the features and improvements we planned to introduce throughout the year. Today, we are excited to provide an update on the progress we've made, the milestones we've reached, and…"
cover: "/blog/hummingbot-2023-roadmap-update/cover.png"
---
In December, we shared our ambitious [technical roadmap](/blog/hummingbot-2023-technical-roadmap) for 2023, detailing the features and improvements we planned to introduce throughout the year. Today, we are excited to provide an update on the progress we've made, the milestones we've reached, and the exciting plans we have for the remainder of the year.

## What's Been Shipped

We are proud to have completed several key items from our roadmap:

1. Expanded Hummingbot to directional strategies by introducing the [Candles Feed](https://docs.hummingbot.org/strategies/v2-strategies/candles) OHLCV generator and the [PositionExecutor Smart Component](https://docs.hummingbot.org/strategies/v2-strategies/executors), enhancing the efficiency and flexibility of our trading algorithms
2. Introduced the [Orchestration Module](https://docs.hummingbot.org/installation/broker) to simplify the management of multiple trading bots and strategies, which is being developed by a community team
...
![](/blog/hummingbot-2023-roadmap-update/Screen-Shot-2023-05-02-at-3.00.20-PM.png)
