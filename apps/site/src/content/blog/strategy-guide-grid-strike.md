---
title: "Strategy Guide: Grid Strike"
description: "Grid Strike (gridstrike) is a Controller in Hummingbot's StrategyV2 framework that automatically places a grid of buy or sell orders within a set price ran"
date: "2025-10-07"
author: "Hummingbot Foundation"
category: "Strategies"
excerpt: "Grid Strike (gridstrike) is a Controller in Hummingbot's StrategyV2 framework that automatically places a grid of buy or sell orders within a set price range. Unlike basic grid strategies, Grid Strike utilizes Executors which dynamically manage each order level with…"
cover: ""
---
**Grid Strike** (`grid_strike`) is a [Controller](https://docs.hummingbot.org/strategies/v2-strategies/controllers) in Hummingbot's StrategyV2 framework that automatically places a grid of buy or sell orders within a set price range.

Unlike [basic grid strategies](https://www.binance.com/en/square/post/24240367765730), Grid Strike utilizes [Executors](https://docs.hummingbot.org/strategies/v2-strategies/executors) which dynamically manage each order level with configurable take profit and stop loss settings. This means every position opened by the strategy is automatically monitored and closed according to your risk parameters. It can be configured to move with the market trend —- either up or down -- letting you adapt the strategy to changing market conditions.
...
![](/blog/strategy-guide-grid-strike/long-grid.png)
...
* [**Hummingbot Client**](https://docs.hummingbot.org/client): See [Installation Guide](https://docs.hummingbot.org/installation) or [Source Installation](https://docs.hummingbot.org/client/installation) to get started
* [**Hummingbot API + Dashboard**](https://docs.hummingbot.org/hummingbot-api): See the [Hummingbot Dashboard Quickstart Guide](/blog/quickstart-dashboard) for a guide with step-by-step setup instructions
...
![1.png](/blog/strategy-guide-grid-strike/1.png)
...
Once you are satisfied with your Grid Strike configuration, add the name of the file to the [Loader Script](https://docs.hummingbot.org/strategies/scripts/examples):

```
create --script-config v2_with_controllers
```
![image.png](/blog/strategy-guide-grid-strike/image.png)
...
![image-1.png](/blog/strategy-guide-grid-strike/image-1.png)
...
![](/blog/strategy-guide-grid-strike/long-grid-order-executor.png)
...
![](/blog/strategy-guide-grid-strike/triple_barrier.png)

Grid Strike creates Grid Executors that implement the Triple Barrier Method, similar to [Position Executors](https://docs.hummingbot.org/strategies/v2-strategies/executors/positionexecutor). Set these parameters to define how each order is managed if it is filled:
...
![](/blog/strategy-guide-grid-strike/long-vs-short-grids.png)
...
![Gridstrike for Short.png](/blog/strategy-guide-grid-strike/Gridstrike_for_Short.png)
...
![GridStrike for Long.png](/blog/strategy-guide-grid-strike/GridStrike_for_Long.png)
