---
title: "Directional Trading with MACD and Bollinger Bands"
description: "Welcome to the inaugural post in our Strategy Experiments series, where we publish hypotheses, code, and performance analyses of live bot strategies. We're"
date: "2023-04-21"
author: "Federico Cardoso"
category: "Strategies"
excerpt: "Welcome to the inaugural post in our Strategy Experiments series, where we publish hypotheses, code, and performance analyses of live bot strategies. We're thrilled to return to the Hummingbot blog with an exciting experiment: developing a crypto trading bot using…"
cover: "/blog/directional-trading-experiment/cover.webp"
---
...
Our strategy employs the Directional Framework, which combines two novel features in Hummingbot: [Candles Feed](https://docs.hummingbot.org/strategies/v2-strategies/candles) and [PositionExecutor](https://docs.hummingbot.org/strategies/v2-strategies/executors/positionexecutor).

![](/blog/directional-trading-experiment/Screen-Shot-2023-04-21-at-3.04.45-PM.png)
...
![](/blog/directional-trading-experiment/Screen-Shot-2023-04-21-at-3.04.54-PM-1.png)
...
![](/blog/directional-trading-experiment/Untitled.png)
