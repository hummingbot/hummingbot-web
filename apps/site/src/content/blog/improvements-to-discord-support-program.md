---
title: "Improvements to the Discord Support Program"
description: "Fourteen months have passed since the introduction of the Discord Support Program, an initiative designed to foster active involvement and collaborative pr"
date: "2024-02-26"
author: "Hummingbot Foundation"
category: "Announcements"
excerpt: "Fourteen months have passed since the introduction of the Discord Support Program, an initiative designed to foster active involvement and collaborative problem-solving within the Hummingbot Discord community channels. This program has enabled the Foundation team to engage community developers and…"
cover: "/blog/improvements-to-discord-support-program/cover.webp"
---
...
But with the introduction of new Hummingbot features like [Dashboard](https://github.com/hummingbot/dashboard) and [V2 Strategies](https://docs.hummingbot.org/strategies/v2-strategies), newer members of our community have struggling to keep pace with troubleshooting and issue resolution. In response, the Foundation team has intensified its engagement with community members on Discord by answering questions. Moreover, we are committed to keeping our community members abreast of the newest Hummingbot developments on the [roadmap](/blog/hummingbot-2024-technical-roadmap), including the imminent launch of the Condor Telegram bot, custom screeners, and advanced AI capabilities.
