---
title: "Hummingbot 2023 Governance Roadmap"
description: "Specifics on our governance roadmap for 2023, Epoch 2 retrospective, and Epoch 3 changes. In our last governance post, we summarized Hummingbot Foundation'"
date: "2022-12-28"
author: "Hummingbot Foundation"
category: "Governance"
excerpt: "Specifics on our governance roadmap for 2023, Epoch 2 retrospective, and Epoch 3 changes. In our last governance post, we summarized Hummingbot Foundation's progress since we launched the HBOT governance token one year ago, as well as the lessons that…"
cover: "/blog/hummingbot-2023-governance-roadmap/cover.jpg"
---
Specifics on our governance roadmap for 2023, Epoch 2 retrospective, and Epoch 3 changes.

In our last [governance post](/blog/changes-to-hummingbot-maintenance-and-governance), we summarized Hummingbot Foundation's progress since we launched the HBOT governance token one year ago, as well as the lessons that we've learned about how to structure the governance process. In particular, the Foundations plans to start regular monthly Polls to allow HBOT users to decide how the scarce maintenance bandwidth would be allocated across various exchanges, strategies, and issues in the Hummingbot codebase.
...
![](/blog/hummingbot-2023-governance-roadmap/javier-allegue-barros-C7B-ExXpOIE-unsplash.jpg)
...
![](/blog/hummingbot-2023-governance-roadmap/brett-jordan-g_hBWtgmDWU-unsplash.jpg)
