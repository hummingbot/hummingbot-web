---
title: "Using Vega Protocol with Hummingbot"
description: "In this guide, we'll walk you through the detailed steps required to seamlessly set up a Vega Wallet, link it with Hummingbot, and start running powerful a"
date: "2024-03-25"
author: "Hummingbot Foundation"
category: "Connectors"
excerpt: "In this guide, we'll walk you through the detailed steps required to seamlessly set up a Vega Wallet, link it with Hummingbot, and start running powerful algo trading strategies on the Vega decentralized exchange. Watch the guide on Youtube and…"
cover: "/blog/using-vega-protocol-with-hummingbot/cover.webp"
---
## Introduction
...
![image](/blog/using-vega-protocol-with-hummingbot/vega-console.png)
...
![image](/blog/using-vega-protocol-with-hummingbot/vega-install-snap.png)
...
![image](/blog/using-vega-protocol-with-hummingbot/vega-deposit.png)
...
![image](/blog/using-vega-protocol-with-hummingbot/vega-network.png)
...
![image](/blog/using-vega-protocol-with-hummingbot/vega-deposit-3.png)
...
![image](/blog/using-vega-protocol-with-hummingbot/snap_key.png)
...
![image](/blog/using-vega-protocol-with-hummingbot/metamask_snap_02.gif)
...
Now, install Hummingbot by following the [installation process](https://docs.hummingbot.org/installation). The easiest way to get started is to clone the Github repo and launch the Docker image:
...
![image](/blog/using-vega-protocol-with-hummingbot/connect_vega.gif)
...
![image](/blog/using-vega-protocol-with-hummingbot/balance.png)
...
This is a simple directional strategy that enters into long positions when the market is oversold (as measured by [RSI](https://en.wikipedia.org/wiki/Relative_strength_index)). Alternatively, if the market is overbought, the bot will enter into a short position. After a position is created, the strategy uses a [PositionExecutor](https://docs.hummingbot.org/strategies/v2-strategies/executors/positionexecutor) to manage it.
...
![image](/blog/using-vega-protocol-with-hummingbot/config.png)
...
* You'll need to use a different exchange (like Binance Futures) other than Vega for `candles_exchange`, since Vega does not currently support [Candles](https://docs.hummingbot.org/strategies/v2-strategies/candles) yet.
...
![image](/blog/using-vega-protocol-with-hummingbot/logs.png)
...
![image](/blog/using-vega-protocol-with-hummingbot/status.png)
...
![image](/blog/using-vega-protocol-with-hummingbot/data-node.png)
...
> **Buy order amount is less than the minimum order size**
>
> ```
