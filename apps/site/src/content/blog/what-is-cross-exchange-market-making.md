...
description: "Welcome back to our Educational Center, where we aim to help you to learn more about market making, arbitrage, and everything related to algorithmic tradin"
date: "2020-09-23"
author: "CoinAlpha"
category: "Tutorials"
excerpt: "Welcome back to our Educational Center, where we aim to help you to learn more about market making, arbitrage, and everything related to algorithmic trading. Today we will talk about one of the core strategies that can be used with…"
cover: "/blog/what-is-cross-exchange-market-making/cover.webp"
---
Welcome back to our Educational Center, where we aim to help you to learn more about [market making](/blog/what-is-market-making), [arbitrage](/blog/what-is-arbitrage), and everything related to algorithmic trading.
...
If you already understand how [arbitrage](/blog/what-is-arbitrage) and [pure market making](/blog/what-is-inventory-risk) work, cross-exchange market making ("XEMM") becomes really simple: it's simply a hybrid of the two.

![](/blog/what-is-cross-exchange-market-making/guitars.jpg)
...
In our previous article on [pure market making](/blog/what-is-market-making), we explained that a market maker is someone who places both bid and ask orders in order to facilitate trading.  You can see that in the cross-exchange market making example above, I am acting as a **maker**, offering a guitar to sell and specifying a price.  So that's one half of what a market maker does.
...
![](/blog/what-is-cross-exchange-market-making/image2.png)
...
![](/blog/what-is-cross-exchange-market-making/image3.png)
...
![](/blog/what-is-cross-exchange-market-making/image4.png)
...
![](/blog/what-is-cross-exchange-market-making/image5.png)
...
With today's article, we presented all three strategies that can be implemented with Hummingbot ([pure_market_making](/blog/what-is-market-making), [arbitrage](/blog/what-is-arbitrage), cross_exchange_market_making), and each one has its own characteristics, advantages, and disadvantages.

Here is a comparison between these strategies:

![](/blog/what-is-cross-exchange-market-making/image6.png)
