---
title: "Partnering with Balancer"
description: "We're incredibly excited to announce a new partnership with Balancer, a leading Ethereum decentralized exchange, that allows Hummingbot users to earn arbit"
date: "2020-11-11"
author: "CoinAlpha"
category: "Announcements"
excerpt: "We're incredibly excited to announce a new partnership with Balancer, a leading Ethereum decentralized exchange, that allows Hummingbot users to earn arbitage profits from reconciling differences between Balancer and other exchanges. The Balancer connector is included with the v0.33 release…"
cover: "/blog/partnering-with-balancer/cover.jpg"
---
...
![Sample arbitage trade between Balancer and Binance](/blog/partnering-with-balancer/2.jpg)

The new `amm-arb` strategy lets you exploit the differences between AMMs like Balancer and order book exchanges like Binance. Extending the `celo-arb` strategy [released](/blog/introducing-the-celo-arbitrage-bot) a few months ago, `amm-arb` uses a new, simpler design that works with any AMM protocol, on both Ethereum and non-Ethereum chains!
...
![Control every aspect of your gas settings](/blog/partnering-with-balancer/ethgasstation.png)
...
![](/blog/partnering-with-balancer/gateway.jpg)
