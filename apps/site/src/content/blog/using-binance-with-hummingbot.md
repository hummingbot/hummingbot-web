---
title: "Using Binance with Hummingbot"
description: "Binance is the world’s largest crypto exchange by trading volume, with $76 billion daily trading volume on Binance exchange as of August 2022, and 90 milli"
date: "2025-04-15"
author: "Hummingbot Foundation"
category: "Connectors"
excerpt: "Binance is the world’s largest crypto exchange by trading volume, with $76 billion daily trading volume on Binance exchange as of August 2022, and 90 million customers worldwide. This section provides a step-by-step guide that helps you use Hummingbot with…"
cover: "/blog/using-binance-with-hummingbot/cover.png"
---
## Introduction
...
Log in to your Binance account. Click on your **Profile** icon, and then on the right-hand sidebar, click [API Management](https://www.binance.com/en/my/settings/api-management)
   ...
   ![Step 1](/blog/using-binance-with-hummingbot/binance-api1.png)
...
Click **Create API**. Please note that before creating an API Key, you need to:
   ...
   ![Step 2](/blog/using-binance-with-hummingbot/binance-api2.png)

**Step 3**

- Select **System generated** as your preferred API Key type. 

   ![Step 3](/blog/using-binance-with-hummingbot/binance-api3.png)
...
- Enter a label / name for your API Key.
   ...
   ![Step 4](/blog/using-binance-with-hummingbot/binance-api4.png)
...
Verify your request with 2FA devices.
   ...
   ![Step 5](/blog/using-binance-with-hummingbot/binance-api5.png)

   - If you don't have a passkey setup you can verify with your currently set 2FA devices. 

   ![Step 6](/blog/using-binance-with-hummingbot/binance-api7.png)
...
Under **IP access restrictions**, you have two options:
   ...
   ![Step 6](/blog/using-binance-with-hummingbot/binance-api6.png)
