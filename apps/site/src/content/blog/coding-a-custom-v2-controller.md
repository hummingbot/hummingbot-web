---
title: "Coding a Liquidation Sniper V2 Strategy Controller"
description: "by Patrick Meier In this article, we'll explore how to create a custom V2 Controller for Hummingbot to snipe future liquidations on Binance. We'll use a ge"
date: "2024-08-03"
author: "Hummingbot Community"
category: "Community"
excerpt: "by Patrick Meier In this article, we'll explore how to create a custom V2 Controller for Hummingbot to snipe future liquidations on Binance. We'll use a generic controller to demonstrate the correct usage and implementation of this strategy. This strategy…"
cover: "/blog/coding-a-custom-v2-controller/cover.webp"
---
*by Patrick Meier*
...
![](/blog/coding-a-custom-v2-controller/liquidation_example.png)

## Coding the Strategy

I intentionally omit the imports here for better readability. You can download the full source-code here: [liquidations_sniper.py](https://docs.hummingbot.org/liquidations_sniper.py)

### Control flow

Let's quickly understand the high-level control flow of the controller we are going to build.

![](/blog/coding-a-custom-v2-controller/control_flow.png)
...
Add the file [liquidations_sniper.py](https://docs.hummingbot.org/liquidations_sniper.py) to your Hummingbot installation like this:

![](/blog/coding-a-custom-v2-controller/hummingbot_controllers.png)
...
![](/blog/coding-a-custom-v2-controller/configuration.png)
...
If you are unsure about the reason for this, just read the docs: [Strategies V2 Architecture](https://docs.hummingbot.org/strategies/v2-strategies)
...
![](/blog/coding-a-custom-v2-controller/strategy_configuration.png)
...
![](/blog/coding-a-custom-v2-controller/running_strategy.png)

#### Monitor live status

You can monitor the actual execution with the command: `status --live`

![](/blog/coding-a-custom-v2-controller/live_status.png)
