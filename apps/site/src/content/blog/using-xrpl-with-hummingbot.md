---
title: "🪙 Using XRP Ledger with Hummingbot"
description: "This step-by-step guide shows you how to: 1. Create an XRPL wallet (two methods: beginner and developer). 2. Import that wallet into Xaman (formerly XUMM)."
date: "2025-05-20"
author: "Hummingbot Foundation"
category: "Connectors"
excerpt: "This step-by-step guide shows you how to: 1. Create an XRPL wallet (two methods: beginner and developer). 2. Import that wallet into Xaman (formerly XUMM). 3. Link your XRPL wallet to Hummingbot, then check your balance. 4. Tweak the XRPL…"
cover: "/blog/using-xrpl-with-hummingbot/cover.png"
---
## 📘 What you’ll learn
...
![Faucet Screenshot](/blog/using-xrpl-with-hummingbot/faucet.webp)
...
![Script Output](/blog/using-xrpl-with-hummingbot/script.png)
...
![import](/blog/using-xrpl-with-hummingbot/xaman1.png)

Press the Import an existing account button

![import](/blog/using-xrpl-with-hummingbot/xaman2.png)
...
![import](/blog/using-xrpl-with-hummingbot/xaman3.png)
...
![import](/blog/using-xrpl-with-hummingbot/xaman4.png)

Enter your Family Seed then press Next.

![import](/blog/using-xrpl-with-hummingbot/xaman5.png)
...
![import](/blog/using-xrpl-with-hummingbot/xaman6.png)
...
![connect](/blog/using-xrpl-with-hummingbot/connect.webp)
...
![Conf Screenshot](/blog/using-xrpl-with-hummingbot/conf.webp)
...
![controller](/blog/using-xrpl-with-hummingbot/controller.png)
...
* [Hummingbot Client](https://docs.hummingbot.org/client)

* [Guides and Tutorials](https://docs.hummingbot.org/guides)
...
![status](/blog/using-xrpl-with-hummingbot/status.png)
