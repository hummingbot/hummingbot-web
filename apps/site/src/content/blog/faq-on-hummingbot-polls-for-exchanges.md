---
title: "FAQ on Hummingbot Polls for Exchanges"
description: "Hummingbot Foundation started conducting quarterly Polls to give HBOT holders a say in the allocation of the Foundation's engineering bandwidth and HBOT de"
date: "2023-01-20"
author: "Hummingbot Foundation"
category: "Governance"
excerpt: "Hummingbot Foundation started conducting quarterly Polls to give HBOT holders a say in the allocation of the Foundation's engineering bandwidth and HBOT developer bounties across the various components of the Hummingbot codebase especially, which exchanges are included in the codebase,…"
cover: "/blog/faq-on-hummingbot-polls-for-exchanges/cover.png"
---
## What are Polls?
...
See the [Governance](https://docs.hummingbot.org/about/governance) documentation to learn more about the current governance process.

## After a Poll, how are exchange ranked?

![](/blog/faq-on-hummingbot-polls-for-exchanges/Epoch-3-Polls-Recap.jpg)
![](/blog/faq-on-hummingbot-polls-for-exchanges/3-1.png)
...
![](/blog/faq-on-hummingbot-polls-for-exchanges/Untitled-design--1-.jpg)

To boost their ranking in upcoming polls, exchanges can have various options to gather more voters:

- **Hold and vote HBOT**: HBOT is a governance token that allows holders to vote gaslessly using their wallet balance. See [this page](https://docs.hummingbot.org/faq) for more information on how to acquire and vote HBOT.
...
![](/blog/faq-on-hummingbot-polls-for-exchanges/Screen-Shot-2023-01-20-at-9.16.43-AM.png)
