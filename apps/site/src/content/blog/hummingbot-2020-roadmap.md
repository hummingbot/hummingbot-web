---
title: "Hummingbot 2020 Roadmap"
description: "At Hummingbot, our mission is to democratize high-frequency trading (HFT). Before, only hedge funds had the technology to run lucrative HFT strategies like"
date: "2020-01-02"
author: "CoinAlpha"
category: "Roadmap"
excerpt: "At Hummingbot, our mission is to democratize high-frequency trading (HFT). Before, only hedge funds had the technology to run lucrative HFT strategies like market making and arbitrage. After we launched Hummingbot in April 2019, ten thousand people around the world…"
cover: "/blog/hummingbot-2020-roadmap/cover.jpg"
---
### 2019 recap
**At Hummingbot, our mission is to democratize high-frequency trading (HFT).**

Before, only hedge funds had the technology to run lucrative HFT strategies like market making and arbitrage. After we [launched Hummingbot](/blog/hummingbot-is-live) in April 2019, ten thousand people around the world have installed our open source HFT software. Currently, Hummingbot's weekly install rate is growing at an 18% clip.

Before, crypto projects and exchanges were held hostage by hedge funds who charged ludicrous fees and required millions in token inventory for market making services. We [announced liquidity mining](/blog/liquidity-mining-launch) in November 2019, which gives projects and exchanges the ability to source liquidity from a decentralized network of both individual and professional liquidity miners, resulting in significant cost savings and transparency gains. Moreover, we project that liquidity miners can [earn 10%+ per year](/blog/liquidity-mining-launch) from running Hummingbot and providing liquidity.
...
![Mockup of the upcoming Hummingbot Miners web app](/blog/hummingbot-2020-roadmap/hummingbot-miners.png)
...
In 2020, we plan to add more diverse market types. As we wrote in this [blog post](/blog/exchange-types-explained-clob-rfq-amm), there are other exchange models such as RFQ and AMM markets. In addition, we plan to integrate with exchanges that offer margin trading, futures, and perpetual swap products.
