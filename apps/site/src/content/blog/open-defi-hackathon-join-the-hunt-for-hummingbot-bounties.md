...
description: "Hello Hummingbot Community Developers! Today we are happy to announce that we will be part of the upcoming Open Defi Hackathon in May! The Open Defi Networ"
date: "2021-04-21"
author: "CoinAlpha"
category: "Announcements"
excerpt: "Hello Hummingbot Community Developers! Today we are happy to announce that we will be part of the upcoming Open Defi Hackathon in May! The Open Defi Network is “a global initiative to develop the decentralized financial ecosystem and advance the…"
cover: "/blog/open-defi-hackathon-join-the-hunt-for-hummingbot-bounties/cover.png"
---
...
To prepare for this bounty, take a look at the [strategy folder of our source code](https://github.com/hummingbot/hummingbot/tree/master/hummingbot/strategy) and the [documentation page related to new strategies](https://docs.hummingbot.org/strategies).
