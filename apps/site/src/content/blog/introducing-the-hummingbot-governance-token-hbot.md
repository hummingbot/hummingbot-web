---
title: "Introducing the Hummingbot Governance Token: HBOT"
description: "HBOT Tokens empower holders to decide how the Hummingbot codebase changes over time through voting on proposals. As announced in this October post, CoinAlp"
date: "2021-12-16"
author: "Hummingbot Foundation"
category: "Announcements"
excerpt: "HBOT Tokens empower holders to decide how the Hummingbot codebase changes over time through voting on proposals. As announced in this October post, CoinAlpha has established the Hummingbot Foundation (the \"Foundation\"), a new, independent open source foundation that will enable…"
cover: "/blog/introducing-the-hummingbot-governance-token-hbot/cover.webp"
---
HBOT Tokens empower holders to decide how the Hummingbot codebase changes over time through voting on proposals.

As announced in [this October post](/blog/introducing-the-hummingbot-foundation), CoinAlpha has established the Hummingbot Foundation (the "Foundation"), a new, independent open source foundation that will enable a decentralized, community-led software development model for Hummingbot, an open source toolbox for building crypto trading bots.
...
![](/blog/introducing-the-hummingbot-governance-token-hbot/hbot-economics.png)
...
See the [Hummingbot Foundation Governance whitepaper](https://docs.hummingbot.org/about/whitepaper) for more details.
...
![](/blog/introducing-the-hummingbot-governance-token-hbot/Screen_Shot_2021-12-17_at_11.10.27_AM.png)
...
![](/blog/introducing-the-hummingbot-governance-token-hbot/hbot-claim-site.png)
...
See the [Hummingbot Foundation Governance whitepaper](https://docs.hummingbot.org/about/whitepaper) for additional details about the governance process, such as proposal types, minim token balance requirements, and quorum/approval thresholds.
