...
description: "We are excited to formally introduce the V2 Strategy Framework! After months of testing by us and our community, we are confident that using this new frame"
date: "2023-11-29"
author: "Michael Feng"
category: "Announcements"
excerpt: "We are excited to formally introduce the V2 Strategy Framework! After months of testing by us and our community, we are confident that using this new framework to design and deploy strategies will improve your algo trading P&L! V2 strategies…"
cover: "/blog/introducing-v2-strategies/cover.png"
---
![](/blog/introducing-v2-strategies/cover.png)
...
[V2 Strategies](https://docs.hummingbot.org/strategies/v2-strategies) marks a departure from the more rigid structure of V1 strategies. It's crafted to enable users to create powerful, custom strategies, even those who may not have extensive Python programming experience.
...
![](/blog/introducing-v2-strategies/architecture.png)

An ecosystem of interconnected components let users customize their V2 Strategies:

* [V2 Script](https://docs.hummingbot.org/strategies/v2-strategies): This serves as the strategy's blueprint, outlining its configuration and interacting seamlessly with other components.
* [Controller](https://docs.hummingbot.org/strategies/v2-strategies/controllers): Acting as the strategy's command center, the Controller interprets input from the V2 Script and steers the overall strategy. It manages Executors, which are crucial for order and position management.
* [Candles](https://docs.hummingbot.org/strategies/v2-strategies/candles): Providing a structured snapshot of market data, Candles are pivotal in generating analytical indicators for market analysis.
* [Executors](https://docs.hummingbot.org/strategies/v2-strategies/executors): These components autonomously manage orders and positions, ensuring alignment with the strategy's directives.
...
His strategy traded across 3 markets on Binance Futures and generated a positive P%L in each market. Here was one such market analyzed using the Strategy Performance page in [Dashboard](https://docs.hummingbot.org/dashboard):

![Trading Strategy Results](/blog/introducing-v2-strategies/performance-1.jpg)

![Binance Futures PnL](/blog/introducing-v2-strategies/performance-0.jpg)
...
![](/blog/introducing-v2-strategies/botcamp-nov-7.png)
