---
title: "2023: A Year of Innovation at Hummingbot"
description: "As we are assembling the roadmap for the new year, it's important to reflect on the strides Hummingbot has made from an engineering standpoint in 2023. In "
date: "2024-01-11"
author: "Hummingbot Foundation"
category: "Engineering"
excerpt: "As we are assembling the roadmap for the new year, it's important to reflect on the strides Hummingbot has made from an engineering standpoint in 2023. In the 2023 Technical Roadmap, we defined 4 key goals: 1. Expand Top Exchange…"
cover: "/blog/a-year-of-innovation-at-hummingbot/cover.png"
---
...
- **New Standard for CLOB DEX Connectors**: We added [Injective Helix](https://docs.hummingbot.org/exchanges/injective), Vertex, and [Hyperliquid](https://docs.hummingbot.org/exchanges/hyperliquid) as Python-based DEX connectors to the Hummingbot client, allowing for enhanced performance and efficiency.
...
- **Codebase Streamlining**: We streamlined maintenance by removing connectors that did not meet the Inclusion Threshold in quarterly Polls.

## 3. Expand Scripts Framework

![](/blog/a-year-of-innovation-at-hummingbot/v2-framework.png)

In 2023, we greatly expanded the scripting capabilities in Hummingbot by adding the [V2 Strategy Framework](https://docs.hummingbot.org/strategies/v2-strategies), which marked a revolutionary leap forward for Hummingbot:
...
![](/blog/a-year-of-innovation-at-hummingbot/Screen-Shot-2023-06-14-at-9.06.43-PM.png)
