---
title: "Announcing the Vega Protocol Connector and Sponsorship"
description: "With the release of a new connector guide for the Vega DEX connector, we are thrilled to officially welcome Vega Protocol as a sponsor and partner of Hummi"
date: "2024-03-25"
author: "Hummingbot Foundation"
category: "Announcements"
excerpt: "With the release of a new connector guide for the Vega DEX connector, we are thrilled to officially welcome Vega Protocol as a sponsor and partner of Hummingbot Foundation! As an open source foundation dedicated to democratizing algo trading, Hummingbot…"
cover: "/blog/announcing-vega-hummingbot-connector-sponsorship/cover.png"
---
With the release of a new [connector guide](/blog/using-vega-protocol-with-hummingbot) for the Vega DEX connector, we are thrilled to officially welcome [Vega Protocol](https://vega.xyz) as a sponsor and partner of Hummingbot Foundation! 
...
That's why we're excited to warmly introduce Vega as a new Hummingbot Foundation [sponsor](https://docs.hummingbot.org/about), which will support our efforts to maintain the Vega integration to Hummingbot and educate our respective communities on how to use it!
...
For instance, we just released the [Vega Connector Guide](/blog/using-vega-protocol-with-hummingbot), in which we detail creating a Vega wallet, adding credentials to Hummingbot, and how to configure Vega-compatible scripts.

[Vega Connector Guide](/blog/using-vega-protocol-with-hummingbot)
