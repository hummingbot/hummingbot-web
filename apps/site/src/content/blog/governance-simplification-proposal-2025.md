---
title: "Proposal: Simplifying Hummingbot Governance"
description: "By Michael Feng, co-founder of Hummingbot The vesting period for all HBOT token holders has now ended, including all CoinAlpha investors, Foundation team m"
date: "2025-12-22"
author: "Michael Feng"
category: "Governance"
excerpt: "By Michael Feng, co-founder of Hummingbot The vesting period for all HBOT token holders has now ended, including all CoinAlpha investors, Foundation team members, and CoinAlpha team members. Fully vested, HBOT's circulating supply stands at 666,576,768 HBOT, with the Foundation…"
cover: "/blog/governance-simplification-proposal-2025/cover.png"
---
...
From the start, the Hummingbot Foundation's goal has been to create a sustainable open source project that earns revenues from exchanges and pays community maintainers to build and maintain connectors to their platforms, as outlined in the original [Hummingbot Foundation whitepaper](https://docs.hummingbot.org/about/whitepaper).
...
2. **Bounties management services**: The Foundation has expanded its services to help new exchanges manage connector development and maintenance via [bounties](https://docs.hummingbot.org/bounties)
3. **Platform maturation**: Hummingbot has migrated from a CLI client to an open source ecosystem for algorithmic trading, with [Hummingbot API](https://docs.hummingbot.org/hummingbot-api) as the command center running on a cloud server and [Condor](https://docs.hummingbot.org/condor) Telegram bot as the primary client. This makes Hummingbot's entire suite of exchanges and bot strategies more accessible than ever.
...
![](/blog/governance-simplification-proposal-2025/governance-current.png)
...
![](/blog/governance-simplification-proposal-2025/governance-simplification.png)
...
- **Clarifies Board role**: Currently, Board responsibilities are [unclear](https://docs.hummingbot.org/about/board). This change defines a clear, focused responsibility: annual budget approval
