...
description: "From the beginning, we conceived of Hummingbot as a shared public utility: an open source project that helps you create trading bots on any crypto exchange"
date: "2020-08-20"
author: "Michael Feng"
category: "Announcements"
excerpt: "From the beginning, we conceived of Hummingbot as a shared public utility: an open source project that helps you create trading bots on any crypto exchange without having to write low-level integrations to exchange APIs. We knew that we would…"
cover: "/blog/scaling-the-hummingbot-developer-community/cover.png"
---
...
In spite of our relatively incomplete documentation and constantly evolving codebase, many developers have forked Hummingbot and built their own exchange connectors, which is why we recently announced a [community governance initiative](/blog/proposed-epoch-6-governance-changes) to vote on which forks we support and merge into the official codebase. In addition, many developers want to learn how to use our new Scripts feature that lets you use market data to fine-tune bot behavior and even create their own Hummingbot strategies.
...
![](/blog/scaling-the-hummingbot-developer-community/discord.png)
