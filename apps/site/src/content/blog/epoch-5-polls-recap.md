...
category: "Governance"
excerpt: "Every quarter, Hummingbot Foundation organizes Polls, an on-going initiative that lets HBOT holders decide how the Foundation allocates its engineering bandwidth and developer bounties across the components in the Hummingbot codebase. This week, we completed the Epoch 5 polls, which…"
cover: "/blog/epoch-5-polls-recap/cover.png"
---
...
![](/blog/epoch-5-polls-recap/CEX-Connectors-Epoch-5.png)

The CEX Connectors poll places [centralized exchange connectors](https://docs.hummingbot.org/connectors) into Gold, Silver and Bronze tiers, which define the level of maintenance that the Foundation spends on each connector for the July-September 2023 release cycles.
...
![](/blog/epoch-5-polls-recap/3.png)
...
![](/blog/epoch-5-polls-recap/4.png)
...
![](/blog/epoch-5-polls-recap/teamwork-business-human-resources-2.jpg)
