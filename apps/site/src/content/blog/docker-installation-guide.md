---
title: "Hummingbot Docker Quickstart Guide"
description: "This brief guide will introduce you to the process of installing and deploying Hummingbot using Docker. You will learn step-by-step how to set up Hummingbo"
date: "2023-12-11"
author: "Hummingbot Foundation"
category: "Tutorials"
excerpt: "This brief guide will introduce you to the process of installing and deploying Hummingbot using Docker. You will learn step-by-step how to set up Hummingbot using Docker Compose, a tool for defining and running multi-container Docker applications, and then run…"
cover: ""
---
## Introduction
...
![Alt text](/blog/docker-installation-guide/password.png)
...
![Alt text](/blog/docker-installation-guide/interface.png)
...
For a more in-depth look, visit [User Interface](https://docs.hummingbot.org/client/user-interface)
...
![Alt text](/blog/docker-installation-guide/create-script-config.png)

Select the `v2_directional_rsi.py` script and press <kbd>ENTER</kbd>. 

![Alt text](/blog/docker-installation-guide/create-script-config2.png)
...
![Alt text](/blog/docker-installation-guide/config-script.png)
...
![Alt text](/blog/docker-installation-guide/load-config-script.png)
...
>
>
![Alt text](/blog/docker-installation-guide/script-status.png)
...
In this example, we'll connect **Binance API** keys. Head over to the [Binance Connector Docs](https://docs.hummingbot.org/exchanges/binance/#generate-api-keys) for instructions on how to generate API keys for [Binance](https://docs.hummingbot.org/exchanges/binance).

Check the [Connectors list](https://docs.hummingbot.org/exchanges) for a list of exchanges that are currently integrated with Hummingbot
...
![Alt text](/blog/docker-installation-guide/connect.png)
...
![Alt text](/blog/docker-installation-guide/binance.png)
...
![Alt text](/blog/docker-installation-guide/connected.png)
