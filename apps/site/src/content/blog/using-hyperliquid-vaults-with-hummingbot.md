---
title: "Funding Rate Arbitrage and Creating Vaults on Hyperliquid"
description: "Hyperliquid Vaults serve as an exchange wallet where funds are used by an individual trader or automated market maker (Vault Leader). Anyone can deposit (V"
date: "2024-02-15"
author: "Hummingbot Foundation"
category: "Connectors"
excerpt: "Hyperliquid Vaults serve as an exchange wallet where funds are used by an individual trader or automated market maker (Vault Leader). Anyone can deposit (Vault Depositors) in the vault and earn a share of the profits. The Hyperliquidity Provider (HLP)…"
cover: "/blog/using-hyperliquid-vaults-with-hummingbot/cover.png"
---
...
![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image1.png)
...
![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image2.png)

Enter the name for the vault and a short description.

![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image3.png)
...
![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image4.png)
...
![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image7.png)
...
![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image8.png)

Next, start a trading strategy in Hummingbot, and your bot trades should match the trades shown under the Vault.

![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image11.png)
...
![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image5.png)
...
![Image](/blog/using-hyperliquid-vaults-with-hummingbot/image6.png)

Users just need to go to the [Vault](https://app.hyperliquid.xyz/vaults) page and select Vaults they want to deposit into.

![HLP](/blog/using-hyperliquid-vaults-with-hummingbot/hlp.png)
