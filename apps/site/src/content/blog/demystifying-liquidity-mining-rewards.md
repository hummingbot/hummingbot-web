---
title: "Demystifying Liquidity Mining Rewards"
description: "We explain in more detail the methodology and mechanics of liquidity mining, a data-driven, objective methodology for quantifying market maker performance."
date: "2019-12-03"
author: "Carlo Las Marias"
category: "Tutorials"
excerpt: "We explain in more detail the methodology and mechanics of liquidity mining, a data-driven, objective methodology for quantifying market maker performance. In our liquidity mining announcement, we introduced a data-driven, objective methodology for quantifying market maker performance. This serves as…"
cover: "/blog/demystifying-liquidity-mining-rewards/cover.webp"
---
...
![](/blog/demystifying-liquidity-mining-rewards/rewards-allocation-chart.png)
...
In our [liquidity mining whitepaper](https://docs.hummingbot.org/liquidity-mining.pdf), we introduced the spread density function ρ(s) for spread s (Equation 1) as a way of mapping spreads to rewards:

![](/blog/demystifying-liquidity-mining-rewards/spread-density-function-graph.png)
...
![](/blog/demystifying-liquidity-mining-rewards/2-total-snapshot-weight.png)
...
![](/blog/demystifying-liquidity-mining-rewards/3_4-miners-allocation.png)
...
![](/blog/demystifying-liquidity-mining-rewards/5-miners-reward.png)
...
![](/blog/demystifying-liquidity-mining-rewards/6_7-liquidity-mining-return.png)

Specifically for one minute snapshots, the annualized return would be:

![](/blog/demystifying-liquidity-mining-rewards/8-annualized-return.png)

This annualized return can then be used to directly compare the economics of liquidity mining vs. HOLDing (0% return), staking, and lending. In the simulation-based analysis in the [liquidity mining whitepaper](https://docs.hummingbot.org/liquidity-mining.pdf), we showed that users could potentially earn 10-50% from liquidity mining.
...
![](/blog/demystifying-liquidity-mining-rewards/8-markets-view.png)
